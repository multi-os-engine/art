...
use-art:
	adb root && sleep 3
	adb shell setprop su system persist.sys.dalvik.vm.lib libart.so
	adb reboot

.PHONY: use-artd
use-artd:
	adb root && sleep 3
	adb shell setprop su system persist.sys.dalvik.vm.lib libartd.so
	adb reboot

.PHONY: use-dalvik
use-dalvik:
	adb root && sleep 3
	adb shell setprop su system persist.sys.dalvik.vm.lib libdvm.so
	adb reboot
