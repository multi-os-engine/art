...
TEST_ART_HOST_RUN_TEST_DEFAULT_LIBART_TARGETS :=
TEST_ART_HOST_RUN_TEST_INTERPRETER_LIBART_TARGETS :=
...
# libart
.PHONY: test-art-host-run-test-default-libart-$(1)
test-art-host-run-test-default-libart-$(1): test-art-host-dependencies $(DX) $(HOST_OUT_EXECUTABLES)/jasmin
...
TEST_ART_HOST_RUN_TEST_DEFAULT_LIBART_TARGETS += test-art-host-run-test-default-libart-$(1)
...
# libart
.PHONY: test-art-host-run-test-interpreter-libart-$(1)
test-art-host-run-test-interpreter-libart-$(1): test-art-host-dependencies $(DX) $(HOST_OUT_EXECUTABLES)/jasmin
...
TEST_ART_HOST_RUN_TEST_INTERPRETER_LIBART_TARGETS += test-art-host-run-test-interpreter-$(1)

.PHONY: test-art-host-run-test-$(1)
test-art-host-run-test-$(1): test-art-host-run-test-default-$(1) test-art-host-run-test-interpreter-$(1) test-art-host-run-test-default-libart-$(1) test-art-host-run-test-interpreter-libart-$(1)
...
.PHONY: test-art-host-run-test-default-libart
test-art-host-run-test-default-libart: $(TEST_ART_HOST_RUN_TEST_DEFAULT_LIBART_TARGETS)
	@echo test-art-host-run-test-default-libart PASSED
...
.PHONY: test-art-host-run-test-interpreter-libart
test-art-host-run-test-interpreter-libart: $(TEST_ART_HOST_RUN_TEST_INTERPRETER_LIBART_TARGETS)
	@echo test-art-host-run-test-interpreter-libart PASSED

.PHONY: test-art-host-run-test-libart
test-art-host-run-test-libart: $(TEST_ART_HOST_RUN_TEST_DEFAULT_LIBART_TARGETS) $(TEST_ART_HOST_RUN_TEST_INTERPRETER_LIBART_TARGETS)
	@echo test-art-host-run-test-libart PASSED

.PHONY: test-art-host-run-test
test-art-host-run-test: test-art-host-run-test-default test-art-host-run-test-interpreter test-art-host-run-test-default-libart test-art-host-run-test-interpreter-libart
...
.PHONY: test-art-target-run-test-libart-$(1)$($(2)ART_PHONY_TEST_TARGET_SUFFIX)
test-art-target-run-test-libart-$(1)$($(2)ART_PHONY_TEST_TARGET_SUFFIX): test-art-target-sync $(DX) $(HOST_OUT_EXECUTABLES)/jasmin
	...
	@echo test-art-target-run-test-libart-$(1)$($(2)ART_PHONY_TEST_TARGET_SUFFIX) PASSED
endef

TEST_ART_TARGET_RUN_TEST_LIBART_TARGETS$(ART_PHONY_TEST_TARGET_SUFFIX) :=
TEST_ART_TARGET_RUN_TEST_LIBART_TARGETS$(2ND_ART_PHONY_TEST_TARGET_SUFFIX) :=
...
test-art-target-run-test-$(1): test-art-target-run-test-$(1)$(ART_PHONY_TEST_TARGET_SUFFIX)
    ...
    TEST_ART_TARGET_RUN_TEST_LIBART_TARGETS$(2ND_ART_PHONY_TEST_TARGET_SUFFIX) += test-art-target-run-test-$(1)$(2ND_ART_PHONY_TEST_TARGET_SUFFIX)

    ifneq ($(ART_PHONY_TEST_TARGET_SUFFIX),)
      # Link primary to non-suffix
test-art-target-run-test-libart-$(1): test-art-target-run-test-libart-$(1)$(ART_PHONY_TEST_TARGET_SUFFIX)
    endif
  endif
  ...
  TEST_ART_TARGET_RUN_TEST_LIBART_TARGETS$(ART_PHONY_TEST_TARGET_SUFFIX) += test-art-target-run-test-libart-$(1)$(ART_PHONY_TEST_TARGET_SUFFIX)

test-art-run-test-$(1): test-art-host-run-test-$(1) test-art-target-run-test-$(1)
test-art-run-test-libart-$(1): test-art-host-run-test-libart-$(1) test-art-target-run-test-libart-$(1)
...
.PHONY: test-art-target-run-test-libart$(1)
test-art-target-run-test-libart$(1): $(TEST_ART_TARGET_RUN_TEST_LIBART_TARGETS$(1))
	@echo test-art-target-run-test-libart$(1) PASSED
endef
