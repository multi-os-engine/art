...
build-art-host-tests:   build-art-host $(ART_TEST_HOST_RUN_TEST_DEPENDENCIES) $(ART_TEST_HOST_GTEST_DEPENDENCIES) $(TEST_ART_RUN_TEST_DEPENDENCIES)

.PHONY: build-art-target-tests
build-art-target-tests:   build-art-target $(TEST_ART_TARGET_SYNC_DEPS) $(TEST_ART_RUN_TEST_DEPENDENCIES)
