...
enum PatchResult {
  kAbosoluteAddress,  // Absolute memory location.
...
static void Patch(std::vector<uint8_t>& buffer,
...
bool ElfWriterQuick<ElfTypes>::Write(
  ...
  RawSection debug_info(".debug_info", SHT_PROGBITS, 0, nullptr, 0, 1, 0,
                        Patch<Elf_Addr, uint32_t, kAbosoluteAddress>, text);
