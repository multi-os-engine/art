...
class MirSFieldLoweringInfo : public MirFieldInfo {
 ...
 private:
  enum {
    ...
    kBitTypeIsInitialized,
    kBitTypeIsInDexCache,
  ...
  static constexpr uint16_t kFlagClassIsInitialized = 1u << kBitTypeIsInitialized;
  static constexpr uint16_t kFlagClassIsInDexCache = 1u << kBitTypeIsInDexCache;
