...
class MIRGraph {
 public:
   ...
   */
  size_t GetNumUsedCompilerTemps() {
   ...
   */
  size_t GetNumNonSpecialCompilerTemps() {
   ...
   */
  bool SetNumTotalAvailableCompilerTemps(size_t new_max) {
   ...
   */
  CompilerTemp* GetCompilerTemp(size_t index) {
