...
namespace art {
   ...
   * @brief The main iterator class, all other iterators derive of this one to define iteration order
   */
  class DataflowIterator {
    public:
      /**
    ...
    protected:
      ...
      /**
       * @brief Get the next BasicBlock forward iteration
       * @return the next BasicBlock forward iteration
       */
      virtual BasicBlock* ForwardSingleNext() ALWAYS_INLINE;

      /**
       * @brief Get the next BasicBlock reverse iteration
       * @return the next BasicBlock reverse iteration
       */
      virtual BasicBlock* ReverseSingleNext() ALWAYS_INLINE;

      /**
       * @brief Get the next BasicBlock forward iteration, caring if we changed the current BasicBlock
       * @return the next BasicBlock forward iteration
       */
      virtual BasicBlock* ForwardRepeatNext() ALWAYS_INLINE;

      /**
       * @brief Get the next BasicBlock reverse iteration, caring if we changed the current BasicBlock
       * @return the next BasicBlock reverse iteration
       */
   ...
   * @brief Pre-order Depth-First-Search Iteration
   */
   ...
   * @brief Repeating Pre-order Depth-First-Search Iteration
   ...
   * @brief Repeating Post-order Depth-First-Search Iteration
   * @details If there is a change during an iteration, the iteration starts over at the end of the iteration
   */
   ...
   * @brief Reverse Post-order Depth-First-Search Iteration
   */
   ...
   * @brief Post Order Domination Iterator
   */
