    ...
    for (MIR* mir = bb->first_mir_insn; mir != nullptr; mir = mir->next) {
      ...
      switch (opcode) {
        ...
        case Instruction::MOVE_EXCEPTION:
          ...
          sregs_[defs[0]] = Type::NonArrayRefType();
          break;
        ...
        case Instruction::NEW_INSTANCE:
          sregs_[defs[0]] = Type::DexType(cu_->dex_file, mir->dalvikInsn.vB);
          DCHECK(sregs_[defs[0]].Ref());
          DCHECK_EQ(sregs_[defs[0]].ArrayDepth(), 0u);
          break;
        case Instruction::NEW_ARRAY:
          sregs_[defs[0]] = Type::DexType(cu_->dex_file, mir->dalvikInsn.vC);
          DCHECK(sregs_[defs[0]].Ref());
        ...
        case Instruction::IGET_SHORT_QUICK:
          DCHECK_LT(mir->meta.ifield_lowering_info, mir_graph_->GetIFieldLoweringInfoCount());
          sregs_[defs[0]] = ifields_[mir->meta.ifield_lowering_info];
          break;
        ...
        case Instruction::IPUT_SHORT_QUICK:
          DCHECK_LT(mir->meta.ifield_lowering_info, mir_graph_->GetIFieldLoweringInfoCount());
          UpdateSRegFromLowWordTypeStrong(ModifiedSReg(uses[0]),
        ...
        case Instruction::SGET_SHORT:
          DCHECK_LT(mir->meta.sfield_lowering_info, mir_graph_->GetSFieldLoweringInfoCount());
          sregs_[defs[0]] = sfields_[mir->meta.sfield_lowering_info];
          break;
...
bool TypeInference::InferTypeAndSize(BasicBlock* bb, MIR* mir) {
  ...
  if (ssa_rep != nullptr) {
    uint64_t attrs = MIRGraph::GetDataFlowAttributes(mir);
    const int32_t* uses = ssa_rep->uses;
    const int32_t* defs = ssa_rep->defs;
