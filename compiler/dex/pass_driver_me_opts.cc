...
template<>
std::unique_ptr<const char> PassDriver<PassDriverMEOpts>::dump_pass_list_(nullptr);

// By default, do not have a print pass list.
template<>
std::unique_ptr<const char> PassDriver<PassDriverMEOpts>::print_pass_list_(nullptr);
