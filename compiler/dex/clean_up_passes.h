...
namespace art {
  ...
  class InitializeData:public PassME {
    public:
      InitializeData(void):PassME("InitializeData") {
      }

      void Start(const PassDataHolder* data) const {
        // New blocks may have been inserted so the first thing we do is ensure that the c_unit's number of blocks
  ...
  class ClearPhiInstructions:public PassME {
    public:
      ClearPhiInstructions(void):PassME("ClearPhiInstructions") {
      }
  ...
  class CalculatePredecessors:public PassME {
    public:
      CalculatePredecessors(void):PassME("CalculatePredecessors") {
      }
  ...
  class DFSOrders:public PassME {
    public:
      DFSOrders(void):PassME("DFSOrders") {
      }
  ...
  class BuildDomination:public PassME {
    public:
      BuildDomination(void):PassME("BuildDomination") {
      }
  ...
  class DefBlockMatrix:public PassME {
    public:
      DefBlockMatrix(void):PassME("DefBlockMatrix") {
      }
  ...
  class CreatePhiNodes:public PassME {
    public:
      CreatePhiNodes(void):PassME("CreatePhiNodes") {
      }
  ...
  class ClearVisitedFlag:public PassME {
    public:
      ClearVisitedFlag(void):PassME("ClearVisitedFlag") {
      }
  ...
  class SSAConversion:public PassME {
    public:
      SSAConversion(void):PassME("SSAConversion") {
      }
  ...
  class PhiNodeOperands:public PassME {
    public:
      PhiNodeOperands(void):PassME("PhiNodeOperands", kPreOrderDFSTraversal) {
      }
