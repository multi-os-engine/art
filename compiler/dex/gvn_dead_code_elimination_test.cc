...
TEST_F(GvnDeadCodeEliminationTestSimple, UnusedRegs2) {
  static const MIRDef mirs[] = {
      ...
      DEF_CONST_WIDE(3, Instruction::CONST_WIDE, 9u, 4000u),  // Killed with 11u (BackwardPass)
      DEF_CONST(3, Instruction::CONST, 11u, 6000u),           // Killed with 9u (BackwardPass)
      { 3, Instruction::LONG_TO_INT, 0, 0u, 2, { 9u, 10u }, 1, { 12u } },
  };
