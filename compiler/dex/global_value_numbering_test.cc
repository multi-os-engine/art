...
TEST_F(GlobalValueNumberingTestCatch, IFields) {
  ...
  static const MIRDef mirs[] = {
      ...
      DEF_IGET(3, Instruction::IGET, 1u, 100u, 0u),
      DEF_IPUT(3, Instruction::IPUT, 1u, 100u, 1u),
      DEF_IPUT(3, Instruction::IPUT, 1u, 101u, 0u),
      DEF_IPUT(3, Instruction::IPUT, 1u, 102u, 0u),
      DEF_IGET(4, Instruction::IGET, 5u, 100u, 0u),         // Differs from the top.
      DEF_IPUT(4, Instruction::IPUT, 5u, 100u, 1u),
      DEF_IPUT(4, Instruction::IPUT, 5u, 101u, 0u),
      DEF_IPUT(4, Instruction::IPUT, 5u, 102u, 0u),
      DEF_IGET(5, Instruction::IGET, 9u, 100u, 0u),         // Differs from both IGETs above.
      DEF_IGET(5, Instruction::IGET, 10u, 100u, 1u),        // Same as 9u.
      DEF_IGET(5, Instruction::IGET, 11u, 101u, 0u),        // Same as 9u.
      DEF_IGET(5, Instruction::IGET, 12u, 102u, 0u),        // Same as 9u.
  };
