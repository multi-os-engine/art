...
class GlobalValueNumberingTestTwoLoops : public GlobalValueNumberingTest {
 public:
  GlobalValueNumberingTestTwoLoops();

 private:
  static const BBDef kTwoLoopsBbs[];
};

const GlobalValueNumberingTest::BBDef GlobalValueNumberingTestTwoLoops::kTwoLoopsBbs[] = {
    DEF_BB(kNullBlock, DEF_SUCC0(), DEF_PRED0()),
    DEF_BB(kEntryBlock, DEF_SUCC1(3), DEF_PRED0()),
...
GlobalValueNumberingTestTwoLoops::GlobalValueNumberingTestTwoLoops()
    : GlobalValueNumberingTest() {
  PrepareBasicBlocks(kTwoLoopsBbs);
}
...
TEST_F(GlobalValueNumberingTestTwoLoops, IFieldAndPhi) {
  static const IFieldDef ifields[] = {
      { 0u, 1u, 0u, false },  // Int.
  };
  static const MIRDef mirs[] = {
...
TEST_F(GlobalValueNumberingTestTwoLoops, NullCheck) {
  static const IFieldDef ifields[] = {
      { 0u, 1u, 0u, false },  // Int.
  };
  static const SFieldDef sfields[] = {
