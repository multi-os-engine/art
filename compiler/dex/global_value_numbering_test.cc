...
TEST_F(GlobalValueNumberingTest, CatchIFields) {
  ...
  static const MIRDef mirs[] = {
      DEF_IGET(3, Instruction::IGET, 0u, 100u, 0u),
      DEF_IPUT(3, Instruction::IPUT, 0u, 100u, 1u),
      DEF_IPUT(3, Instruction::IPUT, 0u, 101u, 0u),
      DEF_IGET(4, Instruction::IGET, 3u, 100u, 0u),         // Differs from the top.
      DEF_IPUT(4, Instruction::IPUT, 3u, 100u, 1u),
      DEF_IPUT(4, Instruction::IPUT, 3u, 101u, 0u),
      DEF_IGET(5, Instruction::IGET, 6u, 100u, 0u),         // Differs from both IGETs above.
      DEF_IGET(5, Instruction::IGET, 7u, 100u, 1u),         // Same as field #1.
      DEF_IGET(5, Instruction::IGET, 8u, 101u, 0u),         // Same as field #1.
  };
  ...
  EXPECT_EQ(value_names_[6], value_names_[8]);
}
...
TEST_F(GlobalValueNumberingTest, MergeSameValueInDifferentMemoryLocations) {
  ...
  static const MIRDef mirs[] = {
      // TODO: Add arrays to this test.
      DEF_UNIQUE_REF(3, Instruction::NEW_INSTANCE, 100u),
      DEF_CONST(4, Instruction::CONST, 1u, 1000),
      DEF_IPUT(4, Instruction::IPUT, 1u, 100u, 0u),
      DEF_IPUT(4, Instruction::IPUT, 1u, 100u, 1u),
      DEF_IPUT(4, Instruction::IPUT, 1u, 200u, 0u),
      DEF_SPUT(4, Instruction::SPUT, 1u, 0u),
      DEF_SPUT(4, Instruction::SPUT, 1u, 1u),
      DEF_CONST(5, Instruction::CONST, 7u, 2000),
      DEF_IPUT(5, Instruction::IPUT, 7u, 100u, 0u),
      DEF_IPUT(5, Instruction::IPUT, 7u, 100u, 1u),
      DEF_IPUT(5, Instruction::IPUT, 7u, 200u, 0u),
      DEF_SPUT(5, Instruction::SPUT, 7u, 0u),
      DEF_SPUT(5, Instruction::SPUT, 7u, 1u),
      DEF_PHI2(6, 13u, 1u, 7u),
      DEF_IGET(6, Instruction::IGET, 14u, 100u, 0u),
      DEF_IGET(6, Instruction::IGET, 15u, 100u, 1u),
      DEF_IGET(6, Instruction::IGET, 16u, 200u, 0u),
      DEF_SGET(6, Instruction::SGET, 17u, 0u),
      DEF_SGET(6, Instruction::SGET, 18u, 1u),
  };
  PrepareIFields(ifields);
  PrepareSFields(sfields);
  PrepareBasicBlocks(bbs);
  ...
  PerformGVN();
  ASSERT_EQ(arraysize(mirs), value_names_.size());
  EXPECT_NE(value_names_[1], value_names_[7]);
  EXPECT_NE(value_names_[1], value_names_[13]);
  EXPECT_NE(value_names_[7], value_names_[13]);
  EXPECT_EQ(value_names_[13], value_names_[14]);
  EXPECT_EQ(value_names_[13], value_names_[15]);
  EXPECT_EQ(value_names_[13], value_names_[16]);
  EXPECT_EQ(value_names_[13], value_names_[17]);
  EXPECT_EQ(value_names_[13], value_names_[18]);
}
