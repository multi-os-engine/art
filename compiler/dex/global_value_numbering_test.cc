...
TEST_F(GlobalValueNumberingTest, LoopNonAliasingIFields) {
  static const IFieldDef ifields[] = {
      ...
      { 2u, 1u, 2u, false },  // Object.
      { 3u, 1u, 3u, false },  // Object.
      { 4u, 1u, 4u, false },  // Object.
      { 5u, 1u, 5u, false },  // Short.
      { 6u, 1u, 6u, false },  // Char.
      { 7u, 0u, 0u, false },  // Unresolved, Short.
      { 8u, 1u, 8u, false },  // Object.
      { 9u, 0u, 0u, false },  // Unresolved, Object.
      { 10u, 1u, 10u, false },  // Object.
      { 11u, 1u, 11u, false },  // Object.
  };
  static const BBDef bbs[] = {
...
TEST_F(GlobalValueNumberingTest, NullCheckIFields) {
  ...
  static const MIRDef mirs[] = {
      DEF_IGET(3, Instruction::IGET, 0u, 100u, 0u),
      DEF_IGET(3, Instruction::IGET, 1u, 100u, 1u),
      DEF_IGET(3, Instruction::IGET, 2u, 101u, 0u),
      DEF_IFZ(3, Instruction::IF_NEZ, 0u),            // Null-check for field #0 for taken.
      DEF_UNIQUE_REF(4, Instruction::NEW_ARRAY, 4u),
      DEF_IPUT(4, Instruction::IPUT, 4u, 100u, 0u),
      DEF_IPUT(4, Instruction::IPUT, 4u, 100u, 1u),
      DEF_IPUT(4, Instruction::IPUT, 4u, 101u, 0u),
      DEF_IGET(5, Instruction::IGET, 8u, 100u, 0u),   // 100u/#0 is null-checked, IF_NEZ/NEW_ARRAY.
      DEF_IGET(5, Instruction::IGET, 9u, 100u, 1u),   // 100u/#1 is not null-checked, -/NEW_ARRAY.
      DEF_IGET(5, Instruction::IGET, 10u, 101u, 0u),  // 101u/#0 is not null-checked, -/NEW_ARRAY.
...
TEST_F(GlobalValueNumberingTest, NullCheckSFields) {
  ...
  static const MIRDef mirs[] = {
      DEF_SGET(3, Instruction::SGET, 0u, 0u),
      DEF_SGET(3, Instruction::SGET, 1u, 1u),
      DEF_IFZ(3, Instruction::IF_NEZ, 0u),            // Null-check for field #0 for taken.
      DEF_UNIQUE_REF(4, Instruction::NEW_ARRAY, 3u),
      DEF_SPUT(4, Instruction::SPUT, 3u, 0u),
      DEF_SPUT(4, Instruction::SPUT, 3u, 1u),
      DEF_SGET(5, Instruction::SGET, 6u, 0u),         // Field #0 is null-checked, IF_NEZ/NEW_ARRAY.
      DEF_SGET(5, Instruction::SGET, 7u, 1u),         // Field #1 is not null-checked, -/NEW_ARRAY.
