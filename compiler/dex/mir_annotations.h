...
struct MethodAnnotation {
  ...
  uint16_t method_idx;
  uint16_t resolved_method_idx;
  uint32_t invoke_type : 3;  // InvokeType;
  uint32_t resolved_invoke_type : 3;  // InvokeType
  uint32_t fast_path : 1;
