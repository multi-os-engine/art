...
#ifndef ART_COMPILER_DEX_DEBUG_STACK_H_
#define ART_COMPILER_DEX_DEBUG_STACK_H_
...
class DebugStackReferenceImpl {
 public:
  explicit DebugStackReferenceImpl(DebugStackRefCounterImpl<IsDebug>* counter)
...
class DebugStackIndirectTopRefImpl {
 public:
  explicit DebugStackIndirectTopRefImpl(DebugStackReferenceImpl<IsDebug>* ref)
      : ref_(ref) {
    CheckTop();
  }
 ...
 private:
  DebugStackReferenceImpl<IsDebug>* ref_;
};

}  // namespace art

#endif  // ART_COMPILER_DEX_DEBUG_STACK_H_
