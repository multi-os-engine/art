 ...
 */
bool MIRGraph::EliminateClassInitChecks(CanEliminateCheckFnPtr CanEliminateCheck,
                                        CanCountEliminationFnPtr CanCountElimination,
                                        BasicBlock* bb) {
