...
bool MIRGraph::SpecialMethodInlinerGate() {
...
void MIRGraph::SpecialMethodInlinerStart() {
...
void MIRGraph::SpecialMethodInliner(BasicBlock* bb) {
...
void MIRGraph::SpecialMethodInlinerEnd() {
  DCHECK(temp_insn_data_ != nullptr);
  temp_insn_data_ = nullptr;
