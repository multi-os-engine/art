...
TEST_F(TypeInferenceTest, Wide1) {
  ...
  static const MIRDef mirs[] = {
      DEF_SGET_WIDE(3u, Instruction::SGET_WIDE, 0u, 0u),
      DEF_CONST(3u, Instruction::CONST, 2u, 0),
      DEF_CONST(3u, Instruction::CONST, 3u, 0),
      DEF_APUT_WIDE(3u, Instruction::APUT_WIDE, 0u, 2u, 3u),
  ...
  ExpectSRegType(0u, expectations[0]);
  ExpectSRegType(2u, expectations[1]);
  ExpectSRegType(3u, expectations[2]);
}


TEST_F(TypeInferenceTest, WideConflict1) {
  static const MIRDef mirs[] = {
