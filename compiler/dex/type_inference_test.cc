...
#define DEF_NEW_ARRAY(bb, opcode, reg, length, type) \
  ...
  enum ExpectFlags : uint32_t {
    ...
    kExpectHigh         = 0x0400u,  // Reserved for ExpectSRegType().
  };
  ...
  void ExpectSRegType(int s_reg, const SRegExpectation& expectation) {
...
TEST_F(TypeInferenceTest, TwoNullObjectArraysInLoop) {
  static const MIRDef mirs[] = {
      ...
      DEF_CONST(3u, Instruction::CONST, 0u, 0),  // array1
      DEF_CONST(3u, Instruction::CONST, 1u, 0),  // array2
      DEF_CONST(3u, Instruction::CONST, 2u, 0),  // index
      DEF_PHI2(4u, 3u, 0u, 7u),  // ? + [L -> [? gives [L (see array-length below)
      DEF_PHI2(4u, 4u, 1u, 8u),  // ? + [L -> ? gives ?
      DEF_CONST(4u, Instruction::CONST, 5u, 0),  // a1
      DEF_CONST(4u, Instruction::CONST, 6u, 0),  // a2
      DEF_APUT(4u, Instruction::APUT_OBJECT, 5u, 6u, 2u),
      DEF_APUT(4u, Instruction::APUT_OBJECT, 6u, 5u, 2u),
      DEF_MOVE(4u, Instruction::MOVE_OBJECT, 7u, 5u),
      DEF_MOVE(4u, Instruction::MOVE_OBJECT, 8u, 6u),
      DEF_UNOP(5u, Instruction::ARRAY_LENGTH, 9u, 3u),
  };
...
TEST_F(TypeInferenceTest, ArrayArrayFloat) {
  ...
  static const MIRDef mirs[] = {
      ...
      //     test(array[0][0]);   // aget-object[2] + aget + invoke
      ...
      //
      // Omitting the try-catch:
      DEF_CONST(3u, Instruction::CONST, 0u, 0),             // array
      DEF_CONST(3u, Instruction::CONST, 1u, 0),             // 0
      DEF_CONST(3u, Instruction::CONST, 2u, 0),             // 0.0f
      DEF_AGET(3u, Instruction::AGET_OBJECT, 3u, 0u, 1u),   // array[0]
      DEF_APUT(3u, Instruction::APUT, 2u, 3u, 1u),          // array[0][0] = 0.0f
      DEF_AGET(3u, Instruction::AGET_OBJECT, 4u, 0u, 1u),   // array[0]
      DEF_AGET(3u, Instruction::AGET, 5u, 4u, 1u),          // array[0][0]
      DEF_INVOKE1(3u, Instruction::INVOKE_STATIC, 5u, 0u),  // fooFloat(array[0][0])
  };
...
TEST_F(TypeInferenceTest, CheckCast1) {
  ...
  static const MIRDef mirs[] = {
      DEF_CONST(3u, Instruction::CONST, 0u, 0),
      DEF_CHECK_CAST(4u, Instruction::CHECK_CAST, 0u, 0u),
      DEF_CHECK_CAST(5u, Instruction::CHECK_CAST, 0u, 0u),
      // Pseudo-phi from [I and [I into L infers only L but not [.
      DEF_MOVE(6u, Instruction::MOVE_OBJECT, 1u, 0u),
  };
  PrepareTypes(types);
  BuildDexFile("()V", true);
  PrepareDiamond();
  ...
  MapVRegToSReg(0, 0, v0_def_blocks);
  PerformTypeInference();
...
TEST_F(TypeInferenceTest, CheckCast2) {
  ...
  static const MIRDef mirs[] = {
      ...
      DEF_MOVE(6u, Instruction::MOVE_OBJECT, 1u, 0u),
      DEF_UNOP(6u, Instruction::ARRAY_LENGTH, 2u, 0u),
  };
  PrepareTypes(types);
  BuildDexFile("()V", true);
  PrepareDiamond();
...
TEST_F(TypeInferenceTest, CheckCast3) {
  ...
  static const MIRDef mirs[] = {
      DEF_CONST(3u, Instruction::CONST, 0u, 0),
      DEF_CHECK_CAST(4u, Instruction::CHECK_CAST, 0u, 0u),
      DEF_CHECK_CAST(5u, Instruction::CHECK_CAST, 0u, 1u),
...
TEST_F(TypeInferenceTest, Phi1) {
  ...
  static const MIRDef mirs[] = {
      ...
      // Phi from [I and [I into L infers only L but not [.
...
TEST_F(TypeInferenceTest, Phi2) {
  ...
  static const MIRDef mirs[] = {
      ...
      DEF_NEW_ARRAY(4u, Instruction::NEW_ARRAY, 1u, 0u, 0u),
      DEF_NEW_ARRAY(5u, Instruction::NEW_ARRAY, 2u, 0u, 0u),
      // Pseudo-phi from [F and [F into [? infers [F.
      DEF_PHI2(6u, 3u, 1u, 2u),
...
// TODO: Tests for wide stuff!!!

/*
 * Getting the detection of references right is essential.
 * Let's look at an especially contrived example.
 *
 * TODO: Test cases for the methods below. (Omit unimportant instructions.)
 *
 * void bar4() {
 *   Object o = null;
 *   if (modifyState() == 1) {
 *     Object[] o1 = o;  // Force o1 and o to the same register (smali).
 *     if (modifyState() == 2) {
 *       o1 = new int[10];
 *     }
 *     o1[0] = 0;
 *     o = o1;
 *   } else {
 *     Object[] o2 = o;  // Force o2 and o to the same register (smali).
 *     if (modifyState() == 3) {
 *       o2 = new float[10];
 *     }
 *     o2[0] = 0;
 *     o = o2;
 *   }
 *   o[1] = 0;  // Type conflict: o must be an array, merged from [I and [F, mark 0 as conflict.
 * }
 */
