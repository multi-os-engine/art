...
struct CompilationUnit {
  ...
  */
  ...
  const uint16_t* insns;        /**!< @deprecated Use MIRGraph::GetInsns */
  uint16_t num_ins;             /**!< @deprecated Use MIRGraph::GetNumOfInVRs */
  uint16_t num_outs;            /**!< @deprecated Use MIRGraph::GetNumOfOutVRs */
  uint16_t num_regs;            /**!< @deprecated Use MIRGraph::GetNumOfCodeVRs or MIRGraph::GetNumOfCodeAndTempVRs */
