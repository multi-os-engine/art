...
QuickCompilerContext::QuickCompilerContext(CompilerDriver& driver)
  : inliner_map_(new DexFileToMethodInlinerMap(&driver)) {
}
...
extern "C" void ArtInitQuickCompilerContext(art::CompilerDriver& driver) {
  ...
  driver.SetCompilerContext(new QuickCompilerContext(driver));
}
