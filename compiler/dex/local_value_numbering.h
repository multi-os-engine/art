...
class LocalValueNumbering {
 ...
 private:
  ...
  static void LoadValueMapUnion(ScopedArenaSafeMap<uint16_t, uint16_t>* work_map,
                                const ScopedArenaSafeMap<uint16_t, uint16_t>& other_map);

  void MergeAliasingValueLocations(AliasingValues* work_values, const AliasingValues* values);
