...
const uint64_t MIRGraph::oat_data_flow_attributes_[kMirOpLast] = {
  ...
  // E3 IGET_QUICK
  DF_DA | DF_UB | DF_NULL_CHK_A | DF_REF_B | DF_IFIELD | DF_LVN,

  // E4 IGET_WIDE_QUICK
  DF_DA | DF_A_WIDE | DF_UB | DF_NULL_CHK_A | DF_REF_B | DF_IFIELD | DF_LVN,

  // E5 IGET_OBJECT_QUICK
  DF_DA | DF_UB | DF_NULL_CHK_A | DF_REF_A | DF_REF_B | DF_IFIELD | DF_LVN,
  ...
  // F6 IGET_OBJECT_VOLATILE
  DF_DA | DF_UB | DF_NULL_CHK_A | DF_REF_A | DF_REF_B | DF_IFIELD | DF_LVN,

  // F7 IGET_WIDE_VOLATILE
  DF_DA | DF_A_WIDE | DF_UB | DF_NULL_CHK_B | DF_REF_B | DF_IFIELD | DF_LVN,
