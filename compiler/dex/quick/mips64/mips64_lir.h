...
enum Mips64ResourceEncodingPos {
  ...
  kMips64RegSP    = 29,
  kMips64RegLR    = 31,
  kMips64FPReg0   = 32,  // only 16 fp regs supported currently.
  kMips64FPRegEnd   = 48,
  kMips64RegHI    = kMips64FPRegEnd,
  kMips64RegLO,
  kMips64RegPC,
  kMips64RegEnd   = 51,
};

#define ENCODE_MIPS64_REG_LIST(N)      (static_cast<uint64_t>(N))
#define ENCODE_MIPS64_REG_SP           (1ULL << kMips64RegSP)
#define ENCODE_MIPS64_REG_LR           (1ULL << kMips64RegLR)
#define ENCODE_MIPS64_REG_PC           (1ULL << kMips64RegPC)
#define ENCODE_MIPS64_REG_HI           (1ULL << kMips64RegHI)
#define ENCODE_MIPS64_REG_LO           (1ULL << kMips64RegLO)
...
enum Mips64OpCode {
  ...
  kMipsMove,  // move d,s [000000] s[25..21] [00000] d[15..11] [00000101101].
  ...
  kMipsDsll,   // dsll d,t,a [00000000000] t[20..16] d[15..11] a[10..6] [111000].
  kMipsDsrl,   // dsrl d,t,a [00000000000] t[20..16] d[15..11] a[10..6] [111010].
  kMipsDsra,   // dsra d,t,a [00000000000] t[20..16] d[15..11] a[10..6] [111011].
  kMipsDsllv,  // dsllv d,t,s [000000] s[25..21] t[20..16] d[15..11] [00000010100].
  kMipsDsrlv,  // dsrlv d,t,s [000000] s[25..21] t[20..16] d[15..11] [00000010110].
  kMipsDsrav,  // dsrav d,t,s [000000] s[25..21] t[20..16] d[15..11] [00000010111].
...
extern Mips64EncodingMap EncodingMap[kMipsLast];
