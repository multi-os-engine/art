...
void Mips64Mir2Lir::GenArithOpFloat(Instruction::Code opcode,
...
void Mips64Mir2Lir::GenArithOpDouble(Instruction::Code opcode,
                                   RegLocation rl_dest, RegLocation rl_src1, RegLocation rl_src2) {
  int op = kMipsNop;
  RegLocation rl_result;
...
void Mips64Mir2Lir::GenCmpFP(Instruction::Code opcode, RegLocation rl_dest,
