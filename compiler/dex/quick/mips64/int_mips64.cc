 ...
 *
 */
void Mips64Mir2Lir::GenCmpLong(RegLocation rl_dest, RegLocation rl_src1,
                             RegLocation rl_src2) {
...
LIR* Mips64Mir2Lir::OpCmpImmBranch(ConditionCode cond, RegStorage reg, int check_value, LIR* target) {
  LIR* branch;
  if (check_value != 0) {
...
void Mips64Mir2Lir::GenMultiplyByTwoBitMultiplier(RegLocation rl_src,
...
void Mips64Mir2Lir::GenAddLong(Instruction::Code opcode, RegLocation rl_dest,
...
void Mips64Mir2Lir::GenSubLong(Instruction::Code opcode, RegLocation rl_dest,
                             RegLocation rl_src1, RegLocation rl_src2) {
  UNUSED(opcode);
  rl_src1 = LoadValueWide(rl_src1, kCoreReg);
  rl_src2 = LoadValueWide(rl_src2, kCoreReg);
...
void Mips64Mir2Lir::GenArithOpLong(Instruction::Code opcode, RegLocation rl_dest, RegLocation rl_src1,
...
void Mips64Mir2Lir::GenArithImmOpLong(Instruction::Code opcode,
