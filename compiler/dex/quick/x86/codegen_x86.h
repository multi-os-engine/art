...
class X86Mir2Lir : public Mir2Lir {
 ...
 protected:
  ...
  void CheckValidByteRegister(const X86EncodingMap* entry, uint8_t raw_reg);
  ...
  void EmitPrefixAndOpcode(const X86EncodingMap* entry,
                           uint8_t reg_r, uint8_t reg_x, uint8_t reg_b, bool r8_form);
   ...
   * @param condition The condition code for operation.
   */
  void EmitRegMemCond(const X86EncodingMap* entry, uint8_t reg1, uint8_t base, int displacement,
                      uint8_t condition);
