...
class X86Mir2Lir : public Mir2Lir {
  public:
    ...
    /*
     * @brief Force a location (in registers) into temporary registers
     * @param loc location of result
     */
    void ForceTemp(RegLocation& loc);
  ...
  private:
     ...
     * @param value Immeadiate value for the operation.  Used for byte variants
     ...
     * @param op Dex opcode for the operation
     * @param value Immeadiate value for the operation.
