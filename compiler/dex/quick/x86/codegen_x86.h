...
class X86Mir2Lir : public Mir2Lir {
  public:
    ...
    LIR* OpMem(OpKind op, int r_base, int disp);
    ...
    LIR* OpRegMem(OpKind op, int r_dest, int r_base, int offset);
    ...
    LIR* OpVldm(int r_base, int count);
    LIR* OpVstm(int r_base, int count);
    void OpLea(int r_base, int reg1, int reg2, int scale, int offset);
