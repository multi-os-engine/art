...
class X86Mir2Lir : public Mir2Lir {
  ...
  private:
    ...
    // Instructions needed patching with Method* values.
    GrowableArray<LIR*> method_address_insns_;

    // Instructions needed patching with Class Type* values.
    GrowableArray<LIR*> class_type_address_insns_;

    // Instructions needed patching with PC relative code addresses.
