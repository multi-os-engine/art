...
void X86CFIInitialization(std::vector<uint8_t>& cfi_info) {
  X86Mir2Lir::ReturnCommonCallFrameInformation(cfi_info);
}

void X86Mir2Lir::ReturnCommonCallFrameInformation(std::vector<uint8_t>& cfi_info) {
...
bool X86Mir2Lir::ReturnCallFrameInformation(std::vector<uint8_t>& cfi_info) {
  ...
  DCHECK(stack_decrement_ != nullptr);
