...
//  rX86_LR = RegStorage::kInvalidRegVal;
//  rX86_SUSPEND = RegStorage::kInvalidRegVal;
//  rX86_SELF = RegStorage::kInvalidRegVal;
//  rX86_PC = RegStorage::kInvalidRegVal;
}
