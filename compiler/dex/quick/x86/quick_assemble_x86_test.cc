...
class QuickAssembleX86Test : public testing::Test {
 protected:
  ...
  void TestVectorFn(InstructionSet target, AsmFn f, std::string inst_string) {
  ...
  void TestAddpd() {
    TestVectorFn(kX86, &X86Mir2Lir::GenAddVector, "addpd");
    TestVectorFn(kX86_64, &X86Mir2Lir::GenAddVector, "addpd");
  }

  void TestSubpd() {
    TestVectorFn(kX86, &X86Mir2Lir::GenSubtractVector, "subpd");
    TestVectorFn(kX86_64, &X86Mir2Lir::GenSubtractVector, "subpd");
  }

  void TestMulpd() {
    TestVectorFn(kX86, &X86Mir2Lir::GenMultiplyVector, "mulpd");
    TestVectorFn(kX86_64, &X86Mir2Lir::GenMultiplyVector, "mulpd");
  }
