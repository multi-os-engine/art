...
{ kX86 ## opname ## RA, kRegArray, IS_LOAD | IS_QUIN_OP     | reg_def | REG_USE12, { prefix, 0, 0x0F, opcode, opcode2, 0, 0, 0, false }, #opname "RA", "!0r,[!1r+!2r<<!3d+!4d]" }
  ...
  EXT_0F_ENCODING_MAP(Maxss,     0xF3, 0x5F, REG_DEF0_USE0),
  EXT_0F_ENCODING_MAP(Maxsd,     0xF2, 0x5F, REG_DEF0_USE0),
  EXT_0F_ENCODING_MAP(Minss,     0xF3, 0x5D, REG_DEF0_USE0),
  EXT_0F_ENCODING_MAP(Minsd,     0xF2, 0x5D, REG_DEF0_USE0),
