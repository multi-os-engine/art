...
enum X86NativeRegisterPool {
  ...
  xr0  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 0,
  xr1  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 1,
  xr2  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 2,
  xr3  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 3,
  xr4  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 4,
  xr5  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 5,
  xr6  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 6,
  xr7  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 7,
#ifdef TARGET_REX_SUPPORT
  xr8  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 8,
  xr9  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 9,
  xr10 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 10,
  xr11 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 11,
  xr12 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 12,
  xr13 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 13,
  xr14 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 14,
  xr15 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 15,
#endif
