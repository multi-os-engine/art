...
enum X86NativeRegisterPool {
  ...
  fr8  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 8,
  fr9  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 9,
  fr10 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 10,
  fr11 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 11,
  fr12 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 12,
  fr13 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 13,
  fr14 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 14,
  fr15 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 15,
#endif
...
#ifdef TARGET_REX_SUPPORTx
  dr8  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 8,
  dr9  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 9,
  dr10 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 10,
  dr11 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 11,
  dr12 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 12,
  dr13 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 13,
  dr14 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 14,
  dr15 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 15,
#endif
...
#ifdef TARGET_REX_SUPPORTx
  qr8  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 8,
  qr9  = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 9,
  qr10 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 10,
  qr11 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 11,
  qr12 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 12,
  qr13 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 13,
  qr14 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 14,
  qr15 = RegStorage::k128BitSolo | RegStorage::kFloatingPoint | 15,
#endif
...
#ifdef TARGET_REX_SUPPORTx
constexpr RegStorage rs_qr8(RegStorage::kValid | qr8);
constexpr RegStorage rs_qr9(RegStorage::kValid | qr9);
constexpr RegStorage rs_qr10(RegStorage::kValid | qr10);
constexpr RegStorage rs_qr11(RegStorage::kValid | qr11);
constexpr RegStorage rs_qr12(RegStorage::kValid | qr12);
constexpr RegStorage rs_qr13(RegStorage::kValid | qr13);
constexpr RegStorage rs_qr14(RegStorage::kValid | qr14);
constexpr RegStorage rs_qr15(RegStorage::kValid | qr15);
#endif
