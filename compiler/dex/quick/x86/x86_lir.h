...
const RegStorage rs_r4sp(RegStorage::kValid | r4sp);
...
const RegStorage rs_qr0(RegStorage::kValid | qr0);
const RegStorage rs_qr1(RegStorage::kValid | qr1);
const RegStorage rs_qr2(RegStorage::kValid | qr2);
const RegStorage rs_qr3(RegStorage::kValid | qr3);
const RegStorage rs_qr4(RegStorage::kValid | qr4);
const RegStorage rs_qr5(RegStorage::kValid | qr5);
const RegStorage rs_qr6(RegStorage::kValid | qr6);
const RegStorage rs_qr7(RegStorage::kValid | qr7);
...
const RegLocation x86_loc_c_return
    {kLocPhysReg, 0, 0, 0, 0, 0, 0, 0, 1, rs_rAX, INVALID_SREG, INVALID_SREG};
