...
static void GenSputCall(Mir2Lir* mir_to_lir, size_t component_size, bool is_object,
  ...
  DCHECK(component_size <= 8 && (component_size & (component_size -1)) == 0);
  // TODO hmmm....
  ThreadOffset<pointer_size> setter_offset =
      component_size == 8? QUICK_ENTRYPOINT_OFFSET(pointer_size, pSet64Static) :
        (component_size == 4? (is_object? QUICK_ENTRYPOINT_OFFSET(pointer_size, pSetObjStatic) : QUICK_ENTRYPOINT_OFFSET(pointer_size, pSet32Static)) :
          (component_size == 2? QUICK_ENTRYPOINT_OFFSET(pointer_size, pSet16Static) :
           QUICK_ENTRYPOINT_OFFSET(pointer_size, pSet8Static)));
...
static void GenSgetCall(Mir2Lir* mir_to_lir, size_t component_size, bool is_object,
  ...
  ThreadOffset<pointer_size> getter_offset =
      component_size == 8? QUICK_ENTRYPOINT_OFFSET(pointer_size, pGet64Static) :
        (component_size == 4? (is_object? QUICK_ENTRYPOINT_OFFSET(pointer_size, pGetObjStatic) : QUICK_ENTRYPOINT_OFFSET(pointer_size, pGet32Static)) :
          (component_size == 2? QUICK_ENTRYPOINT_OFFSET(pointer_size, pGet16Static) :
           QUICK_ENTRYPOINT_OFFSET(pointer_size, pGet8Static)));
...
static void GenIgetCall(Mir2Lir* mir_to_lir, size_t component_size, bool is_object,
  ...
  ThreadOffset<pointer_size> getter_offset =
      component_size == 8? QUICK_ENTRYPOINT_OFFSET(pointer_size, pGet64Instance) :
        (component_size == 4? (is_object? QUICK_ENTRYPOINT_OFFSET(pointer_size, pGetObjInstance) : QUICK_ENTRYPOINT_OFFSET(pointer_size, pGet32Instance)) :
          (component_size == 2? QUICK_ENTRYPOINT_OFFSET(pointer_size, pGet16Instance) :
           QUICK_ENTRYPOINT_OFFSET(pointer_size, pGet8Instance)));
...
static void GenIputCall(Mir2Lir* mir_to_lir, size_t component_size, bool is_object,
  ...
  ThreadOffset<pointer_size> setter_offset =
      component_size == 8? QUICK_ENTRYPOINT_OFFSET(pointer_size, pSet64Instance) :
        (component_size == 4? (is_object? QUICK_ENTRYPOINT_OFFSET(pointer_size, pSetObjInstance) : QUICK_ENTRYPOINT_OFFSET(pointer_size, pSet32Instance)) :
          (component_size == 2? QUICK_ENTRYPOINT_OFFSET(pointer_size, pSet16Instance) :
           QUICK_ENTRYPOINT_OFFSET(pointer_size, pSet8Instance)));
