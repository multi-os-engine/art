  ...
  switch (opcode) {
    ...
    case Instruction::APUT_OBJECT: {
      ...
      if (is_null || is_safe) {
        ...
        GenArrayPut(opt_flags, k32, rl_src[1], rl_src[2], rl_src[0], 2, !is_null);
      } else {
    ...
    case Instruction::IGET_OBJECT:
      GenIGet(mir, opt_flags, k32, rl_dest, rl_src[0], false, true);
      break;
    ...
    case Instruction::IPUT_OBJECT:
      GenIPut(mir, opt_flags, k32, rl_src[0], rl_src[1], false, true);
      break;
