...
#define A64_GET_INT_OFFS(offs) ((offs).Int64Value())
#endif
...
const RegStorage rs_r14lr(RegStorage::k32BitSolo, r30lr);
const RegStorage rs_rARM_LR(RegStorage::k32BitSolo, rARM_LR);
const RegStorage rs_r15pc(RegStorage::kInvalid);
const RegStorage rs_rARM_PC(RegStorage::kInvalid);
const RegStorage rs_invalid(RegStorage::kInvalid);

// TODO(Arm64): remove rs_rARM_ZR.
const RegStorage rs_rARM_ZR(RegStorage::kInvalid);
...
#define rARM_PC RegStorage::kInvalidRegVal
