...
void Arm64Mir2Lir::FlushRegWide(RegStorage reg) {
...
void Arm64Mir2Lir::FlushReg(RegStorage reg) {
  DCHECK(!reg.IsPair());
...
bool Arm64Mir2Lir::IsFpReg(RegStorage reg) {
...
LIR* Arm64Mir2Lir::CheckSuspendUsingLoad() {
  ...
  LoadWordDisp(rs_rARM_SELF, A64_THREAD_SUSPEND_TRIGGER_OFFSET, tmp);
