...
class Arm64Mir2Lir FINAL : public Mir2Lir {
 ...
 public:
  ...
  void GenLongPackedSwitch(MIR* mir, DexOffset table_offset, RegLocation rl_src) OVERRIDE;
  void GenLongSparseSwitch(MIR* mir, DexOffset table_offset, RegLocation rl_src) OVERRIDE;
