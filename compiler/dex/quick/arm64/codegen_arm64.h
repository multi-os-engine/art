...
class Arm64Mir2Lir FINAL : public Mir2Lir {
 protected:
  ...
  public:
    ...
    void GenSelect(RegStorage left_op, RegStorage right_op, ConditionCode code, uint32_t true_val,
                   uint32_t false_val, RegStorage rs_dest, int dest_reg_class) OVERRIDE;
    // Helper used in the above two.
    void GenSelect(uint32_t left, uint32_t right, ConditionCode code, RegStorage rs_dest,
