...
Mir2Lir* QuickCompiler::GetCodeGenerator(CompilationUnit* cu, void* compilation_unit) {
  ...
  switch (cu->instruction_set) {
    ...
    case kThumb2:
      ...
      break;
#endif  // ART_ENABLE_CODEGEN_arm || ART_ENABLE_CODEGEN_arm64
#ifdef ART_ENABLE_CODEGEN_arm64
    case kArm64:
    ...
    case kMips:
      // Fall-through.
      // Intentional 2 level ifdef. Want to fail on mips64 if not enabled, even if mips is.
    ...
    case kX86:
      // Fall-through.
      // Intentional 2 level ifdef. Want to fail on x86_64 if not enabled, even if x86 is.
