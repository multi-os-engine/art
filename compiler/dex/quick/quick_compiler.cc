...
Backend* QuickCompiler::GetCodeGenerator(CompilationUnit* cu, void* compilation_unit) const {
  ...
  switch (cu->instruction_set) {
    case kThumb2:
      mir_to_lir = new ArmMir2Lir(cu, cu->mir_graph.get(), &cu->arena);
      break;
    case kArm64:
      mir_to_lir = Arm64Mir2Lir(cu, cu->mir_graph.get(), &cu->arena);
      break;
    case kMips:
      mir_to_lir = new MipsMir2Lir(cu, cu->mir_graph.get(), &cu->arena);
      break;
    case kX86:
      // Fall-through.
    case kX86_64:
      mir_to_lir = new X86Mir2Lir(cu, cu->mir_graph.get(), &cu->arena);
      break;
    default:
