...
void Mir2Lir::GenInvokeNoInline(CallInfo* info) {
  ...
  std::string method_name = PrettyMethod(method_info.GetTargetMethod().dex_method_index,
                                         *method_info.GetTargetMethod().dex_file);
  if (method_name.find("java.lang.String.<init>") != std::string::npos) {
