...
int Mir2Lir::GenDalvikArgsRange(CallInfo* info, int call_state,
  ...
  // TODO(Ian): For 64-bit, instead of hardcoding 4 for Method* size, we should either
  ...
  if (cu_->instruction_set == kThumb2 && regs_left_to_pass_via_stack <= 16) {
    ...
    while (regs_left_to_pass_via_stack > 0) {
       ...
       */
      if (regs_left_to_pass_via_stack == 4 || (regs_left_to_pass_via_stack > 4 && (src_is_16b_aligned || dest_is_16b_aligned))) {
        ...
        LIR* ld1 = nullptr, * ld2 = nullptr, * st1 = nullptr, * st2 = nullptr;
