...
const RegStorage rs_r0(RegStorage::kValid | r0);
const RegStorage rs_r1(RegStorage::kValid | r1);
const RegStorage rs_r2(RegStorage::kValid | r2);
const RegStorage rs_r3(RegStorage::kValid | r3);
const RegStorage rs_rARM_SUSPEND(RegStorage::kValid | rARM_SUSPEND);
const RegStorage rs_r5(RegStorage::kValid | r5);
const RegStorage rs_r6(RegStorage::kValid | r6);
const RegStorage rs_r7(RegStorage::kValid | r7);
const RegStorage rs_r8(RegStorage::kValid | r8);
const RegStorage rs_rARM_SELF(RegStorage::kValid | rARM_SELF);
const RegStorage rs_r10(RegStorage::kValid | r10);
const RegStorage rs_r11(RegStorage::kValid | r11);
const RegStorage rs_r12(RegStorage::kValid | r12);
const RegStorage rs_r13sp(RegStorage::kValid | r13sp);
const RegStorage rs_rARM_SP(RegStorage::kValid | rARM_SP);
const RegStorage rs_r14lr(RegStorage::kValid | r14lr);
const RegStorage rs_rARM_LR(RegStorage::kValid | rARM_LR);
const RegStorage rs_r15pc(RegStorage::kValid | r15pc);
const RegStorage rs_rARM_PC(RegStorage::kValid | rARM_PC);
const RegStorage rs_invalid(RegStorage::kInvalid);

const RegStorage rs_fr0(RegStorage::kValid | fr0);
const RegStorage rs_fr1(RegStorage::kValid | fr1);
const RegStorage rs_fr2(RegStorage::kValid | fr2);
const RegStorage rs_fr3(RegStorage::kValid | fr3);
const RegStorage rs_fr4(RegStorage::kValid | fr4);
const RegStorage rs_fr5(RegStorage::kValid | fr5);
const RegStorage rs_fr6(RegStorage::kValid | fr6);
const RegStorage rs_fr7(RegStorage::kValid | fr7);
const RegStorage rs_fr8(RegStorage::kValid | fr8);
const RegStorage rs_fr9(RegStorage::kValid | fr9);
const RegStorage rs_fr10(RegStorage::kValid | fr10);
const RegStorage rs_fr11(RegStorage::kValid | fr11);
const RegStorage rs_fr12(RegStorage::kValid | fr12);
const RegStorage rs_fr13(RegStorage::kValid | fr13);
const RegStorage rs_fr14(RegStorage::kValid | fr14);
const RegStorage rs_fr15(RegStorage::kValid | fr15);
const RegStorage rs_fr16(RegStorage::kValid | fr16);
const RegStorage rs_fr17(RegStorage::kValid | fr17);
const RegStorage rs_fr18(RegStorage::kValid | fr18);
const RegStorage rs_fr19(RegStorage::kValid | fr19);
const RegStorage rs_fr20(RegStorage::kValid | fr20);
const RegStorage rs_fr21(RegStorage::kValid | fr21);
const RegStorage rs_fr22(RegStorage::kValid | fr22);
const RegStorage rs_fr23(RegStorage::kValid | fr23);
const RegStorage rs_fr24(RegStorage::kValid | fr24);
const RegStorage rs_fr25(RegStorage::kValid | fr25);
const RegStorage rs_fr26(RegStorage::kValid | fr26);
const RegStorage rs_fr27(RegStorage::kValid | fr27);
const RegStorage rs_fr28(RegStorage::kValid | fr28);
const RegStorage rs_fr29(RegStorage::kValid | fr29);
const RegStorage rs_fr30(RegStorage::kValid | fr30);
const RegStorage rs_fr31(RegStorage::kValid | fr31);

const RegStorage rs_dr0(RegStorage::kValid | dr0);
const RegStorage rs_dr1(RegStorage::kValid | dr1);
const RegStorage rs_dr2(RegStorage::kValid | dr2);
const RegStorage rs_dr3(RegStorage::kValid | dr3);
const RegStorage rs_dr4(RegStorage::kValid | dr4);
const RegStorage rs_dr5(RegStorage::kValid | dr5);
const RegStorage rs_dr6(RegStorage::kValid | dr6);
const RegStorage rs_dr7(RegStorage::kValid | dr7);
const RegStorage rs_dr8(RegStorage::kValid | dr8);
const RegStorage rs_dr9(RegStorage::kValid | dr9);
const RegStorage rs_dr10(RegStorage::kValid | dr10);
const RegStorage rs_dr11(RegStorage::kValid | dr11);
const RegStorage rs_dr12(RegStorage::kValid | dr12);
const RegStorage rs_dr13(RegStorage::kValid | dr13);
const RegStorage rs_dr14(RegStorage::kValid | dr14);
const RegStorage rs_dr15(RegStorage::kValid | dr15);
#if 0
const RegStorage rs_dr16(RegStorage::kValid | dr16);
const RegStorage rs_dr17(RegStorage::kValid | dr17);
const RegStorage rs_dr18(RegStorage::kValid | dr18);
const RegStorage rs_dr19(RegStorage::kValid | dr19);
const RegStorage rs_dr20(RegStorage::kValid | dr20);
const RegStorage rs_dr21(RegStorage::kValid | dr21);
const RegStorage rs_dr22(RegStorage::kValid | dr22);
const RegStorage rs_dr23(RegStorage::kValid | dr23);
const RegStorage rs_dr24(RegStorage::kValid | dr24);
const RegStorage rs_dr25(RegStorage::kValid | dr25);
const RegStorage rs_dr26(RegStorage::kValid | dr26);
const RegStorage rs_dr27(RegStorage::kValid | dr27);
const RegStorage rs_dr28(RegStorage::kValid | dr28);
const RegStorage rs_dr29(RegStorage::kValid | dr29);
const RegStorage rs_dr30(RegStorage::kValid | dr30);
const RegStorage rs_dr31(RegStorage::kValid | dr31);
#endif

const RegStorage rs_r0r1(RegStorage::k64BitPair, r0, r1);

// RegisterLocation templates return values (r0, or r0/r1).
const RegLocation arm_loc_c_return
    {kLocPhysReg, 0, 0, 0, 0, 0, 0, 0, 1, rs_r0, -1, -1};
const RegLocation arm_loc_c_return_wide
    {kLocPhysReg, 1, 0, 0, 0, 0, 0, 0, 1, rs_r0r1, INVALID_SREG, INVALID_SREG};
