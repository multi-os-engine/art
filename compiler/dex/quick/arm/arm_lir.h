...
const RegStorage rs_fr8(RegStorage::k32BitSolo, fr8);
const RegStorage rs_fr9(RegStorage::k32BitSolo, fr9);
...
const RegStorage rs_dr8(RegStorage::k64BitSolo, dr8);
const RegStorage rs_dr9(RegStorage::k64BitSolo, dr9);
...
#define rs_rARM_COUNT (RegStorage::InvalidReg())
