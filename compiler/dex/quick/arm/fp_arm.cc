...
static RegisterClass RegClassForAbsFP(RegLocation rl_src, RegLocation rl_dest) {
  ...
  // With both src and dest in the stack frame prefer...
  // TODO: Choose between fp reg (in anticipation of reusing the live value in subsequent insns)
  // and core reg (is load to/store from a core reg faster?)
  return kCoreReg;
}
