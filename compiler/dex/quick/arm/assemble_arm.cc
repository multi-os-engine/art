...
const ArmEncodingMap ArmMir2Lir::EncodingMap[kArmLast] = {
    ...
    ENCODING_MAP(kThumb2Vrintpd,       0xfeba0b40,
                 kFmtDfp, 22, 12, kFmtDfp, 5, 0, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "vrintp.f64 ", "!0S, !1S", 4, kFixupNone),
    ENCODING_MAP(kThumb2Vrintmd,       0xfebb0b40,
                 kFmtDfp, 22, 12, kFmtDfp, 5, 0, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "vrintm.f64 ", "!0S, !1S", 4, kFixupNone),
    ENCODING_MAP(kThumb2Vrintnd,       0xfeb90b40,
                 kFmtDfp, 22, 12, kFmtDfp, 5, 0, kFmtUnused, -1, -1,
                 kFmtUnused, -1, -1, IS_BINARY_OP | REG_DEF0_USE1,
                 "vrintn.f64 ", "!0S, !1S", 4, kFixupNone),
    ...
    ENCODING_MAP(kThumb2RbitRR, 0xfa90f0a0,
                 kFmtBitBlt, 11, 8, kFmtBitBlt, 19, 16, kFmtBitBlt, 3, 0,
                 kFmtUnused, -1, -1,
                 IS_TERTIARY_OP | REG_DEF0_USE12,  // Binary, but rm is stored twice.
                 "rbit", "!0C, !1C", 4, kFixupNone),
