...
/*
 * Call out to quick entrypoint. For more details see monitor.cc.
 */
...
/*
 * Call out to quick entrypoint. For more details see monitor.cc. Note the code below doesn't
 * use ldrex/strex as the code holds the lock and can only give away ownership if its suspended.
 */
