...
bool DexFileMethodInliner::AnalyseMethodCode(uint32_t method_idx,
  ...
  switch (opcode) {
    ...
    case Instruction::RETURN_OBJECT:
      return CheckReturnMethod(method_idx, code_item, kWord);
    case Instruction::RETURN_WIDE:
      return CheckReturnMethod(method_idx, code_item, kLong);
    case Instruction::CONST:
    case Instruction::CONST_4:
    case Instruction::CONST_16:
    case Instruction::CONST_HIGH16:
      // TODO: Support wide constants (RETURN_WIDE).
      return CheckConstMethod(method_idx, code_item);
    case Instruction::IGET:
      return CheckIGetMethod(method_idx, code_item, kWord, false);
    case Instruction::IGET_OBJECT:
      return CheckIGetMethod(method_idx, code_item, kWord, true);
    case Instruction::IGET_BOOLEAN:
    case Instruction::IGET_BYTE:
      return CheckIGetMethod(method_idx, code_item, kSignedByte, false);
    case Instruction::IGET_CHAR:
      return CheckIGetMethod(method_idx, code_item, kUnsignedHalf, false);
    case Instruction::IGET_SHORT:
      return CheckIGetMethod(method_idx, code_item, kSignedHalf, false);
    case Instruction::IGET_WIDE:
      return CheckIGetMethod(method_idx, code_item, kLong, false);
    case Instruction::IPUT:
      return CheckIPutMethod(method_idx, code_item, kWord, false);
    case Instruction::IPUT_OBJECT:
      return CheckIPutMethod(method_idx, code_item, kWord, true);
    case Instruction::IPUT_BOOLEAN:
    case Instruction::IPUT_BYTE:
      return CheckIPutMethod(method_idx, code_item, kSignedByte, false);
    case Instruction::IPUT_CHAR:
      return CheckIPutMethod(method_idx, code_item, kUnsignedHalf, false);
    case Instruction::IPUT_SHORT:
      return CheckIPutMethod(method_idx, code_item, kSignedHalf, false);
    case Instruction::IPUT_WIDE:
      return CheckIPutMethod(method_idx, code_item, kLong, false);
    default:
      return false;
    }
}
...
bool DexFileMethodInliner::CheckReturnMethod(int32_t method_idx, const DexFile::CodeItem* code_item,
                                             OpSize size) {
  ...
  InlineMethodOpcode op = size == kLong ? kInlineOpReturnWide : kInlineOpReturn;
  return AddInlineMethod(method_idx, op, kInlineSpecial, reg - arg_start);
}

bool DexFileMethodInliner::CheckConstMethod(int32_t method_idx,
                                            const DexFile::CodeItem* code_item) {
  const Instruction* instruction = Instruction::At(code_item->insns_);
...
bool DexFileMethodInliner::CheckIGetMethod(int32_t method_idx, const DexFile::CodeItem* code_item,
...
bool DexFileMethodInliner::CheckIPutMethod(int32_t method_idx, const DexFile::CodeItem* code_item,
                                           OpSize size, bool is_object) {
  const Instruction* instruction = Instruction::At(code_item->insns_);
  const Instruction* return_instruction = instruction->Next();
  if (return_instruction->Opcode() != Instruction::RETURN_VOID) {
