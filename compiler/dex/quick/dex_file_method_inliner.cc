...
static MIR* AllocReplacementMIR(MIRGraph* mir_graph, MIR* invoke) {
...
static uint32_t GetInvokeReg(MIR* invoke, uint32_t arg) {
...
static bool WideArgIsInConsecutiveDalvikRegs(MIR* invoke, uint32_t arg) {
