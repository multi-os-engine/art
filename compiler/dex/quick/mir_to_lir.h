...
class Mir2Lir : public Backend {
  public:
     ...
     * @param method The MethodReference of the method to be invoked.
     * @param type How the method will be invoked.
     * @param register that will contain the code address.
     * @note register will be passed to TargetReg to get physical register.
     */
    void LoadCodeAddress(const MethodReference& method, InvokeType type,
     ...
     * @note register will be passed to TargetReg to get physical register.
     */
    virtual void LoadMethodAddress(const MethodReference& dex_method_index, InvokeType type,
                                   SpecialTargetRegister symbolic_reg);
