...
class Mir2Lir : public Backend {
  public:
    ...
    static constexpr uint16_t kShortSwitchThreshold = 5;
    ...
    virtual void GenShortPackedSwitch(MIR* mir, DexOffset table_offset, RegLocation rl_src);
    virtual void GenShortSparseSwitch(MIR* mir, DexOffset table_offset, RegLocation rl_src);
    // Backend-specific versions of switch instructions for longer switch statements.
    virtual void GenLongPackedSwitch(MIR* mir, DexOffset table_offset, RegLocation rl_src) = 0;
    virtual void GenLongSparseSwitch(MIR* mir, DexOffset table_offset, RegLocation rl_src) = 0;
