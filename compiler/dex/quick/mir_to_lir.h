...
class LIRSlowPath {
 ...
 public:
  LIRSlowPath(Mir2Lir* const m2l, const DexOffset dexpc, LIR* const fromfast,
              LIR* const cont = nullptr) :
    m2l_(m2l), current_dex_pc_(dexpc), fromfast_(fromfast), cont_(cont), next_(nullptr) {
  }
  virtual ~LIRSlowPath() {}
...
class Mir2Lir : public Backend {
  ...
  private:
    ...
    void SetCurrentDexPc(const DexOffset dexpc) {
  ...
  protected:
    ...
    LIRSlowPath* slow_paths_;
    LIRSlowPath* last_slow_path_;
};  // Class Mir2Lir
