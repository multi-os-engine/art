...
class Mir2Lir : public Backend {
  ...
  protected:
    ...
    static OpSize LoadStoreOpSize(size_t component_size, bool ref) {
      DCHECK(component_size == 1 || component_size == 2 || component_size == 4 || component_size == 8) << "Attempted to allocated with size " << component_size;
      // WIP!
      return component_size == 8? k64 : (component_size == 4? (ref? kReference : k32) : (component_size == 2? k16 : kSignedByte));
    }
