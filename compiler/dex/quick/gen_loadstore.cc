...
/* Load a reference at base + displacement.  Displacement must be word multiple */
LIR* Mir2Lir::LoadRefDisp(RegStorage r_base, int displacement, RegStorage r_dest) {
...
LIR* Mir2Lir::StoreRefDisp(RegStorage r_base, int displacement, RegStorage r_src) {
