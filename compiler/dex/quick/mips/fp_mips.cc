...
void MipsMir2Lir::GenCmpFP(Instruction::Code opcode, RegLocation rl_dest,
  ...
  if (wide) {
    ...
    LoadValueDirectFixed(rl_src1, RegStorage(RegStorage::k32BitSolo, rMIPS_FARG0));
    LoadValueDirectFixed(rl_src2, RegStorage(RegStorage::k32BitSolo, rMIPS_FARG2));
  }
  RegStorage r_tgt(RegStorage::k32BitSolo, LoadHelper(offset));
