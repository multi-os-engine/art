...
class MipsMir2Lir : public Mir2Lir {
  public:
    ...
    LIR* LoadBaseDisp(RegStorage r_base, int displacement, RegStorage r_dest, OpSize size,
                      int s_reg);
    LIR* LoadBaseDispWide(int r_base, int displacement, int r_dest_lo, int r_dest_hi, int s_reg);
    LIR* LoadBaseIndexed(int r_base, int r_index, int r_dest, int scale, OpSize size);
    LIR* LoadBaseIndexed(RegStorage r_base, RegStorage r_index, RegStorage r_dest, int scale,
                         OpSize size);
    LIR* LoadBaseIndexedDisp(int r_base, int r_index, int scale, int displacement, int r_dest,
    ...
    LIR* StoreBaseIndexedDisp(int r_base, int r_index, int scale, int displacement, int r_src,
                              int r_src_hi, OpSize size, int s_reg);
    ...
    void GenDivZeroCheck(RegStorage reg_lo, RegStorage reg_hi);
