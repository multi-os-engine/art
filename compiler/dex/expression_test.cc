...
TEST_F(ExpressionTest, SimpleALU) {
  ...
  static const MIRDef mirs[] = {
      DEF_MIR(Instruction::ADD_INT, 3u, 0u, 5u, 3u),  // Unresolved.
      DEF_MIR(Instruction::MUL_INT, 3u, 0u, 0u, 3u),  // Unresolved.
      DEF_MIR(Instruction::ADD_INT, 3u, 0u, 0u, 4u),  // Unresolved.
  };
