...
void MIRGraph::InitializeConstantPropagation(void) {
...
void MIRGraph::InitializeMethodUses(void) {
...
void MIRGraph::InitializeSSATransformation(void) {
...
void MIRGraph::CheckSSARegisterVector(void) {
