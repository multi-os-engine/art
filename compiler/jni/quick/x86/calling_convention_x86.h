...
class X86JniCallingConvention FINAL : public JniCallingConvention {
 ...
 private:
  ...
  JniCallingConvention* CreateJniCallingConvention(bool is_static, bool is_synchronized, const char* shorty, InstructionSet instruction_set);
  ManagedRuntimeCallingConvention* CreateManagedRuntimeCallingConvention(bool is_static, bool is_synchronized, const char* shorty, InstructionSet instruction_set);
