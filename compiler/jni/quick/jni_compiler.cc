...
CompiledMethod* ArtJniCompileMethodInternal(CompilerDriver* driver,
  ...
  if (is_64_bit_target) {
    __ CopyRawPtrFromThread64(main_jni_conv->HandleScopeLinkOffset(),
                              Thread::TopHandleScopeOffset<PointerSize::kPointerSize64>(),
                              mr_conv->InterproceduralScratchRegister());
    __ StoreStackOffsetToThread64(Thread::TopHandleScopeOffset<PointerSize::kPointerSize64>(),
                                  main_jni_conv->HandleScopeOffset(),
                                  mr_conv->InterproceduralScratchRegister());
  } else {
    __ CopyRawPtrFromThread32(main_jni_conv->HandleScopeLinkOffset(),
                              Thread::TopHandleScopeOffset<PointerSize::kPointerSize32>(),
                              mr_conv->InterproceduralScratchRegister());
    __ StoreStackOffsetToThread32(Thread::TopHandleScopeOffset<PointerSize::kPointerSize32>(),
                                  main_jni_conv->HandleScopeOffset(),
                                  mr_conv->InterproceduralScratchRegister());
  }
  ...
  if (is_64_bit_target) {
    __ StoreStackPointerToThread64(Thread::TopOfManagedStackOffset<PointerSize::kPointerSize64>());
  } else {
    __ StoreStackPointerToThread32(Thread::TopOfManagedStackOffset<PointerSize::kPointerSize32>());
  }
  ...
  if (kUseReadBarrier && is_static) {
    ThreadOffset32 read_barrier32 =
        QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize32, pReadBarrierJni);
    ThreadOffset64 read_barrier64 =
        QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize64, pReadBarrierJni);
  ...
  ThreadOffset32 jni_start32 =
      is_synchronized
          ? QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize32, pJniMethodStartSynchronized)
          : QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize32, pJniMethodStart);
  ThreadOffset64 jni_start64 =
      is_synchronized
          ? QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize64, pJniMethodStartSynchronized)
          : QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize64, pJniMethodStart);
  main_jni_conv->ResetIterator(FrameOffset(main_out_arg_size));
  ...
  if (main_jni_conv->IsCurrentParamInRegister()) {
    ...
    if (is_64_bit_target) {
      __ LoadRawPtrFromThread64(jni_env, Thread::JniEnvOffset<PointerSize::kPointerSize64>());
    } else {
      __ LoadRawPtrFromThread32(jni_env, Thread::JniEnvOffset<PointerSize::kPointerSize32>());
    }
  } else {
    FrameOffset jni_env = main_jni_conv->CurrentParamStackOffset();
    if (is_64_bit_target) {
      __ CopyRawPtrFromThread64(jni_env, Thread::JniEnvOffset<PointerSize::kPointerSize64>(),
                                main_jni_conv->InterproceduralScratchRegister());
    } else {
      __ CopyRawPtrFromThread32(jni_env, Thread::JniEnvOffset<PointerSize::kPointerSize32>(),
                                main_jni_conv->InterproceduralScratchRegister());
    }
  }
  ...
  if (reference_return) {
    ...
    jni_end32 = is_synchronized
        ? QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize32,
                                  pJniMethodEndWithReferenceSynchronized)
        : QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize32, pJniMethodEndWithReference);
    jni_end64 = is_synchronized
        ? QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize64,
                                  pJniMethodEndWithReferenceSynchronized)
        : QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize64, pJniMethodEndWithReference);
    SetNativeParameter(jni_asm.get(), end_jni_conv.get(), end_jni_conv->ReturnRegister());
    end_jni_conv->Next();
  } else {
    jni_end32 = is_synchronized
        ? QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize32, pJniMethodEndSynchronized)
        : QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize32, pJniMethodEnd);
    jni_end64 = is_synchronized
        ? QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize64, pJniMethodEndSynchronized)
        : QUICK_ENTRYPOINT_OFFSET(PointerSize::kPointerSize64, pJniMethodEnd);
  }
