...
namespace {
  ...
  bool IsFormOptimizingCompiler(const MethodDebugInfo* method_info) {
  ...
  class CompilationUnitWriter {
   public:
    ...
    void WriteRegLocation(const MethodDebugInfo* method_info,
      ...
      if (!IsFormOptimizingCompiler(method_info)) {
        return;
      }
