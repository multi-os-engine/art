  ...
  class CompilationUnitWriter {
   public:
    ...
    void Write(const CompilationUnit& compilation_unit) {
      ...
      for (auto method_info : compilation_unit.methods_) {
      ...
      info_.WriteAddr(DW_AT_low_pc, text_address + cunit_low_pc);
      info_.WriteAddr(DW_AT_high_pc, text_address + cunit_high_pc);
