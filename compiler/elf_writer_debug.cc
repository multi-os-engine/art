...
void WriteCFISection(ElfBuilder<ElfTypes>* builder,
  ...
  if (format == DW_EH_FRAME_FORMAT) {
    ...
    builder->WriteOatPatchesSection(cfi_section, &patch_locations);
  }
}
...
void WriteDebugSections(ElfBuilder<ElfTypes>* builder,
  ...
  builder->WriteSection(".debug_info", &debug_info, &debug_info_patches);
  builder->WriteSection(".debug_abbrev", &debug_abbrev, nullptr);
  builder->WriteSection(".debug_str", &debug_str, nullptr);
  builder->WriteSection(".debug_line", &debug_line, &debug_line_patches);
}
