...
class ImageWriter FINAL {
 ...
 private:
  ...
  // Return true if klass class reaches a boot class loader non image class. We want to prune these
  // classes since we do not want any boot class loader classes in the image.
