...
class ImageWriter FINAL {
 ...
 private:
  ...
  enum Bin {
    // Dex cache arrays have a special slot for PC-relative addressing. Since they
    // are huge, their dirtiness is not important for the clean/dirty separation,
  ...
  // Slots for dex cache arrays (objects are inside of the image so that they don't move).
  SafeMap<mirror::Object*, size_t> dex_cache_array_slots_;
