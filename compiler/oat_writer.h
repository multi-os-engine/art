...
class OatWriter {
 public:
  ...
  class DexFileSource {
   public:
    DexFileSource(ZipEntry* zip_entry) : type_(kZipEntry), source_(zip_entry) { }
    DexFileSource(File* raw_file) : type_(kRawFile), source_(raw_file) { }
    DexFileSource(const DexFile* dex_file) : type_(kDexFile), source_(dex_file) { }
