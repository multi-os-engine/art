 ...
 private:
  ...
  class OatClass {
   public:
    ...
    // CompiledMethods for each class_def_method_index, or nullptr if no method is available.
    ...
    // nullptr and that the OatClass::type_ should be kOatClassBitmap.
    ...
    // not is kOatClassBitmap, the bitmap will be nullptr.
    ...
    // OatClass::compiled_methods_ contains nullptr values (and
