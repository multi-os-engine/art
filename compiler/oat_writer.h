...
class OatWriter {
 ...
 private:
  ...
  bool ExtendForTypeLookupTables(OutputStream* rodata, File* file);
  ...
  std::unique_ptr<MemMap> dex_files_map_;
  std::vector<std::unique_ptr<const DexFile>> owned_dex_files_;
