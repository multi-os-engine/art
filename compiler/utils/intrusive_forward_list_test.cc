...
TEST(IntrusiveForwardList, ConstructRange) {
  std::forward_list<int> ref { 1, 2, 7 };  // NOLINT(readability/braces)
...
TEST(IntrusiveForwardList, Assign) __attribute__((optnone)) {
  std::forward_list<int> ref1 { 2, 8, 5 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage1(ref1.begin(), ref1.end());
  IntrusiveForwardList<IFLTestValue> ifl;
  ifl.assign(storage1.begin(), storage1.end());
  ASSERT_LISTS_EQUAL(ref1, ifl);
  std::forward_list<int> ref2 { 7, 1, 3 };  // NOLINT(readability/braces)
...
TEST(IntrusiveForwardList, InsertAfter2) {
  ...
  std::vector<IFLTestValue> storage1 { { 2 }, { 8 }, { 5 } };  // NOLINT(readability/braces)
  auto ifl_it = ifl.insert_after(ifl.before_begin(), storage1.begin(), storage1.end());
  ASSERT_LISTS_EQUAL(ref, ifl);
  ASSERT_EQ(*ref_it, *ifl_it);

  std::vector<IFLTestValue> storage2 { { 7 }, { 2 } };  // NOLINT(readability/braces)
  ref_it = ref.insert_after(ref.begin(), { 7, 2 });
  ifl_it = ifl.insert_after(ifl.begin(), storage2.begin(), storage2.end());
  ASSERT_LISTS_EQUAL(ref, ifl);
  ASSERT_EQ(*ref_it, *ifl_it);

  std::vector<IFLTestValue> storage3 { { 1 }, { 3 }, { 4 }, { 9 } };  // NOLINT(readability/braces)
  ref_it = ref.begin();
  ifl_it = ifl.begin();
...
TEST(IntrusiveForwardList, EraseAfter1) {
  std::forward_list<int> ref { 1, 2, 7, 4, 5 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage(ref.begin(), ref.end());
  IntrusiveForwardList<IFLTestValue> ifl(storage.begin(), storage.end());
  ASSERT_LISTS_EQUAL(ref, ifl);
...
TEST(IntrusiveForwardList, EraseAfter2) {
  std::forward_list<int> ref { 1, 2, 7, 4, 5, 3, 2, 8, 9 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage(ref.begin(), ref.end());
  IntrusiveForwardList<IFLTestValue> ifl(storage.begin(), storage.end());
  ASSERT_LISTS_EQUAL(ref, ifl);
...
TEST(IntrusiveForwardList, SwapClear) {
  std::forward_list<int> ref1 { 1, 2, 7 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage1(ref1.begin(), ref1.end());
  IntrusiveForwardList<IFLTestValue> ifl1(storage1.begin(), storage1.end());
  std::forward_list<int> ref2 { 3, 8, 6 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage2(ref2.begin(), ref2.end());
...
TEST(IntrusiveForwardList, SpliceAfter) {
  std::forward_list<int> ref1 { 3, 1, 2, 7, 4, 5, 4, 8, 7 };  // NOLINT(readability/braces)
  ...
  std::forward_list<int> check { 3, 1, 7, 4, 5, 4, 8, 7, 2 };  // NOLINT(readability/braces)
...
TEST(IntrusiveForwardList, Remove) {
  std::forward_list<int> ref { 3, 1, 2, 7, 4, 5, 4, 8, 7 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage(ref.begin(), ref.end());
  IntrusiveForwardList<IFLTestValue> ifl(storage.begin(), storage.end());
  ASSERT_LISTS_EQUAL(ref, ifl);
  ref.remove(1);
  ...
  ifl.remove(4);
  ASSERT_LISTS_EQUAL(ref, ifl);
  auto odd = [](IFLTestValue value) { return (value.value & 1) != 0; };
  ref.remove_if(odd);
  ifl.remove_if(odd);
  ASSERT_LISTS_EQUAL(ref, ifl);
  auto all = [](IFLTestValue value ATTRIBUTE_UNUSED) { return true; };
  ref.remove_if(all);
  ifl.remove_if(all);
  ASSERT_LISTS_EQUAL(ref, ifl);
}
...
TEST(IntrusiveForwardList, Unique) {
  std::forward_list<int> ref { 3, 1, 1, 2, 3, 3, 7, 7, 4, 4, 5, 7 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage(ref.begin(), ref.end());
  IntrusiveForwardList<IFLTestValue> ifl(storage.begin(), storage.end());
  ASSERT_LISTS_EQUAL(ref, ifl);
  ref.unique();
  ifl.unique();
  ASSERT_LISTS_EQUAL(ref, ifl);
  std::forward_list<int> check { 3, 1, 2, 3, 7, 4, 5, 7 };  // NOLINT(readability/braces)
...
TEST(IntrusiveForwardList, Merge) {
  std::forward_list<int> ref1 { 1, 4, 8, 8, 12 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage1(ref1.begin(), ref1.end());
  IntrusiveForwardList<IFLTestValue> ifl1(storage1.begin(), storage1.end());
  std::forward_list<int> ref2 { 3, 5, 6, 7, 9 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage2(ref2.begin(), ref2.end());
  IntrusiveForwardList<IFLTestValue> ifl2(storage2.begin(), storage2.end());
  ASSERT_LISTS_EQUAL(ref1, ifl1);
  ASSERT_LISTS_EQUAL(ref2, ifl2);
  ...
  ASSERT_LISTS_EQUAL(ref2, ifl2);
  CHECK(ref2.empty());
  std::forward_list<int> check { 1, 3, 4, 5, 6, 7, 8, 8, 9, 12 };  // NOLINT(readability/braces)
  ASSERT_LISTS_EQUAL(check, ifl1);
}

TEST(IntrusiveForwardList, Sort1) {
  std::forward_list<int> ref { 2, 9, 8, 3, 7, 4, 1, 5, 3, 0 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage(ref.begin(), ref.end());
  IntrusiveForwardList<IFLTestValue> ifl(storage.begin(), storage.end());
  ASSERT_LISTS_EQUAL(ref, ifl);
  ...
  ifl.sort();
  ASSERT_LISTS_EQUAL(ref, ifl);
  std::forward_list<int> check { 0, 1, 2, 3, 3, 4, 5, 7, 8, 9 };  // NOLINT(readability/braces)
  ASSERT_LISTS_EQUAL(check, ifl);
}
...
TEST(IntrusiveForwardList, Sort2) {
  ...
  ifl.sort(cmp);
  ASSERT_LISTS_EQUAL(ref, ifl);
  std::forward_list<int> check { 1, 0, 2, 3, 3, 4, 5, 7, 9, 8 };  // NOLINT(readability/braces)
  ASSERT_LISTS_EQUAL(check, ifl);
}

TEST(IntrusiveForwardList, Reverse) {
  std::forward_list<int> ref { 8, 3, 5, 4, 1, 3 };  // NOLINT(readability/braces)
  std::vector<IFLTestValue> storage(ref.begin(), ref.end());
  IntrusiveForwardList<IFLTestValue> ifl(storage.begin(), storage.end());
  ASSERT_LISTS_EQUAL(ref, ifl);
  CHECK(!std::is_sorted(ref.begin(), ref.end()));
  ...
  ifl.reverse();
  ASSERT_LISTS_EQUAL(ref, ifl);
  std::forward_list<int> check { 3, 1, 4, 5, 3, 8 };  // NOLINT(readability/braces)
  ASSERT_LISTS_EQUAL(check, ifl);
}
