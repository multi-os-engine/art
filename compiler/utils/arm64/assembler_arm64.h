...
class Arm64Assembler FINAL : public Assembler {
 public:
  ...
  // Set up out_reg to hold a Object** into the handle scope, or to be nullptr if the
  ...
  // Set up out_off to hold a Object** into the handle scope, or to be nullptr if the
