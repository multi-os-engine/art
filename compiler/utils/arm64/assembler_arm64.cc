...
void Arm64Assembler::StoreImmediateToThread64(ThreadOffset64 offs, uint32_t imm,
                                            ManagedRegister m_scratch) {
  Arm64ManagedRegister scratch = m_scratch.AsArm64();
  CHECK(scratch.IsXRegister()) << scratch;
  LoadImmediate(scratch.AsXRegister(), imm);
...
void Arm64Assembler::CallFromThread64(ThreadOffset64 /*offset*/, ManagedRegister /*scratch*/) {
