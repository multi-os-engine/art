...
extern void PushWord(std::vector<uint8_t>* buf, int32_t data);
extern void EncodeUnsignedLeb128(uint32_t data, std::vector<uint8_t>* buf);
extern void EncodeSignedLeb128(int32_t data, std::vector<uint8_t>* buf);
