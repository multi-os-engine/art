...
#include "assembler_arm32_test_expected.cc.inc"
...
TEST(Arm32AssemblerTest, SimpleMov) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, SimpleMov32) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, SimpleMovAdd) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, DataProcessingRegister) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
  ...
  // 16 bit variants.
  __ add(R0, R1, ShifterOperand(0));
  __ sub(R0, R1, ShifterOperand(0));
  __ and_(R0, R1, ShifterOperand(0));
  __ orr(R0, R1, ShifterOperand(0));
  __ eor(R0, R1, ShifterOperand(0));
  __ bic(R0, R1, ShifterOperand(0));
  __ adc(R0, R1, ShifterOperand(0));
  __ sbc(R0, R1, ShifterOperand(0));
...
TEST(Arm32AssemblerTest, DataProcessingImmediate) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, DataProcessingModifiedImmediate) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, DataProcessingModifiedImmediates) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, DataProcessingShiftedRegister) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, BasicLoad) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, BasicStore) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, ComplexLoad) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, ComplexStore) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, NegativeLoadStore) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, SimpleLoadStoreDual) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, ComplexLoadStoreDual) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, NegativeLoadStoreDual) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, SimpleBranch) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, LongBranch) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
  // 32 bit branches.
  Label l1;
  __ mov(R0, ShifterOperand(2));
...
TEST(Arm32AssemblerTest, LoadMultiple) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, StoreMultiple) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, MovWMovT) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, SpecialAddSub) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, StoreToOffset) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, IfThen) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
// This test is named "CbzCbnz" to match a test with the same name in
// assembler_thumb_test.cc, but it does not contain CBZ or CBNZ
// instructions, as they are not supported on ARM32.
TEST(Arm32AssemblerTest, CbzCbnz) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));

  Label l1;
  // Use CMP and BEQ instead of CBZ, as the latter is not supported on ARM32.
  ...
  Label l2;
  // Use CMP and BNE instead of CBNZ, as the latter is not supported on ARM32.
  __ cmp(R2, ShifterOperand(0));
  __ b(&l2, NE);
...
TEST(Arm32AssemblerTest, Multiply) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, Divide) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, BasicFloatingPoint) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, FloatingPointConversions) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, FloatingPointComparisons) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, Breakpoint) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, VPushPop) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, Max16BitBranch) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, Branch32) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, CompareAndBranchMax) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, CompareAndBranchRelocation16) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, CompareAndBranchRelocation32) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, MixedBranch32) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, Shifts) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, LoadStoreRegOffset) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, LoadStoreLiteral) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
...
TEST(Arm32AssemblerTest, LoadStoreLimits) {
  arm::Arm32Assembler* assembler = static_cast<arm::Arm32Assembler*>(Assembler::Create(kArm));
