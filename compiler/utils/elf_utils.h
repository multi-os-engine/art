...
#ifndef ART_COMPILER_UTILS_ELF_UTILS_H_
#define ART_COMPILER_UTILS_ELF_UTILS_H_

// Include the micro-API to avoid potential macro conflicts.
...
#endif  // ART_COMPILER_UTILS_ELF_UTILS_H_
