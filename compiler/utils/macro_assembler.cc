...
using MacroAsm32UniquePtr = std::unique_ptr<MacroAssembler<PointerSize::k32>>;

template <>
MacroAsm32UniquePtr MacroAssembler<PointerSize::k32>::Create(
...
using MacroAsm64UniquePtr = std::unique_ptr<MacroAssembler<PointerSize::k64>>;

template <>
MacroAsm64UniquePtr MacroAssembler<PointerSize::k64>::Create(
    ArenaAllocator* arena,
    InstructionSet instruction_set,
