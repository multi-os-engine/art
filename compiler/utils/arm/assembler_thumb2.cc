...
void Thumb2Assembler::vldmiad(Register base_reg, DRegister reg, int nregs, Condition cond) {
  int32_t rest = B23;
  EmitVLdmOrStm(rest, static_cast<uint32_t>(reg), nregs, base_reg, /*is_load*/ true, true, cond);
}


void Thumb2Assembler::vstmiad(Register base_reg, DRegister reg, int nregs, Condition cond) {
  int32_t rest = B23;
  EmitVLdmOrStm(rest, static_cast<uint32_t>(reg), nregs, base_reg, /*is_load*/ false, true, cond);
}
