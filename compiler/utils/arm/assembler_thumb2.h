...
class Thumb2Assembler FINAL : public ArmAssembler {
 public:
  static std::unique_ptr<Thumb2Assembler> Create(ArenaAllocator* arena,
                                                 bool can_relocate_branches = true) {
    return std::unique_ptr<Thumb2Assembler>(
        new (arena) Thumb2Assembler(arena, can_relocate_branches));
  }
