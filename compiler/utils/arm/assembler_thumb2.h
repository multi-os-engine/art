 ...
 private:
  ...
  class Fixup {
   public:
    ...
    // Load narrow literal.
    static Fixup LoadNarrow(uint32_t location, Register rt, Size size = kLiteral1KiB) {
    ...
    // Load wide literal.
    static Fixup LoadWide(uint32_t location, Register rt, Register rt2,
    ...
    static Fixup LoadSingle(uint32_t location, SRegister sd, Size size = kLongOrFPLiteral1KiB) {
      DCHECK(size == kLongOrFPLiteral1KiB || size == kLongOrFPLiteral256KiB ||
             size == kLongOrFPLiteralFar);
    ...
    static Fixup LoadDouble(uint32_t location, DRegister dd, Size size = kLongOrFPLiteral1KiB) {
      DCHECK(size == kLongOrFPLiteral1KiB || size == kLongOrFPLiteral256KiB ||
             size == kLongOrFPLiteralFar);
