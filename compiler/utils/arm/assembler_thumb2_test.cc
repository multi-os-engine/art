...
TEST_F(AssemblerThumb2Test, TwoCbzMaxOffset) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label0.Position()) + 0u, __ AdjustedPosition(label0.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label1.Position()) + 0u, __ AdjustedPosition(label1.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label2.Position()) + 0u, __ AdjustedPosition(label2.Position()));
}
...
TEST_F(AssemblerThumb2Test, TwoCbzBeyondMaxOffset) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label0.Position()) + 2u, __ AdjustedPosition(label0.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label1.Position()) + 4u, __ AdjustedPosition(label1.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label2.Position()) + 4u, __ AdjustedPosition(label2.Position()));
}
...
TEST_F(AssemblerThumb2Test, TwoCbzSecondAtMaxB16Offset) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label0.Position()) + 0u, __ AdjustedPosition(label0.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label1.Position()) + 2u, __ AdjustedPosition(label1.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label2.Position()) + 2u, __ AdjustedPosition(label2.Position()));
}
...
TEST_F(AssemblerThumb2Test, TwoCbzSecondBeyondMaxB16Offset) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label0.Position()) + 2u, __ AdjustedPosition(label0.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label1.Position()) + 6u, __ AdjustedPosition(label1.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label2.Position()) + 6u, __ AdjustedPosition(label2.Position()));
}
...
TEST_F(AssemblerThumb2Test, TwoCbzFirstBeyondMaxB16Offset) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label0.Position()) + 4u, __ AdjustedPosition(label0.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label1.Position()) + 6u, __ AdjustedPosition(label1.Position()));
  EXPECT_EQ(static_cast<uint32_t>(label2.Position()) + 6u, __ AdjustedPosition(label2.Position()));
}
...
TEST_F(AssemblerThumb2Test, LoadLiteralMax1KiB) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label.Position()) + 0u, __ AdjustedPosition(label.Position()));
}
...
TEST_F(AssemblerThumb2Test, LoadLiteralBeyondMax1KiB) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label.Position()) + 2u, __ AdjustedPosition(label.Position()));
}
...
TEST_F(AssemblerThumb2Test, LoadLiteralBeyondMax4KiB) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label.Position()) + 6u, __ AdjustedPosition(label.Position()));
}
...
TEST_F(AssemblerThumb2Test, LoadLiteralBeyondMax64KiB) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label.Position()) + 8u, __ AdjustedPosition(label.Position()));
}
...
TEST_F(AssemblerThumb2Test, LoadLiteralBeyondMax1MiB) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label.Position()) + 12u, __ AdjustedPosition(label.Position()));
}
...
TEST_F(AssemblerThumb2Test, LoadLiteralDoubleBeyondMax256KiB) {
  ...
  EXPECT_EQ(static_cast<uint32_t>(label.Position()) + 10u, __ AdjustedPosition(label.Position()));
}
