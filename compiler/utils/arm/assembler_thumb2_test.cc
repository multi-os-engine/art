...
TEST_F(AssemblerThumb2Test, DISABLED_SbfxMore) {
  // TODO: These statements do not generate the expected Thumb-2 machine code.
  // Check art::arm::Thumb2Assembler::sbfx.
