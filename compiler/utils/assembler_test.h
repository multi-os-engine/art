...
class AssemblerTest : public testing::Test {
 public:
  ...
  std::string RepeatRRIb(void (Ass::*f)(Reg, Reg, ImmType), int imm_bits, std::string fmt, int bias = 0) {
  ...
  template <typename ImmType>
  std::string RepeatRRRIb(void (Ass::*f)(Reg, Reg, Reg, ImmType), int imm_bits, std::string fmt, int bias = 0) {
  ...
  template <typename ImmType>
  std::string RepeatFRIb(void (Ass::*f)(FPReg, Reg, ImmType), int imm_bits, std::string fmt, int bias = 0) {
