...
class ConstantArea {
 public:
  ConstantArea(ArenaAllocator* arena)
      : buffer_(arena->Adapter(kArenaAllocAssembler)) {}
...
class X86_64Assembler FINAL : public Assembler {
 public:
  static std::unique_ptr<X86_64Assembler> Create(ArenaAllocator* arena) {
    return std::unique_ptr<X86_64Assembler>(new (arena) X86_64Assembler(arena));
  }
