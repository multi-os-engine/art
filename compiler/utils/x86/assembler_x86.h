...
class X86Assembler FINAL : public MacroAssembler<PointerSize::k32> {
 public:
  explicit X86Assembler(ArenaAllocator* arena)
      : MacroAssembler<PointerSize::k32>(arena), constant_area_(arena) {}
