...
void Mips64Assembler::Dext(GpuRegister rt, GpuRegister rs, int pos, int size_less_one) {
  CHECK(0 <= pos && pos < 32) << pos;
  CHECK(0 <= size_less_one && size_less_one < 32) << size_less_one;
...
void Mips64Assembler::Dinsu(GpuRegister rt, GpuRegister rs, int pos_less_32, int size_less_one) {
  CHECK(0 <= pos_less_32 && pos_less_32 < 32) << pos_less_32;
  CHECK(0 <= size_less_one && size_less_one < 32) << size_less_one;
  CHECK(0 <= pos_less_32 + size_less_one && pos_less_32 + size_less_one < 32)
