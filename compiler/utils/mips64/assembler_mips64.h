...
class Mips64Assembler FINAL : public Assembler {
 public:
  ...
  void Bltc(GpuRegister rs, GpuRegister rt, Mips64Label* label);  // R6
  void Bltzc(GpuRegister rt, Mips64Label* label);  // R6
  void Bgtzc(GpuRegister rt, Mips64Label* label);  // R6
  void Bgec(GpuRegister rs, GpuRegister rt, Mips64Label* label);  // R6
  void Bgezc(GpuRegister rt, Mips64Label* label);  // R6
  void Blezc(GpuRegister rt, Mips64Label* label);  // R6
  void Bltuc(GpuRegister rs, GpuRegister rt, Mips64Label* label);  // R6
  void Bgeuc(GpuRegister rs, GpuRegister rt, Mips64Label* label);  // R6
  void Beqc(GpuRegister rs, GpuRegister rt, Mips64Label* label);  // R6
  void Bnec(GpuRegister rs, GpuRegister rt, Mips64Label* label);  // R6
  void Beqzc(GpuRegister rs, Mips64Label* label);  // R6
  void Bnezc(GpuRegister rs, Mips64Label* label);  // R6
