...
class Mips64Assembler FINAL : public Assembler {
 public:
  ...
  void Seleqz(GpuRegister rd, GpuRegister rs, GpuRegister rt);  // R6
  void Selnez(GpuRegister rd, GpuRegister rs, GpuRegister rt);  // R6
