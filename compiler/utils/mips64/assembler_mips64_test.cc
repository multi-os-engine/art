...
TEST_F(AssemblerMIPS64Test, Align) {
  DriverStr(RepeatRRRIb(&mips64::Mips64Assembler::Align,
                        2,
                        "align ${reg1}, ${reg2}, ${reg3}, {imm}"),
            "align");
}

TEST_F(AssemblerMIPS64Test, Dalign) {
  DriverStr(RepeatRRRIb(&mips64::Mips64Assembler::Dalign,
                        3,
                        "dalign ${reg1}, ${reg2}, ${reg3}, {imm}"),
            "dalign");
}
