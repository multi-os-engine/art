...
#ifdef ART_ENABLE_CODEGEN_arm
    case kArm:
      return arm::Arm32Assembler::Create(arena);
    case kThumb2:
      return arm::Thumb2Assembler::Create(arena);
#endif
#ifdef ART_ENABLE_CODEGEN_arm64
    case kArm64:
      return arm64::Arm64Assembler::Create(arena);
#endif
#ifdef ART_ENABLE_CODEGEN_mips
    case kMips:
      return mips::MipsAssembler::Create(
          arena,
...
#ifdef ART_ENABLE_CODEGEN_mips64
    case kMips64:
      return mips64::Mips64Assembler::Create(arena);
#endif
#ifdef ART_ENABLE_CODEGEN_x86
    case kX86:
      return x86::X86Assembler::Create(arena);
#endif
#ifdef ART_ENABLE_CODEGEN_x86_64
    case kX86_64:
      return x86_64::X86_64Assembler::Create(arena);
#endif
    default:
