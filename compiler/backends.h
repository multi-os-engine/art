...
#ifndef ART_COMPILER_COMPILER_QUICK_BACKEND_H_
#define ART_COMPILER_COMPILER_QUICK_BACKEND_H_
...
class OptimizingBackend : public QuickBackend {
 public:
  OptimizingBackend() { }
  ...
  CompiledMethod* TryCompile(CompilerDriver& compiler,
                             const DexFile::CodeItem* code_item,
                             uint32_t access_flags,
                             InvokeType invoke_type,
                             uint16_t class_def_idx,
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(OptimizingBackend);
};

}  // namespace art

#endif  // ART_COMPILER_COMPILER_QUICK_BACKEND_H_
