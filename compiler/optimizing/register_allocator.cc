...
static void CheckIsMaterializableEntryInstructionOfGraphWithIrreducibleLoop(
    HInstruction* instruction) {
  DCHECK(instruction->IsConstant() || instruction->IsCurrentMethod());
  DCHECK(instruction->GetBlock()->GetGraph()->HasIrreducibleLoops());
}
...
void RegisterAllocator::ConnectSplitSiblings(LiveInterval* interval,
  ...
  if (destination == nullptr) {
    ...
    CheckIsMaterializableEntryInstructionOfGraphWithIrreducibleLoop(defined_by);
    return;
  }
