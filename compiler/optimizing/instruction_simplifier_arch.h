...
class InstructionSimplifierArch : public HOptimization {
 public:
  explicit InstructionSimplifierArch(HGraph* graph, InstructionSet instruction_set)
    : HOptimization(graph, true, "instruction_simplifier_arch"), instruction_set_(instruction_set) {}
