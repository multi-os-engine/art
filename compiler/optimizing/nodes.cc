...
// because of missing exceptional edges in the graph. It removes the instruction
// from catch phi uses, together with inputs of other catch phis in the catch
// block at the same index, as these must be dead too.
