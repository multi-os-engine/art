...
bool HInvoke::CanBeMoved() const {
  // An invoke that cannot throw exceptions and without any visible memory side effects
  // can be moved freely around in the graph.
  return !CanThrow() && GetSideEffects().DoesNothing();
}
