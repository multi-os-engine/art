...
void HGraph::InlineInto(HGraph* outer_graph, HInvoke* invoke) {
  ...
  // Ideally we want to add the instructions using HBasicBlock::HBasicBlock::AddInstruction.
  // However, since that has a larger overhead because it treats each instruction independently,
  // we fix the links manually.
  if (first != last) {
