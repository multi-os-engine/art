...
Location InvokeDexCallingConventionVisitorMIPS64::GetReturnLocation(Primitive::Type type) {
 ...
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    if (instruction_->IsInstanceOf()) {
      mips64_codegen->InvokeRuntime(
          QUICK_ENTRY_POINT(pInstanceofNonTrivial),
          instruction_,
          dex_pc_,
          this);
...
void CodeGeneratorMIPS64::MarkGCCard(GpuRegister object, GpuRegister value) {
  ...
  __ Beqzc(value, &done);
  __ LoadFromOffset(kLoadDoubleword, card, TR,
...
void InstructionCodeGeneratorMIPS64::GenerateSuspendCheck(HSuspendCheck* instruction,
  ...
  __ LoadFromOffset(kLoadUnsignedHalfword, TMP, TR,
...
void InstructionCodeGeneratorMIPS64::VisitLoadException(HLoadException* load) {
  ...
  __ LoadFromOffset(kLoadWord, out, TR, Thread::ExceptionOffset<kMips64WordSize>().Int32Value());
