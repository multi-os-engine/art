...
// Slow-path for intrinsic non-intrinsified call. This will copy the arguments into the positions
// for a regular call. Note: The original parameters need to still be available in the original
// locations.
...
static bool LocIntIntIntToInt(ArenaAllocator* arena, HInvokeStaticOrDirect* invoke) {
  LocationSummary* locations = new (arena) LocationSummary(invoke, LocationSummary::kNoCall, true);
  locations->SetInAt(0, Location::RequiresRegister());
  locations->SetInAt(1, Location::RequiresRegister());
...
bool IntrinsicLocationsBuilderX86_64::VisitUnsafeGet(HInvokeStaticOrDirect* invoke) {
  return LocIntIntIntToInt(arena_, invoke);
}
...
static bool LocIntIntIntIntToVoidPlusTemps(ArenaAllocator* arena, HInvokeStaticOrDirect* invoke) {
  LocationSummary* locations = new (arena) LocationSummary(invoke, LocationSummary::kNoCall, true);
...
bool IntrinsicLocationsBuilderX86_64::VisitUnsafePut(HInvokeStaticOrDirect* invoke) {
  return LocIntIntIntIntToVoidPlusTemps(arena_, invoke);
}
...
static bool GenUnsafePut(LocationSummary* locations, Primitive::Type type, bool is_volatile,
  ...
  if (type == Primitive::Type::kPrimLong) {
  ...
  if (type == Primitive::Type::kPrimNot) {
...
bool IntrinsicCodeGeneratorX86_64::VisitUnsafePut(HInvokeStaticOrDirect* invoke) {
  return GenUnsafePut(invoke->GetLocations(), Primitive::Type::kPrimInt, false, codegen_);
}
...
bool IntrinsicCodeGeneratorX86_64::VisitUnsafePutVolatile(HInvokeStaticOrDirect* invoke) {
  return GenUnsafePut(invoke->GetLocations(), Primitive::Type::kPrimInt, true, codegen_);
}
bool IntrinsicCodeGeneratorX86_64::VisitUnsafePutObject(HInvokeStaticOrDirect* invoke) {
  return GenUnsafePut(invoke->GetLocations(), Primitive::Type::kPrimNot, false, codegen_);
}
...
bool IntrinsicCodeGeneratorX86_64::VisitUnsafePutObjectVolatile(HInvokeStaticOrDirect* invoke) {
  return GenUnsafePut(invoke->GetLocations(), Primitive::Type::kPrimNot, true, codegen_);
}
bool IntrinsicCodeGeneratorX86_64::VisitUnsafePutLong(HInvokeStaticOrDirect* invoke) {
  return GenUnsafePut(invoke->GetLocations(), Primitive::Type::kPrimLong, false, codegen_);
}
...
bool IntrinsicCodeGeneratorX86_64::VisitUnsafePutLongVolatile(HInvokeStaticOrDirect* invoke) {
  return GenUnsafePut(invoke->GetLocations(), Primitive::Type::kPrimLong, true, codegen_);
}
