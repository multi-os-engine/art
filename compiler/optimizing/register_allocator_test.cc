...
TEST(RegisterAllocatorTest, SpillInactive) {
  ...
  // We create a synthesize user requesting a register, to avoid just spilling the
  // intervals.
  ...
  // Because the first part of the splitted interval was considered handled, this interval
