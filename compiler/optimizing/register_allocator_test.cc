...
TEST(RegisterAllocatorTest, FreeUntil) {
  ...
  LiveInterval* interval = LiveInterval::MakeInterval(&allocator, nullptr, Primitive::kPrimInt);
  interval->SetRegister(0);
  interval->AddRange(40, 50);
  register_allocator.inactive_.Add(interval);

  interval = LiveInterval::MakeInterval(&allocator, nullptr, Primitive::kPrimInt);
  interval->SetRegister(0);
