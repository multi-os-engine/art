...
bool InductionVarRange::RefineOuter(/*in-out*/ Value* min_val,
  ...
  if (min_val->instruction != max_val->instruction) {
    ...
    if (!v1_max.is_known || v1_max.a_constant != 0 ||
        !v2_min.is_known || v2_min.a_constant != 0 || v1_max.b_constant > v2_min.b_constant) {
      return false;
    }
  }
  ...
  if (info != nullptr) {
    ...
    do {
      ...
      if (v_min.is_known &&
          ...
          v_max.is_known &&
          v_max.a_constant == 0 &&
          v_min.b_constant <= v_max.b_constant) {
...
InductionVarRange::Value InductionVarRange::GetMul(HInductionVarAnalysis::InductionInfo* info1,
  ...
  if (v1_min.a_constant != 0 && v1_max.a_constant != 0) {
    RefineOuter(&v1_min, &v1_max);
  }
  // Positive or negative range?
  if (v1_min.is_known && v1_min.a_constant == 0 && v1_min.b_constant >= 0) {
    // Positive constant vs. any range, or positive range vs. positive or negative range.
    if ((v1_max.is_known && v2_max.a_constant == 0 && v1_min.b_constant == v1_max.b_constant) ||
        (v2_min.is_known && v2_min.a_constant == 0 && v2_min.b_constant >= 0)) {
    ...
    // Negative constant vs any range, or negative range vs. positive or negative range.
    if ((v1_min.is_known && v2_min.a_constant == 0 && v1_min.b_constant == v1_max.b_constant) ||
        (v2_min.is_known && v2_min.a_constant == 0 && v2_min.b_constant >= 0)) {
  ...
  } else if (v2_min.is_known && v2_min.a_constant == 0 &&
             v2_max.is_known && v2_max.a_constant == 0 && v2_min.b_constant == v2_max.b_constant) {
    // Any range vs. positive or negative constant.
    if (v2_max.b_constant >= 0) {
      return is_min ? MulValue(v1_min, v2_min)
                    : MulValue(v1_max, v2_max);
    } else {
      return is_min ? MulValue(v1_max, v2_min)
