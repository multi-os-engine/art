...
TEST(CodegenTest, TEST_NAME) {                                           \
  ...
  const uint16_t word0 =  input & 0x000000000000FFFF;        /* LSW. */  \
  const uint16_t word1 = (input & 0x00000000FFFF0000) >> 16;             \
  const uint16_t word2 = (input & 0x0000FFFF00000000) >> 32;             \
  const uint16_t word3 =  input >> 48;                       /* MSW. */  \
