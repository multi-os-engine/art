...
class StackMapStream : public ValueObject {
 public:
  explicit StackMapStream(ArenaAllocator* allocator)
      : allocator_(allocator),
        ...
        num_instruction_stack_maps_(0),
        num_catch_stack_maps_(0),
  ...
  size_t GetNumberOfStackMaps() const { return num_instruction_stack_maps_; }

  size_t GetNumberOfCatchStackMaps() const { return num_catch_stack_maps_; }
 ...
 private:
  ...
  StackMap GetStackMapFromCodeInfo(const CodeInfo& code_info, size_t index) const;

  ArenaAllocator* allocator_;
  GrowableArray<StackMapEntry> stack_maps_;
  size_t num_instruction_stack_maps_;
  size_t num_catch_stack_maps_;
