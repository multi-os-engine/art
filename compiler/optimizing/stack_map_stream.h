...
// Helpers used to build StackMapStream::DexRegisterDictionaryEntriesIndices.

typedef std::pair<DexRegisterLocation, size_t> DexRegisterDictionaryEntriesIndicesElement;

class DexRegisterDictionaryEntriesIndicesEmptyFn {
 public:
  void MakeEmpty(DexRegisterDictionaryEntriesIndicesElement& item) const {
    item.first = DexRegisterLocation::None();
  }
  bool IsEmpty(const DexRegisterDictionaryEntriesIndicesElement& item) const {
