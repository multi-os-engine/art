...
// either casted to an integer or negated by selecting selecting from zero/one
// integer constants with an If statement. Because boolean values are internally
// represented as zero/one, we can replace the pattern with a suitable condition
// instruction.
