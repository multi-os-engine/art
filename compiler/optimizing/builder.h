...
class HGraphBuilder : public ValueObject {
 ...
 private:
  ...
  template<typename T>
  void If_22t(const Instruction& instruction, int32_t dex_offset, IfCondition cond);

  template<typename T>
  void If_21t(const Instruction& instruction, int32_t dex_offset, IfCondition cond);
