...
void ReferenceTypePropagation::HandleInvoke(HInvoke* instr) {
  ...
  ArtMethod* method = dex_cache->GetResolvedMethod(instr->GetDexMethodIndex(),
...
void ReferenceTypePropagation::VisitInvokeVirtual(HInvokeVirtual* instr) {
  VisitInvoke(instr);
}

void ReferenceTypePropagation::VisitInvokeStaticOrDirect(HInvokeStaticOrDirect* instr) {
  VisitInvoke(instr);
}

void ReferenceTypePropagation::VisitInvokeInterface(HInvokeInterface* instr) {
  VisitInvoke(instr);
}
