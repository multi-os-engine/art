...
void InstructionCodeGeneratorARM::GenerateAtomicLoad(Register addr,
                                                     uint32_t offset,
                                                     Register out_lo,
                                                     Register out_hi) {
  if (offset != 0) {
...
void InstructionCodeGeneratorARM::GenerateAtomicStore(Register addr,
                                                      uint32_t offset,
                                                      Register value_lo,
                                                      Register value_hi,
                                                      Register temp1,
  ...
  switch (field_type) {
    ...
    case Primitive::kPrimLong: {
      if (is_volatile) {
        ...
        GenerateAtomicStore(base, offset,
                            value.AsRegisterPairLow<Register>(),
...
void InstructionCodeGeneratorARM::HandleFieldGet(HInstruction* instruction,
  ...
  switch (field_type) {
    ...
    case Primitive::kPrimLong: {
      if (is_volatile) {
        GenerateAtomicLoad(base, offset,
                           out.AsRegisterPairLow<Register>(),
                           out.AsRegisterPairHigh<Register>());
      } else {
    ...
    case Primitive::kPrimDouble: {
      ...
      if (is_volatile) {
        ...
        GenerateAtomicLoad(base, offset, lo, hi);
