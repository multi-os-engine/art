...
void LocationsBuilderARM::VisitInvokeSuperInterface(HInvokeSuperInterface* invoke) {
...
void InstructionCodeGeneratorARM::VisitInvokeSuperInterface(HInvokeSuperInterface* invoke) {
