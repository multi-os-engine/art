...
void InstructionCodeGeneratorARM::HandleFieldSet(HInstruction* instruction,
  ...
  switch (field_type) {
    ...
    case Primitive::kPrimLong: {
      if (is_volatile) {
        // TODO: ldrd and strd may be atomic (e.g. common with Large Physical Address Extension).
        // This info is stored in the compiler driver (HasAtomicLdrdAndStrd) and we should pass it
        // around to be able to optimize.
