...
void CodeGeneratorARM::Finalize(CodeAllocator* allocator) {
  ...
  for (RelativeCallPatchData& data : relative_call_patches_) {
    __ AdjustLabelPosition(&data.label);
  }
...
void CodeGeneratorARM::GenerateStaticOrDirectCall(HInvokeStaticOrDirect* invoke, Location temp) {
  ...
  switch (invoke->GetCodePtrLocation()) {
    ...
    case HInvokeStaticOrDirect::CodePtrLocation::kDirectCodeFixup:
      ...
      // the boot image, these calls are more likely to exceed the available BL range.
