...
void CodeGeneratorARM::SaveCpuRegister(Location stack_location, uint32_t reg_id) {
  __ str(static_cast<Register>(reg_id), Address(SP, stack_location.GetStackIndex()));
}

void CodeGeneratorARM::RestoreCpuRegister(Location stack_location, uint32_t reg_id) {
