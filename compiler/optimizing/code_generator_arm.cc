...
class ArraySetSlowPathARM : public SlowPathCode {
 public:
  ArraySetSlowPathARM(HInstruction* instruction) : instruction_(instruction) {}
...
void LocationsBuilderARM::VisitArraySet(HArraySet* instruction) {
  ...
  LocationSummary* locations = new (GetGraph()->GetArena()) LocationSummary(
      instruction, may_need_runtime_call ? LocationSummary::kCallOnSlowPath : LocationSummary::kNoCall);
  locations->SetInAt(0, Location::RequiresRegister());
  locations->SetInAt(1, Location::RegisterOrConstant(instruction->InputAt(1)));
  ...
  switch (value_type) {
    ...
    case Primitive::kPrimNot: {
      ...
      if (may_need_runtime_call) {
        ...
        __ LoadFromOffset(kLoadWord, temp1, obj, class_offset);
        codegen_->MaybeRecordImplicitNullCheck(instruction);
      ...
      codegen_->MarkGCCard(temp1, temp2, obj, value, instruction->GetValueCanBeNull());
