...
void CodeGeneratorARM::SetupBlockedRegisters() const {
  ...
  // TODO: We should revisit this with a new ABI.
  blocked_fpu_registers_[STMP0] = true;  // Aka S24.  Also DTMP low bits.
  blocked_fpu_registers_[STMP1] = true;  // Aka S25.  Also DTMP high bits.
