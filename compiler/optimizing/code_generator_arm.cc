...
void LocationsBuilderARM::HandleRotate(HRotate* ror) {
  LocationSummary* locations =
...
void InstructionCodeGeneratorARM::HandleRotate(HRotate* ror) {
...
void LocationsBuilderARM::VisitRotate(HRotate* op) {
    HandleRotate(op);
}

void InstructionCodeGeneratorARM::VisitRotate(HRotate* op) {
    HandleRotate(op);
}
