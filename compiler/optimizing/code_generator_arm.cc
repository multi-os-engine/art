...
void CodeGeneratorARM::GenerateReferenceLoadWithBakerReadBarrier(HInstruction* instruction,
  ...
  // which can be a 16-bit instruction unlike unlike the TST immediate.
  static_assert(ReadBarrier::white_ptr_ == 0, "Expecting white to have value 1");
  static_assert(ReadBarrier::gray_ptr_ == 1, "Expecting gray to have value 1");
  static_assert(ReadBarrier::black_ptr_ == 2, "Expecting black tohave value 1");
