...
class CodeGeneratorX86_64 : public CodeGenerator {
 public:
  ...
  virtual void SaveCoreRegister(size_t stack_index, uint32_t reg_id) OVERRIDE;
  virtual void RestoreCoreRegister(size_t stack_index, uint32_t reg_id) OVERRIDE;
  virtual void SaveFloatingPointRegister(size_t stack_index, uint32_t reg_id) OVERRIDE;
  virtual void RestoreFloatingPointRegister(size_t stack_index, uint32_t reg_id) OVERRIDE;
