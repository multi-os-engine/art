...
class BisectableOptimizingCompiler : public OptimizingCompiler {
 public:
  ...
  ~BisectableOptimizingCompiler() OVERRIDE;
  void Init() OVERRIDE;
...
BisectableOptimizingCompiler::~BisectableOptimizingCompiler() { }
...
void BisectableOptimizingCompiler::Init() {
  ...
  bisection_controller_->Init(GetCompilerDriver()->GetCompilerOptions().GetBisectionConfig());
