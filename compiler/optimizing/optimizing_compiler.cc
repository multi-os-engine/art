...
static void RunArchOptimizations(InstructionSet instruction_set,
  ...
  switch (instruction_set) {
    case kArm64: {
      // Additional architecture-specific optimisation passes for ARM64.
      InstructionSimplifierArch* arch_simplifier = new (arena) InstructionSimplifierArch(
          graph, instruction_set, stats);
