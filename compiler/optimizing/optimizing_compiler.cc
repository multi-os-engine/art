...
CompiledMethod* OptimizingCompiler::Compile(const DexFile::CodeItem* code_item,
  ...
  if (Compiler::IsPathologicalCase(*code_item, method_idx, dex_file)) {
    compilation_stats_.RecordStat(MethodCompilationStat::kNotCompiledPathologicalCase);
    return nullptr;
  }
  ...
  if (codegen == nullptr) {
    ...
    compilation_stats_.RecordStat(MethodCompilationStat::kNotCompiledNoCode);
    return nullptr;
  }
  ...
  if (run_optimizations_ && can_optimize && can_allocate_registers) {
    ...
    compilation_stats_.RecordStat(MethodCompilationStat::kCompileOptimized);
