  ...
  if (result_type == Primitive::kPrimLong && Primitive::IsIntegralType(input_type)) {
    ...
    if (result_type == Primitive::kPrimLong) {
      if (isR6) {
        ...
        // This supports both NAN2008=1 (should be always true for R6) and NAN2008=0 behaviors of
      ...
      // This supports both NAN2008=1 (should be always true for R6) and NAN2008=0 behaviors of the
