...
void LocationsBuilderMIPS::VisitInvokeSuperInterface(HInvokeSuperInterface* invoke) {
...
void InstructionCodeGeneratorMIPS::VisitInvokeSuperInterface(HInvokeSuperInterface* invoke) {
