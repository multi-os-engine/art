...
class RegisterAllocator {
 ...
 private:
  ...
  void BlockAllRegisters(size_t start, size_t end, bool caller_save_only = false);
  ...
  // for phis which share the same vreg. Should be called in reverse linear order
  // of lifetime positions and ascending vreg numbers.
