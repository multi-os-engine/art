...
class InductionVarRange {
 public:
   ...
   * to protect the range evaluation inside its loop. Parameter hint defines an instruction
   * at which chasing may stop. Returns false on failure.
   */
  ...
  bool GetInductionRange(HInstruction* context,
                         ...
                         /*out*/ Value* max_val,
                         /*out*/ bool* needs_finite_test) {
    return GetInductionRange(context, instruction, nullptr, min_val, max_val, needs_finite_test);
  }
