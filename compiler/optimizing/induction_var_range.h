...
class InductionVarRange {
 public:
   ...
   * Although range analysis could yield more complex values in ranges, this format is
   * sufficiently powerful to represent many useful cases, and feeds directly into e.g. BCE.
   */
  struct Value {
