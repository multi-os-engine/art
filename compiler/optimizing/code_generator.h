...
class CodeGenerator : public ArenaObject {
 public:
  ...
  virtual void SaveCoreRegister(size_t stack_index, uint32_t reg_id) = 0;
  virtual void RestoreCoreRegister(size_t stack_index, uint32_t reg_id) = 0;
  virtual void SaveFloatingPointRegister(size_t stack_index, uint32_t reg_id) {
    LOG(FATAL) << "Unimplemented";
  }
  virtual void RestoreFloatingPointRegister(size_t stack_index, uint32_t reg_id) {
    LOG(FATAL) << "Unimplemented";
  }
