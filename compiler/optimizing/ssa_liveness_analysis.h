 ...
 public:
  ...
  void AddUse(HInstruction* instruction,
    ...
    if (!is_environment) {
      ...
      // to splitting).
      bool position_at_instruction = locations->IsFixedInput(input_index);
      position_at_instruction |= locations->OutputUsesSameAs(input_index);
