...
TEST(OptimizerTest, CFG7) {
  const uint16_t data[] = {
    Instruction::IF_EQ, 3, // block 1
    Instruction::GOTO | 0x100, // block 2
    Instruction::GOTO | 0xFF00 // block 3
  };
...
TEST(OptimizerTest, CFG8) {
  const uint16_t data[] = {
    Instruction::IF_EQ, 3, // block 1
    Instruction::GOTO | 0x200, // block 2
    Instruction::GOTO | 0x100, // block 3
    Instruction::GOTO | 0xFF00 // block 4
  };
...
TEST(OptimizerTest, CFG9) {
  const uint16_t data[] = {
    ...
    Instruction::GOTO | 0x200, // block 2
    Instruction::GOTO | 0x100, // block 3
    Instruction::GOTO | 0xFE00 // block 4
  };
...
TEST(OptimizerTest, CFG10) {
  const uint16_t data[] = {
    Instruction::IF_EQ, 6, // block 1
    Instruction::IF_EQ, 3, // block 2
    Instruction::GOTO | 0x100, // block 3
    Instruction::GOTO | 0x100, // block 4
    Instruction::RETURN_VOID // block 5
  };
  ...
  const int dominators[] = {
    ...
    2,
    1,
    5 // block 5 dominates exit block
  };
