...
class HeapLocationCollector : public HGraphVisitor {
 ...
 private:
  ...
  // Create reference info if `instruction` is a reference type. This can be called
  // to add entry into ref_info_array_ as early as possible to help pre-existence-based
  // aliasing analysis.
