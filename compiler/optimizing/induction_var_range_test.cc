...
TEST_F(InductionVarRangeTest, GetMulMin) {
  ...
  ExpectEqual(Value(), GetMul(CreateRange(-1, 1), CreateRange(1, 2), true));
  ExpectEqual(Value(), GetMul(CreateRange(1, 2), CreateRange(-1, 1), true));
}
...
TEST_F(InductionVarRangeTest, GetMulMax) {
  ...
  ExpectEqual(Value(), GetMul(CreateRange(-1, 1), CreateRange(1, 2), false));
  ExpectEqual(Value(), GetMul(CreateRange(1, 2), CreateRange(-1, 1), false));
}
...
TEST_F(InductionVarRangeTest, GetDivMin) {
  ...
  ExpectEqual(Value(), GetDiv(CreateRange(-1, 1), CreateRange(1, 2), true));
  ExpectEqual(Value(), GetDiv(CreateRange(1, 2), CreateRange(-1, 1), true));
}
...
TEST_F(InductionVarRangeTest, GetDivMax) {
  ...
  ExpectEqual(Value(), GetDiv(CreateRange(-1, 1), CreateRange(1, 2), false));
  ExpectEqual(Value(), GetDiv(CreateRange(1, 2), CreateRange(-1, 1), false));
}
