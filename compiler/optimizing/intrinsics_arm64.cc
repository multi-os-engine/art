...
void IntrinsicLocationsBuilderARM64::VisitSystemArrayCopyChar(HInvoke* invoke) {
  ...
  locations->SetInAt(0, Location::RequiresRegister());
  locations->SetInAt(1,
    (src_pos != nullptr && !vixl::Assembler::IsImmAddSub(src_pos->GetValue()))
      ? Location::RequiresRegister()
      : Location::RegisterOrConstant(invoke->InputAt(1)));
  locations->SetInAt(2, Location::RequiresRegister());
  locations->SetInAt(3,
    (dst_pos != nullptr && !vixl::Assembler::IsImmAddSub(dst_pos->GetValue()))
      ? Location::RequiresRegister()
      : Location::RegisterOrConstant(invoke->InputAt(3)));
  locations->SetInAt(4,
    (length != nullptr && !vixl::Assembler::IsImmAddSub(length->GetValue()))
      ? Location::RequiresRegister()
      : Location::RegisterOrConstant(invoke->InputAt(4)));
