 ...
 public:
  ...
  ArenaVector<HInstruction*>* GetLocalsFor(HBasicBlock* block) {
    ...
    if (locals == nullptr) {
      ...
      void* storage = arena->Alloc(sizeof(ArenaVector<HInstruction*>), kArenaAllocSsaBuilder);
      locals = new (storage) ArenaVector<HInstruction*>(vregs,
                                                        nullptr,
                                                        arena->Adapter(kArenaAllocSsaBuilder));
      ...
      locals_for_[block->GetBlockId()] = locals;
    }
    return locals;
  }
