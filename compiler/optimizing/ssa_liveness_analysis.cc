...
int LiveInterval::FindFirstRegisterHint(size_t* free_until, const SsaLivenessAnalysis& liveness) const {
  ...
  if (!IsDefiningPosition(GetStart()) && liveness.IsAtBlockBoundary(GetStart() / 2)) {
