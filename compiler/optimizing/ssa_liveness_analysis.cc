...
void SsaLivenessAnalysis::NumberInstructions() {
  ...
  // to differentiate between the start and end of an instruction. Therefore, the
  // start of a following instruction is different then the end of the instruction.
