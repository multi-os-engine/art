...
class CodeGeneratorARM : public CodeGenerator {
 ...
 private:
  typedef ArenaSafeMap<MethodReference, Literal*, MethodReferenceComparator> MethodToLiteralMap;

  Literal* DeduplicateMethodLiteral(MethodReference target_method, MethodToLiteralMap* map);
  Literal* DeduplicateMethodAddressLiteral(MethodReference target_method);
  Literal* DeduplicateMethodCodeLiteral(MethodReference target_method);

  struct CallPatchData {
    explicit CallPatchData(MethodReference m) : target_method(m), label() { }
  ...
  ArenaDeque<CallPatchData> relative_call_patches_;
