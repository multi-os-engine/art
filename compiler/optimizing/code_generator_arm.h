...
class InvokeDexCallingConventionVisitorARM : public InvokeDexCallingConventionVisitor {
 public:
  InvokeDexCallingConventionVisitorARM() = default;
  virtual ~InvokeDexCallingConventionVisitorARM() = default;
...
class CodeGeneratorARM : public CodeGenerator {
 public:
  ...
  InvokeDexCallingConventionVisitorARM* GetCallingConventionVisitor() OVERRIDE {
 ...
 private:
  ...
  InvokeDexCallingConventionVisitorARM calling_convention_visitor_;
