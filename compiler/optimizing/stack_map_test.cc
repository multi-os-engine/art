...
TEST(StackMapTest, Test1) {
  ...
  ASSERT_EQ(Kind::kInStack,
            dex_register_map.GetLocationInternalKind(
                0, number_of_dex_registers, code_info, encoding));
...
TEST(StackMapTest, Test2) {
  ...
  // First stack map.
  {
    ...
    ASSERT_EQ(Kind::kInStack,
              dex_register_map.GetLocationKind(0, number_of_dex_registers, code_info, encoding));
    ASSERT_EQ(Kind::kConstant,
              dex_register_map.GetLocationKind(1, number_of_dex_registers, code_info, encoding));
    ASSERT_EQ(Kind::kInStack,
              dex_register_map.GetLocationInternalKind(0, number_of_dex_registers, code_info, encoding));
    ASSERT_EQ(Kind::kConstantLargeValue,
              dex_register_map.GetLocationInternalKind(1, number_of_dex_registers, code_info, encoding));
    ASSERT_EQ(0, dex_register_map.GetStackOffsetInBytes(0, number_of_dex_registers, code_info, encoding));
    ASSERT_EQ(-2, dex_register_map.GetConstant(1, number_of_dex_registers, code_info, encoding));
  ...
  // Second stack map.
  {
    ...
    ASSERT_EQ(Kind::kInFpuRegister,
              dex_register_map.GetLocationInternalKind(1, number_of_dex_registers, code_info, encoding));
    ASSERT_EQ(18, dex_register_map.GetMachineRegister(0, number_of_dex_registers, code_info, encoding));
    ASSERT_EQ(3, dex_register_map.GetMachineRegister(1, number_of_dex_registers, code_info, encoding));
...
TEST(StackMapTest, DexRegisterMapOffsetOverflow) {
  ...
  ASSERT_NE(stack_map1.GetDexRegisterMapOffset(), StackMap::kNoDexRegisterMap);
...
TEST(StackMapTest, TestShareDexRegisterMap) {
  ...
  ASSERT_EQ(sm0.GetDexRegisterMapOffset(), sm1.GetDexRegisterMapOffset());
  ASSERT_NE(sm0.GetDexRegisterMapOffset(), sm2.GetDexRegisterMapOffset());
  ASSERT_NE(sm1.GetDexRegisterMapOffset(), sm2.GetDexRegisterMapOffset());
}
...
TEST(StackMapTest, InlineTest) {
...

  {
    ...
    DexRegisterMap dex_registers1 = ci.GetDexRegisterMapAtDepth(0, if0, 1, encoding);
    ASSERT_EQ(8, dex_registers1.GetStackOffsetInBytes(0, 1, ci, encoding));

    DexRegisterMap dex_registers2 = ci.GetDexRegisterMapAtDepth(1, if0, 3, encoding);
...

  {
    ...
    DexRegisterMap dex_registers1 = ci.GetDexRegisterMapAtDepth(0, if1, 1, encoding);
    ASSERT_EQ(12, dex_registers1.GetStackOffsetInBytes(0, 1, ci, encoding));

    DexRegisterMap dex_registers2 = ci.GetDexRegisterMapAtDepth(1, if1, 3, encoding);
...

  {
    ...
    DexRegisterMap dex_registers1 = ci.GetDexRegisterMapAtDepth(1, if2, 1, encoding);
    ASSERT_EQ(2, dex_registers1.GetMachineRegister(0, 1, ci, encoding));

    DexRegisterMap dex_registers2 = ci.GetDexRegisterMapAtDepth(2, if2, 2, encoding);
