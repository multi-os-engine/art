...
TEST(StackMapTest, InlineTest) {
...

  {
    ...
    DexRegisterMap dex_registers3 = ci.GetDexRegisterMapAtDepth(2, if1, 0);
    ASSERT_FALSE(dex_registers3.IsValid());
  }
...

  {
    ...
    ASSERT_FALSE(ci.GetDexRegisterMapAtDepth(0, if2, 0).IsValid());
