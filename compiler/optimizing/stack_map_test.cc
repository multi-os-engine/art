...
TEST(StackMapTest, Test1) {
  ...
  switch (kDexRegisterMapEncoding) {
    case kDexRegisterLocationList: {
      ...
      ASSERT_EQ(DexRegisterLocation::Kind::kInStack, dex_registers.GetLocationKind(0));
      ASSERT_EQ(DexRegisterLocation::Kind::kConstant, dex_registers.GetLocationKind(1));
    ...
    case kDexRegisterCompressedLocationList: {
      ...
      ASSERT_EQ(DexRegisterLocation::Kind::kInStack, location0.kind);
      ASSERT_EQ(DexRegisterLocation::Kind::kConstantBigValue, location1.kind);
...
TEST(StackMapTest, Test2) {
  ...
  switch (kDexRegisterMapEncoding) {
    case kDexRegisterLocationList: {
      ...
      ASSERT_EQ(16u, dex_registers.Size());
      ASSERT_EQ(16u, ComputeDexRegisterMapSize(number_of_dex_registers));
      ASSERT_EQ(DexRegisterLocation::Kind::kInRegister, dex_registers.GetLocationKind(0));
      ASSERT_EQ(DexRegisterLocation::Kind::kInFpuRegister, dex_registers.GetLocationKind(1));
    ...
    case kDexRegisterCompressedLocationList: {
      ...
      DexRegisterLocation location0 = dex_registers.GetLocationKindAndValue(0);
      DexRegisterLocation location1 = dex_registers.GetLocationKindAndValue(1);
      ASSERT_EQ(DexRegisterLocation::Kind::kInRegister, location0.kind);
      ASSERT_EQ(DexRegisterLocation::Kind::kInFpuRegister, location1.kind);
