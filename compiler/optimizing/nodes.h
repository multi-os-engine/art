...
class HUserRecord {
 public:
  ...
  HUserRecord(HInstruction* instruction) : instruction_(instruction), use_node_(nullptr) {}
...
#undef DECLARE_KIND
  ...
  void RecordUse(HUseListNode<HInstruction*>* use) {
    ...
    HUserRecord<HInstruction*> old_record = InputRecordAt(index);
    HUserRecord<HInstruction*> new_record = HUserRecord<HInstruction*>(old_record, use);
...
#undef INSTRUCTION_TYPE_CHECK
 ...
 protected:
  virtual HUserRecord<HInstruction*> InputRecordAt(size_t i) const = 0;
  virtual void SetRawInputRecordAt(size_t index, HUserRecord<HInstruction*> input) = 0;
...
class HTemplateInstruction: public HInstruction {
 ...
 protected:
  virtual HUserRecord<HInstruction*> InputRecordAt(size_t i) const { return inputs_[i]; }

  virtual void SetRawInputRecordAt(size_t i, HUserRecord<HInstruction*> input) {
    inputs_[i] = input;
  }
...
class HInvoke : public HInstruction {
 ...
 protected:
  ...
  virtual HUserRecord<HInstruction*> InputRecordAt(size_t i) const { return inputs_.Get(i); }
  virtual void SetRawInputRecordAt(size_t index, HUserRecord<HInstruction*> input) {
...
class HPhi : public HInstruction {
 ...
 protected:
  ...
  void SetRawInputRecordAt(size_t index, HUserRecord<HInstruction*> input) OVERRIDE {
    inputs_.Put(index, input);
  }
