...
class HInstanceOf : public HExpression<2> {
 public:
  ...
  bool MustDoNullCheck() const { return must_do_null_check_ && InputAt(0)->CanBeNull(); }
  void SetMustDoNullCheck(bool must_do_null_check) { must_do_null_check_ = must_do_null_check; }
