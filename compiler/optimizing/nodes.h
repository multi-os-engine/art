...
#define FOR_EACH_CONCRETE_INSTRUCTION_ARM64(M)                          \
  M(arm64, IntermediateAddress, Instruction)
...
#define FORWARD_DECLARATION_ARCH(arch, type, super)                     \
...
#define DECLARE_KIND_ARCH(arch, type, super) k##arch##type,
...
#define INSTRUCTION_TYPE_CHECK_ARCH(arch, type, super)                         \
  bool Is##type() const { return (As##type() != nullptr); }                    \
...
#define DECLARE_VISIT_INSTRUCTION_ARCH(arch, name, super)                             \
  virtual void Visit##name(arch::H##name* instr) OVERRIDE {                           \
    Visit##super(reinterpret_cast<HInstruction*>(instr));                             \
  }
