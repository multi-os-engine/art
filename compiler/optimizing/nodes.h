 ...
 *    VZSJIFDCBL|VZSJIFDCBL|VZSJIFDCBL|VZSJIFDCBL
 */
class SideEffects : public ValueObject {
 public:
  ...
  // Returns true if this defines all types (useful to determine when
  // further analysis cannot add any more defs to this representation).
  bool HasAllDefs() const {
    return (flags_ & kAllDefs) == kAllDefs;
  }

  // Returns true if representation uses something.
  bool HasUses() const {
...
#undef DECLARE_KIND
  ...
  bool HasSideEffects() const { return side_effects_.HasDefs(); }  // BIK: fix
