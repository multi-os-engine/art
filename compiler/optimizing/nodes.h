...
// Switch (jump table). A block ending with a Switch instruction must have
// at least two successors.
class HSwitch : public HTemplateInstruction<1> {
 public:
  explicit HSwitch(int32_t start_value, int32_t num_entries, HInstruction* input)
  ...
  virtual bool IsSwitchInstruction() const { return true; }
