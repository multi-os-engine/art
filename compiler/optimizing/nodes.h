...
class HEnvironment : public ArenaObject<kArenaAllocEnvironment> {
 public:
  HEnvironment(ArenaAllocator* arena,
               ...
               HInstruction* holder)
     : vregs_(number_of_vregs,
              HUserRecord<HEnvironment*>(),
              arena->Adapter(kArenaAllocEnvironmentVRegs)),
       locations_(number_of_vregs, Location(), arena->Adapter(kArenaAllocEnvironmentLocations)),
       parent_(nullptr),
       dex_file_(dex_file),
       method_idx_(method_idx),
       dex_pc_(dex_pc),
  ...
  HPhi(ArenaAllocator* arena,
      ...
      : HInstruction(SideEffects::None(), dex_pc),
        inputs_(number_of_inputs,
                HUserRecord<HInstruction*>(),
                arena->Adapter(kArenaAllocPhiInputs)),
