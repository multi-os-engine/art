...
class HArrayGet : public HExpression<2> {
 ...
 private:
  // Bytecode aget(-wide) instructions have ambiguous type. If uses require a
  // certain type, the type is set and fixed. This prevents PrimitiveTypePropagation
  // from changing it while typing phis.
  bool fixed_type_;
