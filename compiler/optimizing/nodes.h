...
#define FOR_EACH_NON_CONCRETE_INSTRUCTION(M)                            \
...
#define FOR_EACH_INSTRUCTION(M)                                         \
  ...
  FOR_EACH_NON_CONCRETE_INSTRUCTION(M)
...
#define DECLARE_NON_CONCRETE_INSTRUCTION(type)                          \
  bool InstructionTypeEquals(HInstruction* other ATTRIBUTE_UNUSED)      \
...
#define INSTRUCTION_TYPE_CHECK(type, super)                                    \
  ...
  FOR_EACH_NON_CONCRETE_INSTRUCTION(INSTRUCTION_TYPE_CHECK)
#undef INSTRUCTION_TYPE_CHECK
...
class HConstant : public HExpression<0> {
 public:
  ...
  DECLARE_NON_CONCRETE_INSTRUCTION(Constant);
...
class HUnaryOperation : public HExpression<1> {
 public:
  ...
  DECLARE_NON_CONCRETE_INSTRUCTION(UnaryOperation);
...
class HBinaryOperation : public HExpression<2> {
 public:
  ...
  DECLARE_NON_CONCRETE_INSTRUCTION(BinaryOperation);
...
class HCondition : public HBinaryOperation {
 public:
  ...
  DECLARE_NON_CONCRETE_INSTRUCTION(Condition);
...
class HInvoke : public HInstruction {
 public:
  ...
  DECLARE_NON_CONCRETE_INSTRUCTION(Invoke);
...
#define INSTRUCTION_TYPE_CHECK(type, super)                                    \
  ...
  inline const H##type* HInstruction::As##type() const {                       \
    return Is##type() ? static_cast<const H##type*>(this) : nullptr;           \
  }                                                                            \
