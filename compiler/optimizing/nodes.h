...
class HExpression : public HTemplateInstruction<N> {
 ...
 protected:
  ...
  static constexpr size_t kFieldTypeSize = 4u;
...
class HTryBoundary : public HTemplateInstruction<0> {
 ...
 private:
  ...
  static constexpr size_t kFieldBoundaryKindSize = 1;
...
class HClassTableGet : public HExpression<1> {
 ...
 private:
  ...
  static constexpr size_t kFieldTableKindSize = 1;
...
class HCondition : public HBinaryOperation {
 ...
 protected:
  ...
  static constexpr size_t kFieldComparisonBiasSize = 2;
...
class HInvoke : public HInstruction {
 ...
 protected:
  ...
  static constexpr size_t kFieldOriginalInvokeTypeSize = 3;
  static constexpr size_t kFieldReturnType =
      kFieldOriginalInvokeType + kFieldOriginalInvokeTypeSize;
  static constexpr size_t kFieldReturnTypeSize = 4;
...
class HInvokeStaticOrDirect : public HInvoke {
 ...
 private:
  ...
  static constexpr size_t kFieldOptimizedInvokeTypeSize = 3;
  static constexpr size_t kFieldClinitCheckRequirement =
      kFieldOptimizedInvokeType + kFieldOptimizedInvokeTypeSize;
  static constexpr size_t kFieldClinitCheckRequirementSize = 2;
...
class HArraySet : public HTemplateInstruction<3> {
 ...
 private:
  ...
  static constexpr size_t kFieldExpectedComponentTypeSize = 4;
...
class HUnresolvedInstanceFieldSet : public HTemplateInstruction<2> {
 ...
 private:
  ...
  static constexpr size_t kFieldFieldTypeSize = 4u;
...
class HInstanceOf : public HExpression<2> {
 ...
 private:
  ...
  static constexpr size_t kFieldTypeCheckKindSize = 3;
...
class HMemoryBarrier : public HTemplateInstruction<0> {
 ...
 private:
  ...
  static constexpr size_t kFieldBarrierKindSize = 3u;
