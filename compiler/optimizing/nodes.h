...
class HReturnVoid : public HTemplateInstruction<0> {
 public:
  explicit HReturnVoid(uint32_t dex_pc = kNoDexPc) : HTemplateInstruction(SideEffects::None(), dex_pc) {}
...
class HReturn : public HTemplateInstruction<1> {
 public:
  HReturn(HInstruction* value, uint32_t dex_pc = kNoDexPc)
...
class HIntConstant : public HConstant {
 ...
 private:
  HIntConstant(int32_t value, uint32_t dex_pc = kNoDexPc)
      : HConstant(Primitive::kPrimInt, dex_pc), value_(value) {}
  HIntConstant(bool value, uint32_t dex_pc = kNoDexPc)
...
class HLongConstant : public HConstant {
 ...
 private:
  HLongConstant(int64_t value, uint32_t dex_pc = kNoDexPc)
...
class HTryBoundary : public HTemplateInstruction<0> {
 public:
  ...
  HTryBoundary(BoundaryKind kind, uint32_t dex_pc = kNoDexPc)
...
class HDeoptimize : public HTemplateInstruction<1> {
 public:
  HDeoptimize(HInstruction* cond, uint32_t dex_pc = kNoDexPc)
      : HTemplateInstruction(SideEffects::None(), dex_pc) {
...
class HCurrentMethod : public HExpression<0> {
 public:
  HCurrentMethod(Primitive::Type type, uint32_t dex_pc = kNoDexPc)
      : HExpression(type, SideEffects::None(), dex_pc) {}
...
class HBinaryOperation : public HExpression<2> {
 public:
  HBinaryOperation(Primitive::Type result_type,
                   HInstruction* left,
                   HInstruction* right,
                   SideEffects side_effects = SideEffects::None(), uint32_t dex_pc = kNoDexPc)
...
class HEqual : public HCondition {
 public:
  ...
  HConstant* Evaluate(HIntConstant* x, HIntConstant* y) const OVERRIDE {
    return GetBlock()->GetGraph()->GetIntConstant(Compute(x->GetValue(), y->GetValue()), GetDexPc());
  }
...
class HCompare : public HBinaryOperation {
 public:
  HCompare(Primitive::Type type,
           ...
           ComparisonBias bias,
           uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(Primitive::kPrimInt, first, second, SideEffectsForArchRuntimeCalls(type), dex_pc),
        bias_(bias) {
...
class HLocal : public HTemplateInstruction<0> {
 public:
  HLocal(uint16_t reg_number, uint32_t dex_pc = kNoDexPc)
...
class HStoreLocal : public HTemplateInstruction<2> {
 public:
  HStoreLocal(HLocal* local, HInstruction* value, uint32_t dex_pc)
      : HTemplateInstruction(SideEffects::None(), dex_pc) {
    SetRawInputAt(0, local);
...
class HFloatConstant : public HConstant {
 ...
 private:
  HFloatConstant(float value, uint32_t dex_pc = kNoDexPc)
      : HConstant(Primitive::kPrimFloat, dex_pc), value_(value) {}
  HFloatConstant(int32_t value, uint32_t dex_pc = kNoDexPc)
...
class HDoubleConstant : public HConstant {
 ...
 private:
  HDoubleConstant(double value, uint32_t dex_pc = kNoDexPc)
      : HConstant(Primitive::kPrimDouble, dex_pc), value_(value) {}
  HDoubleConstant(int64_t value, uint32_t dex_pc = kNoDexPc)
...
class HAdd : public HBinaryOperation {
 public:
  HAdd(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
  ...
  HConstant* Evaluate(HLongConstant* x, HLongConstant* y) const OVERRIDE {
    return GetBlock()->GetGraph()->GetLongConstant(Compute(x->GetValue(), y->GetValue()), GetDexPc());
  }
...
class HSub : public HBinaryOperation {
 public:
  HSub(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffects::None(), dex_pc) {}
...
class HMul : public HBinaryOperation {
 public:
  HMul(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffects::None(), dex_pc) {}
...
class HDiv : public HBinaryOperation {
 public:
  HDiv(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
...
class HRem : public HBinaryOperation {
 public:
  HRem(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffectsForArchRuntimeCalls(), dex_pc) {}
...
class HDivZeroCheck : public HExpression<1> {
 public:
  HDivZeroCheck(HInstruction* value, uint32_t dex_pc = kNoDexPc)
...
class HShl : public HBinaryOperation {
 public:
  HShl(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffects::None(), dex_pc) {}
...
class HShr : public HBinaryOperation {
 public:
  HShr(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffects::None(), dex_pc) {}
...
class HUShr : public HBinaryOperation {
 public:
  HUShr(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffects::None(), dex_pc) {}
...
class HAnd : public HBinaryOperation {
 public:
  HAnd(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffects::None(), dex_pc) {}
...
class HOr : public HBinaryOperation {
 public:
  HOr(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffects::None(), dex_pc) {}
...
class HXor : public HBinaryOperation {
 public:
  HXor(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(result_type, left, right, SideEffects::None(), dex_pc) {}
...
class HParameterValue : public HExpression<0> {
 public:
  HParameterValue(uint8_t index, Primitive::Type parameter_type, bool is_this = false, uint32_t dex_pc = kNoDexPc)
...
class HBooleanNot : public HUnaryOperation {
 public:
  HBooleanNot(HInstruction* input, uint32_t dex_pc = kNoDexPc)
...
class HTypeConversion : public HExpression<1> {
 public:
  ...
  HTypeConversion(Primitive::Type result_type, HInstruction* input, uint32_t dex_pc = kNoDexPc)
      : HExpression(result_type, SideEffectsForArchRuntimeCalls(input->GetType(), result_type), dex_pc) {
    SetRawInputAt(0, input);
...
class HPhi : public HInstruction {
 public:
  HPhi(ArenaAllocator* arena, uint32_t reg_number, size_t number_of_inputs,
       Primitive::Type type, uint32_t dex_pc = kNoDexPc)
...
class HNullCheck : public HExpression<1> {
 public:
  HNullCheck(HInstruction* value, uint32_t dex_pc = kNoDexPc)
      : HExpression(value->GetType(), SideEffects::None(), dex_pc) {
    SetRawInputAt(0, value);
  }
...
class HArrayGet : public HExpression<2> {
 public:
  HArrayGet(HInstruction* array, HInstruction* index, Primitive::Type type, uint32_t dex_pc)
      : HExpression(type, SideEffects::ArrayReadOfType(type), dex_pc = kNoDexPc) {
...
class HArrayLength : public HExpression<1> {
 public:
  HArrayLength(HInstruction* array, uint32_t dex_pc = kNoDexPc)
...
class HBoundsCheck : public HExpression<2> {
 public:
  HBoundsCheck(HInstruction* index, HInstruction* length, uint32_t dex_pc = kNoDexPc)
...
class HTemporary : public HTemplateInstruction<0> {
 public:
  HTemporary(size_t index, uint32_t dex_pc = kNoDexPc)
...
class HLoadString : public HExpression<1> {
 public:
  HLoadString(HCurrentMethod* current_method, uint32_t string_index, uint32_t dex_pc = kNoDexPc)
      : HExpression(Primitive::kPrimNot, SideEffectsForArchRuntimeCalls(), dex_pc),
...
class HClinitCheck : public HExpression<1> {
 public:
  HClinitCheck(HLoadClass* constant, uint32_t dex_pc = kNoDexPc)
      : HExpression(
            Primitive::kPrimNot,
...
class HThrow : public HTemplateInstruction<1> {
 public:
  HThrow(HInstruction* exception, uint32_t dex_pc = kNoDexPc)
...
class HInstanceOf : public HExpression<2> {
 public:
  HInstanceOf(HInstruction* object,
              ...
              bool class_is_final,
              uint32_t dex_pc = kNoDexPc)
      : HExpression(Primitive::kPrimBoolean, SideEffectsForArchRuntimeCalls(class_is_final), dex_pc),
...
class HBoundType : public HExpression<1> {
 public:
  ...
  HBoundType(HInstruction* input, ReferenceTypeInfo upper_bound,
             bool upper_can_be_null, uint32_t dex_pc = kNoDexPc)
      : HExpression(Primitive::kPrimNot, SideEffects::None(), dex_pc),
...
class HMemoryBarrier : public HTemplateInstruction<0> {
 public:
  HMemoryBarrier(MemBarrierKind barrier_kind, uint32_t dex_pc = kNoDexPc)
      : HTemplateInstruction(
...
class HMonitorOperation : public HTemplateInstruction<1> {
 public:
  ...
  HMonitorOperation(HInstruction* object, OperationKind kind, uint32_t dex_pc = kNoDexPc)
    : HTemplateInstruction(
          SideEffects::AllExceptGCDependency(), dex_pc),  // Assume write/read on all fields/arrays.
      kind_(kind) {
    SetRawInputAt(0, object);
...
class HFakeString : public HTemplateInstruction<0> {
 public:
  explicit HFakeString(uint32_t dex_pc = kNoDexPc) : HTemplateInstruction(SideEffects::None(), dex_pc) {}
...
class HParallelMove : public HTemplateInstruction<0> {
 public:
  HParallelMove(ArenaAllocator* arena, uint32_t dex_pc = kNoDexPc)
