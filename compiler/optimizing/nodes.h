...
class HGraph : public ArenaObject<kArenaAllocMisc> {
 public:
  ...
  // Returns a constant of the given type and value already inserted into
  // the graph. Currently supports only integral types.
...
class HFloatConstant : public HConstant {
 ...
 private:
  ...
  // ever need to create them later in the pipeline, lifting this restriction
  // will require implementing a different canonicalization mechanism.
  friend class SsaBuilder;
