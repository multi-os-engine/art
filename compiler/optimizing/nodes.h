...
class HBasicBlock : public ArenaObject {
 public:
  HBasicBlock(HGraph* graph)
      : graph_(graph),
        predecessors_(graph->arena(), 2),
        successors_(graph->arena(), 2),
...
class HInstruction : public ArenaObject {
 public:
  HInstruction(HBasicBlock* block)
      : previous_(nullptr),
        next_(nullptr) { }
...
class HReturnVoid : public HTemplateInstruction<0> {
 public:
  HReturnVoid(HBasicBlock* block) : HTemplateInstruction<0>(block) {}
...
class HExit : public HTemplateInstruction<0> {
 public:
  HExit(HBasicBlock* block) : HTemplateInstruction<0>(block) {}
...
class HGoto : public HTemplateInstruction<0> {
 public:
  HGoto(HBasicBlock* block) : HTemplateInstruction<0>(block) {}
