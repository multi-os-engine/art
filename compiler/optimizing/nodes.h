...
class HDiv : public HBinaryOperation {
 public:
  HDiv(Primitive::Type result_type, HInstruction* left, HInstruction* right, uint32_t dex_pc = 0)
  ...
  bool NeedsEnvironment() const OVERRIDE { return type_ == Primitive::kPrimLong; }
