...
class HCompare : public HBinaryOperation {
 public:
  HCompare(Primitive::Type type,
    ...
    DCHECK_EQ(HPhi::ToPhiType(type), HPhi::ToPhiType(first->GetType()));
    DCHECK_EQ(HPhi::ToPhiType(type), HPhi::ToPhiType(second->GetType()));
  }
...
class HBoundsCheck : public HExpression<2> {
 public:
  ...
  HBoundsCheck(HInstruction* index, HInstruction* length, uint32_t dex_pc)
    ...
    DCHECK_EQ(HPhi::ToPhiType(index->GetType()), Primitive::kPrimInt);
...
class HUnresolvedInstanceFieldSet : public HTemplateInstruction<2> {
 public:
  HUnresolvedInstanceFieldSet(HInstruction* obj,
    ...
    DCHECK_EQ(HPhi::ToPhiType(field_type), HPhi::ToPhiType(value->GetType()));
    SetRawInputAt(0, obj);
    SetRawInputAt(1, value);
  }
