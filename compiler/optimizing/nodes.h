...
class SideEffects : public ValueObject {
 ...
 private:
  ...
  // TODO: remove this intercepter once HIR types are clean
  static uint64_t TypeFlag(Primitive::Type type, int offset) {
    switch (type) {
      case Primitive::kPrimInt:
      case Primitive::kPrimFloat:
        return TypeFlag2(Primitive::kPrimInt, offset) |
               TypeFlag2(Primitive::kPrimFloat, offset);
      case Primitive::kPrimLong:
      case Primitive::kPrimDouble:
        return TypeFlag2(Primitive::kPrimLong, offset) |
               TypeFlag2(Primitive::kPrimDouble, offset);
      default:
        return TypeFlag2(type, offset);
    }
  }

  // Translates type to bit flag.
  static uint64_t TypeFlag2(Primitive::Type type, int offset) {
