...
class HArraySet : public HTemplateInstruction<3> {
 public:
  HArraySet(HInstruction* array,
      ...
      : HTemplateInstruction(
        ...
        value_can_be_null_(true),
        is_object_array_check_useful_(true) {
    SetRawInputAt(0, array);
    SetRawInputAt(1, index);
  ...
  void ClearIsObjectArrayCheckUseful() {
    is_object_array_check_useful_ = false;
  }

  bool GetValueCanBeNull() const { return value_can_be_null_; }
  bool NeedsTypeCheck() const { return needs_type_check_; }
  bool IsObjectArrayCheckUseful() const { return is_object_array_check_useful_; }
 ...
 private:
  ...
  bool value_can_be_null_;
  bool is_object_array_check_useful_;
