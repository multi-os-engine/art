...
class HLoadClass FINAL : public HInstruction {
 ...
 private:
  ...
  // The special input is current method for kDexCacheViaMethod or kReferrersClass.
  // For other load kinds it's either empty or some architecture-specific instruction
...
class HLoadString FINAL : public HInstruction {
 ...
 private:
  ...
  // The special input is current method for kDexCacheViaMethod.
  // For other load kinds it's either empty or some architecture-specific instruction
  // for PC-relative loads, i.e. kDexCachePcRelative or kBootImageLinkTimePcRelative.
  HUserRecord<HInstruction*> special_input_;
