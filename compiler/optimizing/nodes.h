...
class HArraySet : public HTemplateInstruction<3> {
 public:
  HArraySet(HInstruction* array,
    ...
    Primitive::Type type_at_building = GetComponentType();
    SetSideEffects(SideEffects::ArrayWriteOfType(type_at_building).Union(
        SideEffectsForArchRuntimeCalls(type_at_building)));
  }
