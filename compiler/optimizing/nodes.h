...
class HGraph : public ArenaObject {
 public:
  explicit HGraph(ArenaAllocator* arena)
      : arena_(arena),
        ...
        maximum_number_of_arguments_(0),
  ...
  uint16_t GetMaximumNumberOfArguments() const {
    return maximum_number_of_arguments_;
  }

  void UpdateMaximumNumberOfArguments(uint16_t new_value) {
    maximum_number_of_arguments_ = std::max(new_value, maximum_number_of_arguments_);
  }
 ...
 private:
  ...
  uint16_t maximum_number_of_arguments_;
