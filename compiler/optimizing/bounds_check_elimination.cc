...
class ValueBound : public ValueObject {
 public:
  ...
  // Add a constant to a ValueBound. If constant part overflow/underflow
  // happens and we can't accurately represent it, just return Max/Min() depending
  // on whether the returned ValueBound is used for lower/upper bound.
