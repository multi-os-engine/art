...
TEST(BoundsCheckEliminationTest, ConstantArrayBoundsElimination) {
  ...
  array_set = new (&allocator) HArraySet(
    null_check, bounds_check6, array_length, Primitive::kPrimInt, 0);
  block->AddInstruction(null_check);
  block->AddInstruction(array_length);
  ...
  BoundsCheckElimination bounds_check_elimination(graph);
  bounds_check_elimination.Run();
  ASSERT_NE(bounds_check5->GetBlock(), nullptr);
  ASSERT_EQ(bounds_check4->GetBlock(), nullptr);
  ASSERT_NE(bounds_check6->GetBlock(), nullptr);
}
...
TEST(BoundsCheckEliminationTest, LoopArrayBoundsElimination4) {
  ...
  // Try for (int i=0; i<array.length; i++) { array[array.length-i-1] = 10; }
  HInstruction* bounds_check = nullptr;
  ...
  // Try for (int i=1; i<array.length; i++) { array[array.length-i-1] = 10; }
  ...
  // Try for (int i=0; i<array.length; i++) { array[array.length-i] = 10; }
...
TEST(BoundsCheckEliminationTest, BubbleSortArrayBoundsElimination) {
  ...
  ASSERT_NE(bounds_check2->GetBlock(), nullptr);
  ASSERT_EQ(bounds_check3->GetBlock(), nullptr);
  ASSERT_EQ(bounds_check4->GetBlock(), nullptr);
  ASSERT_EQ(bounds_check5->GetBlock(), nullptr);
  ASSERT_EQ(bounds_check6->GetBlock(), nullptr);
  BoundsCheckElimination bounds_check_elimination(graph);
  bounds_check_elimination.Run();
  ASSERT_EQ(bounds_check1->GetBlock(), nullptr);
