...
public class ConstantFolding {
  ...
  // CHECK-DAG:     [[Const2:i##]]  IntConstant 2
  // CHECK-DAG:     [[Add:i##]]     Add [ [[Const1]] [[Const2]] ]
  ...
  */
  ...
  // CHECK-DAG:     [[Const6:i##]]  IntConstant 6
  // CHECK-DAG:     [[Add1:i##]]    Add [ [[Const1]] [[Const2]] ]
  // CHECK-DAG:     [[Add2:i##]]    Add [ [[Const5]] [[Const6]] ]
  // CHECK-DAG:     [[Add3:i##]]    Add [ [[Add1]] [[Add2]] ]
  // CHECK-DAG:                     Return [ [[Add3]] ]

  // CHECK-START: int ConstantFolding.IntAddition2() constant_folding (after)
  // CHECK-DAG:     [[Const14:i##]] IntConstant 14
  ...
  // CHECK-DAG:     [[Const5:i##]]  IntConstant 5
  // CHECK-DAG:     [[Const2:i##]]  IntConstant 2
  // CHECK-DAG:     [[Sub:i##]]     Sub [ [[Const5]] [[Const2]] ]
  ...
  // CHECK-DAG:     [[Const1:j##]]  LongConstant 1
  // CHECK-DAG:     [[Const2:j##]]  LongConstant 2
  // CHECK-DAG:     [[Add:j##]]     Add [ [[Const1]] [[Const2]] ]
  // CHECK-DAG:                     Return [ [[Add]] ]

  // CHECK-START: long ConstantFolding.LongAddition() constant_folding (after)
  // CHECK-DAG:     [[Const3:j##]]  LongConstant 3
  // CHECK-DAG:                     Return [ [[Const3]] ]
  ...
  // CHECK-DAG:     [[Const5:j##]]  LongConstant 5
  // CHECK-DAG:     [[Const2:j##]]  LongConstant 2
  // CHECK-DAG:     [[Sub:j##]]     Sub [ [[Const5]] [[Const2]] ]
  // CHECK-DAG:                     Return [ [[Sub]] ]
  ...
  // CHECK-DAG:     [[Const5:i##]]  IntConstant 5
  // CHECK-DAG:     [[Const2:i##]]  IntConstant 2
  // CHECK-DAG:     [[Cond:z##]]    GreaterThanOrEqual [ [[Const5]] [[Const2]] ]
  // CHECK-DAG:                     If [ [[Cond]] ]
  ...
  // CHECK-DAG:     [[Const2:i##]]  IntConstant 2
  // CHECK-DAG:     [[Const5:i##]]  IntConstant 5
  // CHECK-DAG:     [[Add:i##]]     Add [ [[Const5]] [[Const2]] ]
  // CHECK-DAG:     [[Sub:i##]]     Sub [ [[Const5]] [[Const2]] ]
  ...
  // CHECK-DAG:     [[Const3:i##]]  IntConstant 3
  // CHECK-DAG:     [[Const7:i##]]  IntConstant 7
  // CHECK-DAG:     [[Phi:i##]]     Phi [ [[Const7]] [[Const3]] ]
  // CHECK-DAG:                     Return [ [[Phi]] ]
