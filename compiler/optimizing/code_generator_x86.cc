...
void CodeGeneratorX86::SaveCpuRegister(Location stack_location, uint32_t reg_id) {
  __ movl(Address(ESP, stack_location.GetStackIndex()), static_cast<Register>(reg_id));
}

void CodeGeneratorX86::RestoreCpuRegister(Location stack_location, uint32_t reg_id) {
