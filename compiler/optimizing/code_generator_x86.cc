...
SlowPathCode* CodeGeneratorX86::MakeReadBarrierMarkSlowPathX86(HInstruction* instruction,
                                                               Location obj) {
  return new (GetGraph()->GetArena()) ReadBarrierMarkSlowPathX86(instruction, obj);
}
