...
class ArraySetSlowPathX86 : public SlowPathCode {
 public:
  ArraySetSlowPathX86(HInstruction* instruction) : instruction_(instruction) {}
  ...
  switch (value_type) {
    ...
    case Primitive::kPrimByte: {
      ...
      Address address = index.IsConstant()
          ...
          : Address(obj, index.AsRegister<Register>(), TIMES_1, offset);
      if (value.IsRegister()) {
    ...
    case Primitive::kPrimChar: {
      ...
      Address address = index.IsConstant()
          ...
          : Address(obj, index.AsRegister<Register>(), TIMES_2, offset);
      if (value.IsRegister()) {
    ...
    case Primitive::kPrimNot: {
      ...
      Address address = index.IsConstant()
          ...
          : Address(obj, index.AsRegister<Register>(), TIMES_4, offset);
      if (!value.IsRegister()) {
        // Just setting null.
    ...
    case Primitive::kPrimDouble: {
      ...
      Address address = index.IsConstant()
          ...
          : Address(obj, index.AsRegister<Register>(), TIMES_8, offset);
      DCHECK(value.IsFpuRegister());
