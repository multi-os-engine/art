...
void ReadBarrierForHeapReferenceSlowPathX86::SaveParameterRegisters(CodeGenerator* codegen,
                                                                    Location out) {
...
void ReadBarrierForHeapReferenceSlowPathX86::RestoreParameterRegisters(CodeGenerator* codegen,
                                                                       Location out) {
  size_t stack_offset = codegen->GetFirstRegisterSlotInSlowPath();
  for (size_t i = 0; i < kParameterCoreRegistersLength; ++i) {
    size_t reg = static_cast<size_t>(kParameterCoreRegisters[i]);
