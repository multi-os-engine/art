...
void InstructionCodeGeneratorX86::GenearateDivRemIntegral(HBinaryOperation* instruction) {
  ...
  switch (instruction->GetResultType()) {
    ...
    default:
      LOG(FATAL) << "Unexpected type for GenearateDivRemIntegral " << instruction->GetResultType();
  }
}
