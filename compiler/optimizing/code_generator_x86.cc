...
class NullCheckSlowPathX86 : public SlowPathCodeX86 {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(ThrowNullPointer),
                               instruction_,
...
class DivZeroCheckSlowPathX86 : public SlowPathCodeX86 {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    CodeGeneratorX86* x86_codegen = down_cast<CodeGeneratorX86*>(codegen);
    __ Bind(GetEntryLabel());
    x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(ThrowDivZero),
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
  }
 ...
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    x86_codegen->EmitParallelMoves(
        ...
        Primitive::kPrimInt);
    x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(ThrowArrayBounds),
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
  }
...
class SuspendCheckSlowPathX86 : public SlowPathCodeX86 {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(TestSuspend),
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
...
class LoadStringSlowPathX86 : public SlowPathCodeX86 {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(ResolveString),
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
...
class LoadClassSlowPathX86 : public SlowPathCodeX86 {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    if (do_clinit_) {
      x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(InitializeStaticStorage),
                                 at_, dex_pc_, this);
    } else {
      x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(InitializeType),
                                 at_, dex_pc_, this);
    }
 ...
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    if (instruction_->IsInstanceOf()) {
      x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(InstanceofNonTrivial),
                                 instruction_,
                                 instruction_->GetDexPc(),
                                 this);
    } else {
      DCHECK(instruction_->IsCheckCast());
      x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(CheckCast),
                                 instruction_,
                                 instruction_->GetDexPc(),
                                 this);
    }
...
class DeoptimizationSlowPathX86 : public SlowPathCodeX86 {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    __ Bind(GetEntryLabel());
    SaveLiveRegisters(codegen, instruction_->GetLocations());
    x86_codegen->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(Deoptimize),
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
  }
...
void InstructionCodeGeneratorX86::GenerateDivRemIntegral(HBinaryOperation* instruction) {
  ...
  switch (instruction->GetResultType()) {
    ...
    case Primitive::kPrimLong: {
      ...
      if (is_div) {
        codegen_->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(Ldiv),
                                instruction,
                                instruction->GetDexPc(),
                                nullptr);
      } else {
        codegen_->InvokeRuntime(QUICK_ENTRYPOINT_ARGS(Lmod),
                                instruction,
                                instruction->GetDexPc(),
                                nullptr);
      }
