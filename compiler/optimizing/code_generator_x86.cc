...
void LocationsBuilderX86::VisitBinaryOperation(HBinaryOperation* instruction) {
  LOG(FATAL) << "Unreachable";
}

void InstructionCodeGeneratorX86::VisitBinaryOperation(HBinaryOperation* instruction) {
  LOG(FATAL) << "Unreachable";
}
