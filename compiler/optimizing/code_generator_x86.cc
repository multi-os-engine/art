...
void LocationsBuilderX86::VisitConditionalSelect(HConditionalSelect* instr) {
  LocationSummary* locations =
...
void InstructionCodeGeneratorX86::VisitConditionalSelect(HConditionalSelect* instr) {
