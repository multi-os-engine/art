...
class NullCheckSlowPathX86 : public DefaultSlowPathCode {
 public:
...
class DivZeroCheckSlowPathX86 : public DefaultSlowPathCode {
 public:
...
class DivRemMinusOneSlowPathX86 : public DefaultSlowPathCode {
 public:
...
class BoundsCheckSlowPathX86 : public DefaultSlowPathCode {
 public:
...
class SuspendCheckSlowPathX86 : public DefaultSlowPathCode {
 public:
...
class LoadStringSlowPathX86 : public DefaultSlowPathCode {
 public:
...
class LoadClassSlowPathX86 : public DefaultSlowPathCode {
 public:
...
class TypeCheckSlowPathX86 : public DefaultSlowPathCode {
 public:
...
class DeoptimizationSlowPathX86 : public DefaultSlowPathCode {
 public:
...
void InstructionCodeGeneratorX86::VisitDivZeroCheck(HDivZeroCheck* instruction) {
  DefaultSlowPathCode* slow_path = new (GetGraph()->GetArena()) DivZeroCheckSlowPathX86(instruction);
  codegen_->AddSlowPath(slow_path);
...
void InstructionCodeGeneratorX86::GenerateExplicitNullCheck(HNullCheck* instruction) {
  DefaultSlowPathCode* slow_path = new (GetGraph()->GetArena()) NullCheckSlowPathX86(instruction);
  codegen_->AddSlowPath(slow_path);
...
void InstructionCodeGeneratorX86::VisitLoadClass(HLoadClass* cls) {
  ...
  if (cls->IsReferrersClass()) {
    ...
    DefaultSlowPathCode* slow_path = new (GetGraph()->GetArena()) LoadClassSlowPathX86(
...
void InstructionCodeGeneratorX86::VisitLoadString(HLoadString* load) {
  DefaultSlowPathCode* slow_path = new (GetGraph()->GetArena()) LoadStringSlowPathX86(load);
  codegen_->AddSlowPath(slow_path);
