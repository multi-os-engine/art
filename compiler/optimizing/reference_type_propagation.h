 ...
 */
class ReferenceTypePropagation : public HOptimization, public HGraphVisitor {
 public:
 ...
 private:
  ...
  void VisitInvokeVirtual(HInvokeVirtual* instr);
  void VisitInvokeStaticOrDirect(HInvokeStaticOrDirect* instr);
  void VisitInvokeInterface(HInvokeInterface* instr);
