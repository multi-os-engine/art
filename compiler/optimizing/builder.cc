  ...
  if (optimized_invoke_type == kVirtual) {
    ...
    if (optimized_invoke_type == kStatic && !is_string_init) {
      ...
      Handle<mirror::DexCache> dex_cache(hs.NewHandle(
          compiler_driver_->GetDexCache(dex_compilation_unit_, self_)));
      ...
      Handle<mirror::DexCache> outer_dex_cache(hs.NewHandle(
          compiler_driver_->GetDexCache(outer_compilation_unit_, self_)));
...
static mirror::Class* GetClassFrom(CompilerDriver* driver,
  ...
  Handle<mirror::DexCache> dex_cache(hs.NewHandle(
      compilation_unit.GetClassLinker()->FindDexCache(self, dex_file)));
