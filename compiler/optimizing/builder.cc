...
bool HGraphBuilder::BuildInvoke(const Instruction& instruction,
  ...
  if (is_string_init) {
    return HandleStringInit(dex_pc,
                            method_idx,
                            string_init_offset,
...
bool HGraphBuilder::HandleStringInit(uint32_t dex_pc,
                                     uint32_t method_idx,
  ...
  MethodReference target_method(dex_file_, method_idx);
  HInvokeStaticOrDirect::DispatchInfo dispatch_info = ComputeDispatchInfo(/*is_string_init*/ true,
                                                                          string_init_offset,
                                                                          target_method,
                                                                          /*direct_method*/ 0,
                                                                          /*direct_code*/ 0);
  HInvoke* invoke = new (arena_) HInvokeStaticOrDirect(
      arena_,
      number_of_arguments - 1,  // Remove this argument.
      ...
      HInvokeStaticOrDirect::ClinitCheckRequirement::kImplicit);
  return SetupArgumentsAndAddStringInit(invoke,
                                        number_of_vreg_arguments,
                                        args,
                                        register_index,
                                        is_range,
...
bool HGraphBuilder::SetupCommonInvokeArguments(HInvoke* invoke,
                                               uint32_t number_of_vreg_arguments,
                                               uint32_t* args,
                                               uint32_t register_index,
                                               bool is_range,
...
bool HGraphBuilder::SetupArgumentsAndAddInvoke(HInvoke* invoke,
  ...
  if (!SetupCommonInvokeArguments(invoke,
                                  number_of_vreg_arguments,
                                  args,
                                  register_index,
                                  is_range,
...
bool HGraphBuilder::SetupArgumentsAndAddStringInit(HInvoke* invoke,
                                                   uint32_t number_of_vreg_arguments,
                                                   uint32_t* args,
                                                   uint32_t register_index,
                                                   bool is_range,
