...
void HGraphBuilder::If_22t(const Instruction& instruction, int32_t dex_offset, IfCondition cond) {
  ...
  HInstruction* ifinst = new (arena_) HIf(comparison, cond);
...
#define IF_XX(comparison, cond) \
    case Instruction::IF_##cond: If_22t<comparison>(instruction, dex_offset, kCond##cond); break; \
    case Instruction::IF_##cond##Z: If_21t<comparison>(instruction, dex_offset, kCond##cond); break
