...
void StackMapStream::FillIn(MemoryRegion region) {
  ...
  ArenaBitVector empty_bitmask(allocator_, 0, false);
...
// Helper for the method below - check that register map has the expected content.
void StackMapStream::CheckDexRegisterMap(CodeInfo& code_info,
