...
class FixNullConstantType : public ValueObject {
 public:
  explicit FixNullConstantType(HGraph* graph) : graph_(graph) {}
...
void SsaBuilder::BuildSsa() {
  ...
  FixNullConstantType fix_null_constants_type(GetGraph());
  fix_null_constants_type.Run();
