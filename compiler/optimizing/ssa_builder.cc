...
void SsaBuilder::BuildSsa() {
  ...
  // 6) Now that the graph is correctly typed, we can get rid of redundant phis.
  ...
  // 7) Fix the type for null constants which are part of an equality comparison.
  ...
  // 9) Now that the right phis are used for the environments, we can eliminate
