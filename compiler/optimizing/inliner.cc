...
bool HInliner::TryInlinePolymorphicCall(HInvoke* invoke_instruction,
  ...
  bool one_target_not_inlined = false;
  ...
  for (size_t i = 0; i < InlineCache::kIndividualCacheSize; ++i) {
    ...
    if (class_index == DexFile::kDexNoIndex ||
      ...
      one_target_not_inlined = true;
    } else {
      one_target_inlined = true;
      bool is_referrer =
          (ic.GetTypeAt(i) == outermost_graph_->GetArtMethod()->GetDeclaringClass());
      deoptimize = !one_target_not_inlined &&
