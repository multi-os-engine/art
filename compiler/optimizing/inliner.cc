...
// TODO: Tune this heuristic when the graph contains inlined methods.
static constexpr size_t kMaximumNumberOfHInstructions = 26;
...
bool HInliner::TryInline(HInvoke* invoke_instruction, uint32_t method_index) {
