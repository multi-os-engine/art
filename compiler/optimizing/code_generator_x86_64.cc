  ...
  switch (op->GetResultType()) {
    ...
    case Primitive::kPrimLong: {
      if (second.IsRegister()) {
        ...
        // TODO: it should not be possible to get an int constant here.
        // There's a bug somewhere, but that can be chased separately.
        HConstant* constant = second.GetConstant();
        Immediate imm(constant->IsIntConstant()
