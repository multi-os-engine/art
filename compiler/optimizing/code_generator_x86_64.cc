...
void LocationsBuilderX86_64::VisitConditionalSelect(HConditionalSelect* instr) {
  ...
  // The comparison is just like a condition.  We only handle integers for now.
...
void InstructionCodeGeneratorX86_64::VisitConditionalSelect(HConditionalSelect* instr) {
