...
class ReadBarrierForHeapReferenceSlowPathX86_64 : public SlowPathCode {
 ...
 private:
  ...
  bool ShouldSaveAndRestoreParameterRegisters() const {
    ...
    // ReadBarrierForRootSlowPathX86_64) when visiting a
...
void ReadBarrierForHeapReferenceSlowPathX86_64::SaveParameterRegisters(CodeGenerator* codegen,
                                                                       Location out) {
...
void ReadBarrierForHeapReferenceSlowPathX86_64::RestoreParameterRegisters(CodeGenerator* codegen,
                                                                          Location out) {
  size_t stack_offset = codegen->GetFirstRegisterSlotInSlowPath();
  for (size_t i = 0; i < kParameterCoreRegistersLength; ++i) {
    size_t reg = static_cast<size_t>(kParameterCoreRegisters[i]);
