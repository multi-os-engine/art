...
void CodeGeneratorX86_64::SaveCpuRegister(Location stack_location, uint32_t reg_id) {
  __ movq(Address(CpuRegister(RSP), stack_location.GetStackIndex()), CpuRegister(reg_id));
}

void CodeGeneratorX86_64::RestoreCpuRegister(Location stack_location, uint32_t reg_id) {
