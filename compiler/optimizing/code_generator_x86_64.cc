...
class NullCheckSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
class DivZeroCheckSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
class DivRemMinusOneSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
class SuspendCheckSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
class BoundsCheckSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
class LoadClassSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
class LoadStringSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
class TypeCheckSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
class DeoptimizationSlowPathX86_64 : public DefaultSlowPathCode {
 public:
...
void InstructionCodeGeneratorX86_64::GenerateExplicitNullCheck(HNullCheck* instruction) {
  DefaultSlowPathCode* slow_path = new (GetGraph()->GetArena()) NullCheckSlowPathX86_64(instruction);
  codegen_->AddSlowPath(slow_path);
...
void InstructionCodeGeneratorX86_64::GenerateClassInitializationCheck(
    DefaultSlowPathCode* slow_path, CpuRegister class_reg) {
...
void InstructionCodeGeneratorX86_64::VisitLoadClass(HLoadClass* cls) {
  ...
  if (cls->IsReferrersClass()) {
    ...
    DefaultSlowPathCode* slow_path = new (GetGraph()->GetArena()) LoadClassSlowPathX86_64(
...
void InstructionCodeGeneratorX86_64::VisitLoadString(HLoadString* load) {
  DefaultSlowPathCode* slow_path = new (GetGraph()->GetArena()) LoadStringSlowPathX86_64(load);
  codegen_->AddSlowPath(slow_path);
