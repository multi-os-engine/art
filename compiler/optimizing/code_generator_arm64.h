...
class CodeGeneratorARM64 : public CodeGenerator {
 ...
 private:
  ...
  // NOTE: The MethodPatchInfo from base class uses generic Label but we need vixl::Label.
  struct MethodPatchInfo {
    explicit MethodPatchInfo(MethodReference method) : target_method(method), label() { }
  ...
  ArenaDeque<MethodPatchInfo> relative_call_patches_;
