...
void LocationsBuilderARM64::VisitArm64IntermediateAddress(
...
void InstructionCodeGeneratorARM64::VisitArm64IntermediateAddress(HArm64IntermediateAddress* instruction) {
