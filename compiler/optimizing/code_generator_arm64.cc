...
void LocationsBuilderARM64::VisitInvokeSuperInterface(HInvokeSuperInterface* invoke) {
...
void InstructionCodeGeneratorARM64::VisitInvokeSuperInterface(HInvokeSuperInterface* invoke) {
