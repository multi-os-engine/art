...
#undef DECLARE_VISIT_INSTRUCTION
 ...
 private:
  ...
  void HandleShift(HBinaryOperation* instruction);
  void GenerateShlLong(const Location& first, Register second);
  void GenerateShrLong(const Location& first, Register second);
  void GenerateUShrLong(const Location& first, Register second);
