...
/**
 * The purpose of this class is to provide a common set of APIs that allow one to call
 *  custom functions.
 ...
 * 6) Dump Selectivity Analysis - Logic to provide verbosity in terms of results gained
...
class DefaultSelectivity : public Selectivity {
 public:
  ...
  static void SwitchMethodLists(PassDriver<PassDriverMEOpts>* driver, CompilationUnit* cu);

 protected:
  DefaultSelectivity() {}
  ~DefaultSelectivity() {}
  static std::vector<const Pass*> custom_opt_list;
};
}  // namespace art
