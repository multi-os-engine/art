...
template <typename ArtMember>
inline std::pair<bool, bool> CompilerDriver::IsFastStaticMember(mirror::DexCache* dex_cache,
                                                                mirror::Class* referrer_class,
...
inline std::pair<bool, bool> CompilerDriver::IsFastStaticField(
  ...
  return IsFastStaticMember(dex_cache, referrer_class, resolved_field, field_idx, storage_index);
}
...
inline bool CompilerDriver::IsClassOfStaticMethodAvailableToReferrer(
  ...
  std::pair<bool, bool> result =
      IsFastStaticMember(dex_cache, referrer_class, resolved_method, method_idx, storage_index);
