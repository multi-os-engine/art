...
inline bool CompilerDriver::IsStaticFieldsClassInitialized(mirror::Class* referrer_class,
  ...
  DCHECK(resolved_field->IsStatic());
  mirror::Class* fields_class = resolved_field->GetDeclaringClass();
  return referrer_class->IsSubClass(fields_class) || CanAssumeClassIsInitialized(fields_class);
}
...
inline bool CompilerDriver::IsMethodsClassInitialized(mirror::Class* referrer_class,
  ...
  mirror::Class* methods_class = resolved_method->GetDeclaringClass();
  return referrer_class->IsSubClass(methods_class) || CanAssumeClassIsInitialized(methods_class);
}
