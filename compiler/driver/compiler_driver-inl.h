...
inline int CompilerDriver::IsFastInvoke(
  ...
  bool can_sharpen_super_based_on_type = (*invoke_type == kSuper) &&
      ...
      resolved_method->GetMethodIndex() < methods_class->GetEmbeddedVTableLength() &&
      (methods_class->GetEmbeddedVTableEntry(resolved_method->GetMethodIndex()) == resolved_method);
