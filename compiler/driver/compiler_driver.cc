...
void CompilerDriver::CompileAll(jobject class_loader,
  ...
  std::unique_ptr<ThreadPool> thread_pool(
      new ThreadPool("Compiler driver thread pool", parallel_thread_count_ - 1));
...
void CompilerDriver::PreCompile(jobject class_loader, const std::vector<const DexFile*>& dex_files,
  ...
  //       be deterministic.
  Verify(class_loader, dex_files, thread_pool, parallel_thread_count_, timings);
...
void CompilerDriver::SetVerifiedDexFile(jobject class_loader, const DexFile& dex_file,
  ...
  context.ForAll(0, dex_file.NumClassDefs(), &visitor, parallel_thread_count_);
}
