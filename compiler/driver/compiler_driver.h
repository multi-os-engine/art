 ...
 public:
  ...
  class ProfileData {
   public:
    ...
    ProfileData(std::string method_name, uint32_t count, uint32_t method_size, double percent) : method_name_(method_name), count_(count), method_size_(method_size), percent_(percent) {
  ...
  bool SkipCompilation(std::string method_name);
