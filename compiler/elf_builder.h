...
class ElfBuilder FINAL {
 public:
  ...
  bool Init() {
    ...
    program_headers_[PH_LOAD_RW_1].p_type    = PT_LOAD;
    program_headers_[PH_LOAD_RW_1].p_flags   = PF_R | PF_W;

    program_headers_[PH_LOAD_RW_2].p_type    = PT_LOAD;
    program_headers_[PH_LOAD_RW_2].p_flags   = PF_R | PF_W;
  ...
  bool Write() {
    ...
    program_headers_[PH_LOAD_RW_1].p_offset = bss_builder_.GetSection()->sh_offset;
    program_headers_[PH_LOAD_RW_1].p_vaddr  = bss_builder_.GetSection()->sh_offset;
    program_headers_[PH_LOAD_RW_1].p_paddr  = bss_builder_.GetSection()->sh_offset;
    program_headers_[PH_LOAD_RW_1].p_filesz = 0;
    program_headers_[PH_LOAD_RW_1].p_memsz  = bss_builder_.GetSection()->sh_size;
    program_headers_[PH_LOAD_RW_1].p_align  = bss_builder_.GetSection()->sh_addralign;

    program_headers_[PH_LOAD_RW_2].p_offset = dynamic_builder_.GetSection()->sh_offset;
    program_headers_[PH_LOAD_RW_2].p_vaddr  = dynamic_builder_.GetSection()->sh_addr;
    program_headers_[PH_LOAD_RW_2].p_paddr  = dynamic_builder_.GetSection()->sh_addr;
    program_headers_[PH_LOAD_RW_2].p_filesz = dynamic_builder_.GetSection()->sh_size;
    program_headers_[PH_LOAD_RW_2].p_memsz  = dynamic_builder_.GetSection()->sh_size;
    program_headers_[PH_LOAD_RW_2].p_align  = dynamic_builder_.GetSection()->sh_addralign;
    ...
    if (bss_builder_.GetSection()->sh_size != 0u) {
      ...
      // Skip PH_LOAD_RW_1.
      Elf_Word part1_size = PH_LOAD_RW_1 * sizeof(Elf_Phdr);
      Elf_Word part2_size = (PH_NUM - PH_LOAD_RW_1 - 1) * sizeof(Elf_Phdr);
      CHECK_EQ(part1_size + part2_size, elf_header_.e_phnum * sizeof(Elf_Phdr));
      pieces.push_back(new ElfFileMemoryPiece<Elf_Word>("Program headers", PHDR_OFFSET,
                                                        &program_headers_, part1_size));
      pieces.push_back(new ElfFileMemoryPiece<Elf_Word>("Program headers part 2",
                                                        PHDR_OFFSET + part1_size,
                                                        &program_headers_, part2_size));
    }
