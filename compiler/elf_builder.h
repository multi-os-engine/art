 ...
 public:
  ...
  bool Write() {
    ...
    if (eh_frame != nullptr) {
      ...
      program_headers_[PH_EH_FRAME].p_vaddr  = eh_frame->GetSection()->sh_offset;
      program_headers_[PH_EH_FRAME].p_paddr  = eh_frame->GetSection()->sh_offset;
      program_headers_[PH_EH_FRAME].p_filesz = eh_frame->GetSection()->sh_size + adjust_filesz;
      program_headers_[PH_EH_FRAME].p_memsz  = eh_frame->GetSection()->sh_size + adjust_memsz;
