...
class ElfBuilder FINAL {
 public:
  ...
  bool Init() {
    ...
    program_headers_[PH_BSS].p_type    = PT_LOAD;
    program_headers_[PH_BSS].p_flags   = PF_R | PF_W;
  ...
  bool Write() {
    ...
    program_headers_[PH_LOAD_RW_].p_vaddr  = dynamic_builder_.GetSection()->sh_addr;
    program_headers_[PH_LOAD_RW_].p_paddr  = dynamic_builder_.GetSection()->sh_addr;
    ...
    program_headers_[PH_BSS].p_offset = bss_builder_.GetSection()->sh_offset;
    program_headers_[PH_BSS].p_vaddr  = bss_builder_.GetSection()->sh_offset;
    program_headers_[PH_BSS].p_paddr  = bss_builder_.GetSection()->sh_offset;
    program_headers_[PH_BSS].p_filesz = 0;
    program_headers_[PH_BSS].p_memsz  = bss_builder_.GetSection()->sh_size;
    program_headers_[PH_BSS].p_align  = bss_builder_.GetSection()->sh_addralign;

    // Finish setup of the Ehdr values.
    elf_header_.e_phoff = PHDR_OFFSET;
    elf_header_.e_shoff = sections_offset;
    static_assert(PH_NUM == PH_BSS + 1, ".bss must be last");
