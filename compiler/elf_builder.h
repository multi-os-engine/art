...
class ElfBuilder FINAL {
 public:
  ...
  using WriteOatSection = std::function<bool(File*)>;  // NOLINT
  ...
  class OatSection FINAL : public Section {
   public:
    OatSection(const std::string& name, Elf_Word type, Elf_Word flags,
               ...
               Elf_Word entsize, Elf_Word size, WriteOatSection write)
        : Section(name, type, flags, link, info, align, entsize),
  ...
  ElfBuilder(InstructionSet isa,
             Elf_Word rodata_size, WriteOatSection write_rodata,
             Elf_Word text_size, WriteOatSection write_text,
             Elf_Word bss_size)
    : isa_(isa),
