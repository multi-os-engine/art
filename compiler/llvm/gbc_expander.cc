...
llvm::Value* GBCExpanderPass::EmitLoadStaticStorage(uint32_t dex_pc,
  ...
  llvm::Value* class_status =  irb_.CreateLoad(storage_object_addr, kTBAARuntimeInfo, kInt);

  llvm::Value* is_initialized = irb_.CreateICmpUGE(class_status,
                                                   irb_.getInt32(art::mirror::Class::kStatusInitialized));

  irb_.CreateCondBr(is_initialized, block_load_static, block_cont, kUnlikely);
  ...
  irb_.CreateBr(block_check_init);
