...
NO_RETURN static void Usage(const char* fmt, ...) {
  ...
  UsageError("      Has priority over the --compiler-filter option.");
...
class Dex2Oat FINAL {
 public:
  ...
  void ParseArgs(int argc, char** argv) {
    ...
    int inline_depth_limit = -1;
    int inline_max_code_units = -1;
