...
static void Usage(const char* fmt, ...) {
  ...
  UsageError("");
  UsageError("  --include-debug-symbols: Add elf symbols for the code within the oat file");
  UsageError("");
  UsageError("  --no-include-debug-symbols: Do not include elf symbols for the code within the oat file");
  UsageError("");
