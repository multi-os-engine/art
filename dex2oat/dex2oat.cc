...
class Dex2Oat {
 public:
  ...
  const CompilerDriver* CreateOatFile(const std::string& boot_image_option,
    ...
    UniquePtr<CompilerDriver> driver(new CompilerDriver(callbacks_.GetVerifiedMethodsData(),
                                                        compiler_backend_,
                                                        instruction_set_,
 ...
 private:
  class Dex2OatCompilerCallbacks : public CompilerCallbacks {
    public:
      ...
      VerifiedMethodsData* GetVerifiedMethodsData() {
        return verified_methods_data_.get();
      }
  ...
  explicit Dex2Oat(CompilerBackend compiler_backend,
      ...
      : compiler_backend_(compiler_backend),
        ...
        callbacks_(new VerifiedMethodsData),
        runtime_(nullptr),
