...
ifeq ($(ART_BUILD_HOST_NDEBUG),true)
  ...
  ifeq ($(ART_BUILD_HOST_STATIC),true)
    $(eval $(call build-art-executable,dex2oat,$(DEX2OAT_SRC_FILES),libart libart-compiler libziparchive-host libnativehelper libnativebridge libsigchain libvixl liblog libz libcutils libbacktrace libunwind libunwindbacktrace libutils libbase,art/compiler,host,ndebug,$(dex2oat_host_arch),static))
  endif
endif
...
ifeq ($(ART_BUILD_HOST_DEBUG),true)
  ...
  ifeq ($(ART_BUILD_HOST_STATIC),true)
    $(eval $(call build-art-executable,dex2oat,$(DEX2OAT_SRC_FILES),libartd libartd-compiler libziparchive-host libnativehelper libnativebridge libsigchain libvixld liblog libz libcutils libbacktrace libunwind libunwindbacktrace libutils libbase,art/compiler,host,debug,$(dex2oat_host_arch),static))
  endif
endif
