...
$(shell rm $(HOST_OUT)/bin/dex2oat $(HOST_OUT)/bin/dex2oatd)
$(shell ln -s dex2oat_${TARGET_ARCH} ${HOST_OUT}/bin/dex2oat)
$(shell ln -s dex2oat_${TARGET_ARCH}d ${HOST_OUT}/bin/dex2oatd)
