...
class OatFileManager {
 public:
  ...
  // Add an oat file to the internal accounting, aborts if there already exist an oat file with the
  // same base address.
  ...
  // Return the oat file for an image, registers the oat file.
  OatFile& RegisterImageOatFile(gc::space::ImageSpace* space)
      REQUIRES(!Locks::oat_file_manager_lock_);
