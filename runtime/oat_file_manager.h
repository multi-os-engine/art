...
class OatFileManager {
 public:
  ...
  // Add an oat file to the internal accounting, std::aborts if there already exist an oat file with
  // the same base address. Returns the oat file pointer from oat_file.
  ...
  // Return the oat file for an image, registers the oat file. Takes owership of the imagespaces'
  // underlying oat file.
