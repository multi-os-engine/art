...
static constexpr size_t kArmStackOverflowReservedBytes =    4 * KB;
static constexpr size_t kArm64StackOverflowReservedBytes =  4 * KB;
static constexpr size_t kX86StackOverflowReservedBytes =    4 * KB;
static constexpr size_t kX86_64StackOverflowReservedBytes = 4 * KB;
