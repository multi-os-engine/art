...
mirror::Object* DexFile::CreateAnnotationMember(Handle<mirror::Class> klass,
  ...
  if (pointer_size == PointerSize::kPointerSize64) {
    method_obj_ptr = mirror::Method::CreateFromArtMethod<PointerSize::kPointerSize64, false>(
        self, annotation_method);
  } else {
    method_obj_ptr = mirror::Method::CreateFromArtMethod<PointerSize::kPointerSize32, false>(
        self, annotation_method);
  }
  ...
  switch (value_type) {
    ...
    case kDexAnnotationMethod: {
      ...
      if (result_style == kAllRaw) {
        ...
        if (method->IsConstructor()) {
          if (pointer_size == PointerSize::kPointerSize64) {
            element_object = mirror::Constructor::CreateFromArtMethod<PointerSize::kPointerSize64,
                                                                      false>(self, method);
          } else {
            element_object = mirror::Constructor::CreateFromArtMethod<PointerSize::kPointerSize32,
                                                                      false>(self, method);
          }
        } else {
          if (pointer_size == PointerSize::kPointerSize64) {
            element_object = mirror::Method::CreateFromArtMethod<PointerSize::kPointerSize64,
                                                                 false>(self, method);
          } else {
            element_object = mirror::Method::CreateFromArtMethod<PointerSize::kPointerSize32,
                                                                 false>(self, method);
          }
        }
        if (element_object == nullptr) {
    ...
    case kDexAnnotationField: {
      ...
      if (result_style == kAllRaw) {
        ...
        PointerSize pointer_size = Runtime::Current()->GetClassLinker()->GetImagePointerSize();
        if (pointer_size == PointerSize::kPointerSize64) {
          element_object = mirror::Field::CreateFromArtField<PointerSize::kPointerSize64>(self,
                                                                                          field,
                                                                                          true);
        } else {
          element_object = mirror::Field::CreateFromArtField<PointerSize::kPointerSize32>(self,
                                                                                          field,
                                                                                          true);
        }
        if (element_object == nullptr) {
