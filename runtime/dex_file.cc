...
mirror::Object* DexFile::GetAnnotationForField(ArtField* field, Handle<mirror::Class> annotation_class) const {
...
bool DexFile::IsFieldAnnotationPresent(ArtField* field, Handle<mirror::Class> annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForField(field);
  if (annotation_set == nullptr) {
    return false;
  }
...
mirror::Object* DexFile::GetAnnotationDefaultValue(ArtMethod* method) const {
  ...
  if (!ProcessAnnotationValue(hs.NewHandle(klass), &annotation, &annotation_value, hs.NewHandle(method->GetReturnType()), kAllObjects)) {
    return nullptr;
  }
  return annotation_value.value_.GetL();
}

mirror::Object* DexFile::GetAnnotationForMethod(ArtMethod* method, Handle<mirror::Class> annotation_class) const {
...
bool DexFile::IsMethodAnnotationPresent(ArtMethod* method, Handle<mirror::Class> annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForMethod(method);
  if (annotation_set == nullptr) {
    return false;
  }
...
const DexFile::AnnotationSetItem* DexFile::FindAnnotationSetForClass(Handle<mirror::Class> klass) const {
  const AnnotationsDirectoryItem* annotations_dir = GetAnnotationsDirectory(*klass->GetClassDef());
  if (annotations_dir == nullptr) {
    return nullptr;
  }
...
mirror::Object* DexFile::GetAnnotationForClass(Handle<mirror::Class> klass, Handle<mirror::Class> annotation_class) const {
...
mirror::ObjectArray<mirror::Object>* DexFile::GetAnnotationsForClass(Handle<mirror::Class> klass) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForClass(klass);
  return ProcessAnnotationSet(klass, annotation_set, kDexVisibilityRuntime);
}

bool DexFile::IsClassAnnotationPresent(Handle<mirror::Class> klass, Handle<mirror::Class> annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForClass(klass);
  if (annotation_set == nullptr) {
    return false;
  }
...
mirror::Object* DexFile::CreateAnnotationMember(Handle<mirror::Class> klass,
  ...
  Handle<mirror::String> name_object(hs.NewHandle(mirror::String::AllocFromModifiedUtf8(self, name)));
  MutableHandle<mirror::Method> method_object(hs.NewHandle<mirror::Method>(nullptr));
  MutableHandle<mirror::Class> method_return(hs.NewHandle<mirror::Class>(nullptr));

  if (name != nullptr) {
    ArtMethod* annotation_method = annotation_class->FindDeclaredVirtualMethodByName(name, sizeof(void*));
    if (annotation_method == nullptr) {
      LOG(WARNING) << "Could not find annotation member " << name << " in " << annotation_class->GetName();
    } else {
      method_object.Assign(mirror::Method::CreateFromArtMethod(self, annotation_method));
      method_return.Assign(annotation_method->GetReturnType());
    }
  }
  ...
  if (new_member.Get() == nullptr || name_object.Get() == nullptr || method_object.Get() == nullptr ||
      method_return.Get() == nullptr) {
    LOG(ERROR) << StringPrintf("Failed creating annotation element (m=%p n=%p a=%p r=%p",
        new_member.Get(), name_object.Get(), method_object.Get(), method_return.Get());
  }
  ...
  uint32_t args[5] = { static_cast<uint32_t>(reinterpret_cast<uintptr_t>(new_member.Get())),
                       static_cast<uint32_t>(reinterpret_cast<uintptr_t>(name_object.Get())),
...
mirror::Object* DexFile::GetAnnotationObjectFromAnnotationSet(Handle<mirror::Class> klass,
    const AnnotationSetItem* annotation_set, uint32_t visibility, Handle<mirror::Class> annotation_class) const {
...
mirror::Object* DexFile::GetAnnotationValue(Handle<mirror::Class> klass,
    const AnnotationItem* annotation_item, const char* annotation_name, Handle<mirror::Class> array_class,
    uint32_t expected_type) const {
  const uint8_t* annotation = SearchEncodedAnnotation(annotation_item->annotation_, annotation_name);
  if (annotation == nullptr) {
    return nullptr;
  }
...
mirror::ObjectArray<mirror::Object>* DexFile::ProcessAnnotationSetRefList(Handle<mirror::Class> klass,
  ...
  switch (value_type) {
    ...
    case kDexAnnotationType:
    {
      ...
      if (result_style == kAllRaw) {
        ...
        element_object = Runtime::Current()->GetClassLinker()->ResolveType(klass->GetDexFile(), index, klass.Get());
        set_object = true;
        if (element_object == nullptr) {
          self->ClearException();
    ...
    case kDexAnnotationArray:
      if (result_style == kAllRaw) {
        ...
        mirror::Array* new_array = mirror::Array::Alloc<true>(self, array_class.Get(), size,
...
mirror::Object* DexFile::ProcessEncodedAnnotation(Handle<mirror::Class> klass,
  ...
  Handle<mirror::Class> annotation_class(hs.NewHandle(class_linker->ResolveType(klass->GetDexFile(), type_index, klass.Get())));
  if (annotation_class.Get() == nullptr) {
    LOG(INFO) << "Unable to resolve " << PrettyClass(klass.Get()) << " annotation class " << type_index;
  ...
  MutableHandle<mirror::ObjectArray<mirror::Object>> element_array(hs.NewHandle<mirror::ObjectArray<mirror::Object>>(nullptr));

  if (size > 0) {
    element_array.Assign(mirror::ObjectArray<mirror::Object>::Alloc(self, annotation_member_array_class, size));
    if (element_array.Get() == nullptr) {
  ...
  uint32_t args[2] = { static_cast<uint32_t>(reinterpret_cast<uintptr_t>(annotation_class.Get())),
                       static_cast<uint32_t>(reinterpret_cast<uintptr_t>(element_array.Get())) };
