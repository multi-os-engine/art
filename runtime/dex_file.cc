...
mirror::Object* DexFile::GetAnnotationForField(ArtField* field, mirror::Class* annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForField(field);
  if (annotation_set == nullptr) {
    return nullptr;
  }
  return GetAnnotationObjectFromAnnotationSet(field->GetDeclaringClass(), annotation_set,
...
mirror::ObjectArray<mirror::Object>* DexFile::GetAnnotationsForField(ArtField* field) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForField(field);
  return ProcessAnnotationSet(field->GetDeclaringClass(), annotation_set, kDexVisibilityRuntime);
}

mirror::ObjectArray<mirror::Object>* DexFile::GetSignatureAnnotationForField(ArtField* field) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForField(field);
  if (annotation_set == nullptr) {
    return nullptr;
  }
  return GetSignatureValue(field->GetDeclaringClass(), annotation_set);
}

bool DexFile::IsFieldAnnotationPresent(ArtField* field, mirror::Class* annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForField(field);
  if (annotation_set == nullptr) {
    return false;
  }
  const AnnotationItem* annotation_item = GetAnnotationItemFromAnnotationSet(
      field->GetDeclaringClass(), annotation_set, kDexVisibilityRuntime, annotation_class);
...
const DexFile::ParameterAnnotationsItem* DexFile::FindAnnotationsItemForMethod(ArtMethod* method) const {
  mirror::Class* klass = method->GetDeclaringClass();
  const AnnotationsDirectoryItem* annotations_dir = GetAnnotationsDirectory(*klass->GetClassDef());
  if (annotations_dir == nullptr) {
    return nullptr;
...
mirror::Object* DexFile::GetAnnotationDefaultValue(ArtMethod* method) const {
  ...
  const uint8_t* annotation = SearchEncodedAnnotation(klass, annotation_item->annotation_, "value");
  ...
  annotation = SearchEncodedAnnotation(klass, annotation, method->GetName());
  if (annotation == nullptr) {
    return nullptr;
  }
  AnnotationValue annotation_value;
  if (!ProcessAnnotationValue(klass, &annotation, &annotation_value, method->GetReturnType(), kAllObjects)) {
    return nullptr;
  }
  return annotation_value.value_.GetL();
}

mirror::Object* DexFile::GetAnnotationForMethod(ArtMethod* method, mirror::Class* annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForMethod(method);
  if (annotation_set == nullptr) {
    return nullptr;
  }
  return GetAnnotationObjectFromAnnotationSet(method->GetDeclaringClass(), annotation_set,
                                              kDexVisibilityRuntime, annotation_class);
}

mirror::ObjectArray<mirror::Object>* DexFile::GetAnnotationsForMethod(ArtMethod* method) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForMethod(method);
  return ProcessAnnotationSet(method->GetDeclaringClass(), annotation_set, kDexVisibilityRuntime);
}
...
mirror::ObjectArray<mirror::Object>* DexFile::GetExceptionTypesForMethod(ArtMethod* method) const {
  ...
  return GetThrowsValue(method->GetDeclaringClass(), annotation_set);
}
...
mirror::ObjectArray<mirror::Object>* DexFile::GetParameterAnnotations(ArtMethod* method) const {
  ...
  if (parameter_annotations == nullptr) {
    // TODO: Allocate the empty array of arrays here instead of in java?
    return nullptr;
  }
  const AnnotationSetRefList* set_ref_list = GetParameterAnnotationSetRefList(parameter_annotations);
  if (set_ref_list == nullptr) {
    return nullptr;
  }
  uint32_t size = set_ref_list->size_;
  return ProcessAnnotationSetRefList(method->GetDeclaringClass(), set_ref_list, size);
}

bool DexFile::IsMethodAnnotationPresent(ArtMethod* method, mirror::Class* annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForMethod(method);
  if (annotation_set == nullptr) {
    return false;
  }
  const AnnotationItem* annotation_item = GetAnnotationItemFromAnnotationSet(
      method->GetDeclaringClass(), annotation_set, kDexVisibilityRuntime, annotation_class);
  return (annotation_item != nullptr);
}

const DexFile::AnnotationSetItem* DexFile::FindAnnotationSetForClass(mirror::Class* klass) const {
  const AnnotationsDirectoryItem* annotations_dir = GetAnnotationsDirectory(*klass->GetClassDef());
  if (annotations_dir == nullptr) {
    return nullptr;
  }
...
mirror::Object* DexFile::GetAnnotationForClass(mirror::Class* klass, mirror::Class* annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForClass(klass);
  if (annotation_set == nullptr) {
    return nullptr;
  }
  return GetAnnotationObjectFromAnnotationSet(klass, annotation_set, kDexVisibilityRuntime, annotation_class);
}

mirror::ObjectArray<mirror::Object>* DexFile::GetAnnotationsForClass(mirror::Class* klass) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForClass(klass);
  return ProcessAnnotationSet(klass, annotation_set, kDexVisibilityRuntime);
}

bool DexFile::IsClassAnnotationPresent(mirror::Class* klass, mirror::Class* annotation_class) const {
  const AnnotationSetItem* annotation_set = FindAnnotationSetForClass(klass);
  if (annotation_set == nullptr) {
    return false;
  }
...
const DexFile::AnnotationItem* DexFile::GetAnnotationItemFromAnnotationSet(mirror::Class* klass,
    const AnnotationSetItem* annotation_set, uint32_t visibility, mirror::Class* annotation_class) const {
  for (uint32_t i = 0; i < annotation_set->size_; ++i) {
    ...
    mirror::Class* resolved_class = Runtime::Current()->GetClassLinker()->ResolveType(
        klass->GetDexFile(), type_index, klass);
    ...
    if (resolved_class == annotation_class) {
...
mirror::Object* DexFile::GetAnnotationObjectFromAnnotationSet(mirror::Class* klass,
    const AnnotationSetItem* annotation_set, uint32_t visibility, mirror::Class* annotation_class) const {
...
mirror::ObjectArray<mirror::Object>* DexFile::GetSignatureValue(mirror::Class* klass,
...
mirror::ObjectArray<mirror::Object>* DexFile::GetThrowsValue(mirror::Class* klass,
    const AnnotationSetItem* annotation_set) const {
  const AnnotationItem* annotation_item =
...
mirror::Object* DexFile::GetAnnotationValue(mirror::Class* klass,
    const AnnotationItem* annotation_item, const char* annotation_name, mirror::Class* array_class,
    uint32_t expected_type) const {
  const uint8_t* annotation = SearchEncodedAnnotation(klass, annotation_item->annotation_, annotation_name);
  if (annotation == nullptr) {
    return nullptr;
  }
...
const uint8_t* DexFile::SearchEncodedAnnotation(mirror::Class* klass, const uint8_t* annotation,
  ...
  while (size--) {
    ...
    SkipAnnotationValue(klass, &annotation);
  }
  return nullptr;
}

bool DexFile::SkipAnnotationValue(mirror::Class* klass, const uint8_t** annotation_ptr) const {
  ...
  switch (value_type) {
    ...
    case kDexAnnotationArray:
    {
      uint32_t size = DecodeUnsignedLeb128(&annotation);
      while (size--) {
        if (!SkipAnnotationValue(klass, &annotation)) {
          return false;
        }
      }
      width = 0;
...
mirror::ObjectArray<mirror::Object>* DexFile::ProcessAnnotationSet(mirror::Class* klass,
...
mirror::Object* DexFile::ProcessEncodedAnnotation(mirror::Class* klass, const uint8_t** annotation) const {
  uint32_t type_index = DecodeUnsignedLeb128(annotation);
  uint32_t size = DecodeUnsignedLeb128(annotation);

  mirror::Class* annotation_class = Runtime::Current()->GetClassLinker()->ResolveType(klass->GetDexFile(), type_index, klass);
  ...
  mirror::Class* annotation_member_array_class =
      Runtime::Current()->GetClassLinker()->FindArrayClass(self, &annotation_member_class);
...
mirror::Object* DexFile::CreateAnnotationMember(mirror::Class* klass,
  ...
  mirror::Object* value_object = annotation_value.value_.GetL();
  mirror::Class* annotation_member_class =
...
bool DexFile::ProcessAnnotationValue(mirror::Class* klass, const uint8_t** annotation_ptr,
    AnnotationValue* annotation_value, mirror::Class* array_class,
  ...
  switch (value_type) {
    ...
    case kDexAnnotationShort:
      ...
      break;
    case kDexAnnotationChar:
      annotation_value->value_.SetC(static_cast<uint16_t>(ReadUnsignedInt(annotation, value_arg, false)));
    ...
    case kDexAnnotationType:
    {
      ...
      if (result_style == kAllRaw) {
        ...
        element_object = reinterpret_cast<mirror::Object*>(Runtime::Current()->GetClassLinker()->ResolveType(klass->GetDexFile(), index, klass));
        set_object = true;
        if (element_object == nullptr) {
          self->ClearException();
    ...
    case kDexAnnotationMethod:
    {
      ...
      if (result_style == kAllRaw) {
        ...
        // does this thing need to throw?
        ArtMethod* method = Runtime::Current()->GetClassLinker()->ResolveAmbiguousMethod(
        ...
        for (uint32_t i = 0; i < size; ++i) {
          ...
          // collect obj?
            ...
            switch (new_annotation_value.type_) {
              case kDexAnnotationByte:
                new_array->AsByteArray()->SetWithoutChecks<false>(i, new_annotation_value.value_.GetB());
                break;
              case kDexAnnotationShort:
                new_array->AsShortArray()->SetWithoutChecks<false>(i, new_annotation_value.value_.GetS());
                break;
              case kDexAnnotationChar:
                new_array->AsCharArray()->SetWithoutChecks<false>(i, new_annotation_value.value_.GetC());
                break;
              case kDexAnnotationInt:
                new_array->AsIntArray()->SetWithoutChecks<false>(i, new_annotation_value.value_.GetI());
                break;
              case kDexAnnotationLong:
                new_array->AsLongArray()->SetWithoutChecks<false>(i, new_annotation_value.value_.GetJ());
                break;
              case kDexAnnotationFloat:
                new_array->AsFloatArray()->SetWithoutChecks<false>(i, new_annotation_value.value_.GetF());
                break;
              case kDexAnnotationDouble:
                new_array->AsDoubleArray()->SetWithoutChecks<false>(i, new_annotation_value.value_.GetD());
                break;
              case kDexAnnotationBoolean:
                new_array->AsBooleanArray()->SetWithoutChecks<false>(i, new_annotation_value.value_.GetZ());
                break;
              default:
                LOG(FATAL) << "Found invalid annotation value_ type_ while building annotation array";
                return false;
            }
          }
        }
    ...
    case kDexAnnotationNull:
      ...
      break;
    default:
      LOG(ERROR) << StringPrintf("Bad annotation element value_ type_ 0x%02x", value_type);
      return false;
  }
...
mirror::ObjectArray<mirror::Object>* DexFile::ProcessAnnotationSetRefList(mirror::Class* klass,
  ...
  mirror::ObjectArray<mirror::Object>* annotation_array_array =
...
void EncodedStaticFieldValueIterator::Next() {
  ...
  case kArray:
  case kAnnotation:
    UNIMPLEMENTED(FATAL) << ": type_ " << type_;
    UNREACHABLE();
  case kNull:
    jval_.l = nullptr;
    width = 0;
...
void EncodedStaticFieldValueIterator::ReadValueToField(ArtField* field) const {
  switch (type_) {
    ...
    default: UNIMPLEMENTED(FATAL) << ": type_ " << type_;
  }
}
