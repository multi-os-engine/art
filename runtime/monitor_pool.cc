...
// At allocation time we do not have a Thread. Thus we cannot actually lock our lock. This is OK as
// at this point nobody can concurrently access the pool.
MonitorPool::MonitorPool()
    : allocated_ids_lock_("allocated monitor ids lock", LockLevel::kMonitorPoolLock),
