...
// of compiled frames.
static constexpr StackVisitor::StackWalkKind kInstrumentationWalk =
    StackVisitor::StackWalkKind::kNoInlinedFrames;
...
static void InstrumentationInstallStack(Thread* thread, void* arg)
  ...
  struct InstallStackVisitor FINAL : public StackVisitor {
    InstallStackVisitor(Thread* thread_in, Context* context, uintptr_t instrumentation_exit_pc)
        : StackVisitor(thread_in, context, kInstrumentationWalk),
...
static void InstrumentationRestoreStack(Thread* thread, void* arg)
  ...
  struct RestoreStackVisitor FINAL : public StackVisitor {
    RestoreStackVisitor(Thread* thread_in, uintptr_t instrumentation_exit_pc,
                        Instrumentation* instrumentation)
        : StackVisitor(thread_in, nullptr, kInstrumentationWalk),
          thread_(thread_in),
          instrumentation_exit_pc_(instrumentation_exit_pc),
...
static void CheckStackDepth(Thread* self, const InstrumentationStackFrame& instrumentation_frame,
                            int delta)
    SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
  size_t frame_id = StackVisitor::ComputeNumFrames(self, kInstrumentationWalk) + delta;
...
void Instrumentation::PushInstrumentationStackFrame(Thread* self, mirror::Object* this_object,
  ...
  size_t frame_id = StackVisitor::ComputeNumFrames(self, kInstrumentationWalk);
