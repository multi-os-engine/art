...
enum ProfileDataType {
  kProfilerMethodSig,  // Method signature only
  kProfilerDexPC,      // Method signature with Dex PC
};
...
class ProfilerOptions {
 public:
  ...
  static constexpr ProfileDataType kDefaultProfileData = kProfilerMethodSig;
