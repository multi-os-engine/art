...
inline MirrorType* ReadBarrier::Barrier(
  ...
  if (with_read_barrier && kUseBakerReadBarrier) {
    ...
    bool is_gray = gc::collector::ConcurrentCopying::HasGrayReadBarrierPointer(
        obj, &rb_ptr_high_bits);
    ...
    if (gc::collector::ConcurrentCopying::kEnableReadBarrierInvariantChecks) {
...
inline void ReadBarrier::AssertToSpaceInvariant(mirror::Object* obj, MemberOffset offset,
                                                mirror::Object* ref) {
  if (gc::collector::ConcurrentCopying::kEnableToSpaceInvariantChecks || kIsDebugBuild) {
