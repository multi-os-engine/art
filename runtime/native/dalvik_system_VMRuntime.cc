...
extern "C" void _dl_android_set_application_target_sdk_version(uint32_t version);
#endif
#include <limits.h>
...
static void VMRuntime_setTargetSdkVersionNative(JNIEnv*, jobject, jint target_sdk_version) {
  ...
  _dl_android_set_application_target_sdk_version(static_cast<uint32_t>(target_sdk_version));
#endif
}
