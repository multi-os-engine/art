...
static jobject DexCache_getResolvedMethod(JNIEnv* env, jobject javaDexCache, jint method_index) {
  ScopedFastNativeObjectAccess soa(env);
  mirror::DexCache* dex_cache = soa.Decode<mirror::DexCache*>(javaDexCache);
  return soa.AddLocalReference<jobject>(dex_cache->GetResolvedMethod(method_index));
}
...
static JNINativeMethod gMethods[] = {
  ...
  NATIVE_METHOD(DexCache, getResolvedMethod, "!(I)Ljava/lang/reflect/ArtMethod;"),
