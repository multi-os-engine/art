...
static jboolean Method_isAnnotationPresentNative(JNIEnv* env, jobject javaMethod, jclass annotationType) {
  ScopedFastNativeObjectAccess soa(env);
  ArtMethod* method = ArtMethod::FromReflectedMethod(soa, javaMethod);
  if (method->GetDeclaringClass()->IsProxyClass()) {
    return false;
...
static JNINativeMethod gMethods[] = {
  NATIVE_METHOD(Method, getAnnotationNative, "!(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;"),
