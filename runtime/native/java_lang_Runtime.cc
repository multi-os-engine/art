...
static void Runtime_setLdLibraryPath(JNIEnv* env, jstring javaLdLibraryPathJstr, jstring javaDexPathJstr) {
#ifdef HAVE_ANDROID_OS
  std::stringstream ss;
  ...
  UNUSED(javaLdLibraryPathJstr);
  UNUSED(javaDexPathJstr);
  UNUSED(env);
#endif
}
...
static jstring Runtime_nativeLoad(JNIEnv* env, jclass, jstring javaFilename, jobject javaLoader,
  ...
  Runtime_setLdLibraryPath(env, javaLdLibraryPathJstr, javaDexPathJstr);
