...
extern "C" void android_update_lookup_fn(lookup_fn_t fn);
...
#else
static jstring Runtime_nativeLoad(JNIEnv* env, jclass, jstring javaFilename, jobject javaLoader, jstring, jstring) {
#endif
  ...
  // TODO: Consider guard for javaLdLibraryPath resetting it after JNI_OnLoad
  // and effectively scoping it to this function call.
  ...
  std::unique_ptr<void, decltype(guard_fn)> guard(dummy_ptr, guard_fn);
