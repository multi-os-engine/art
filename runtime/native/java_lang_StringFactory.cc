...
static jstring StringFactory_newStringFromChars(JNIEnv* env, jclass java_class, jint offset,
...
static jstring StringFactory_newStringFromString(JNIEnv* env, jclass, jstring to_copy) {
  ...
  gc::AllocatorType allocator_type = Runtime::Current()->GetHeap()->GetCurrentAllocator();
  mirror::String* result = mirror::String::AllocFromString<true>(soa.Self(), string->GetCount(),
