...
static jobject Constructor_getAnnotationNative(JNIEnv* env, jobject javaMethod, jclass annotationType) {
  ScopedFastNativeObjectAccess soa(env);
  ArtMethod* method = ArtMethod::FromReflectedMethod(soa, javaMethod);
  mirror::Class* klass = soa.Decode<mirror::Class*>(annotationType);
  return soa.AddLocalReference<jobject>(method->GetDexFile()->GetAnnotationForMethod(method, klass));
}
...
static jboolean Constructor_isAnnotationPresentNative(JNIEnv* env, jobject javaMethod, jclass annotationType) {
  ScopedFastNativeObjectAccess soa(env);
  ArtMethod* method = ArtMethod::FromReflectedMethod(soa, javaMethod);
  mirror::Class* klass = soa.Decode<mirror::Class*>(annotationType);
...
static JNINativeMethod gMethods[] = {
  NATIVE_METHOD(Constructor, getAnnotationNative, "!(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;"),
  ...
  NATIVE_METHOD(Constructor, getParameterAnnotationsNative, "!()[[Ljava/lang/annotation/Annotation;"),
