...
static jstring String_concat(JNIEnv* env, jobject java_this, jobject java_string_arg) {
  ScopedFastNativeObjectAccess soa(env);
  SirtRef<mirror::String> string_this(soa.Self(), soa.Decode<mirror::String*>(java_this));
  SirtRef<mirror::String> string_arg(soa.Self(), soa.Decode<mirror::String*>(java_string_arg));
...
static void String_getCharsNoCheck(JNIEnv* env, jobject java_this, jint start, jint end,
  ...
  ScopedFastNativeObjectAccess soa(env);
  SirtRef<mirror::CharArray> char_array(soa.Self(), soa.Decode<mirror::CharArray*>(buffer));
