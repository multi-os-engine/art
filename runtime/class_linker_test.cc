...
class ClassLinkerTest : public CommonRuntimeTest {
 protected:
  ...
  void AssertArrayClass(const std::string& array_descriptor,
    ...
    Handle<mirror::Class> array(self,
  ...
  void AssertDexFileClass(mirror::ClassLoader* class_loader, const std::string& descriptor)
    ...
    Thread* self = Thread::Current();
    Handle<mirror::Class> klass(self, class_linker_->FindSystemClass(self, descriptor.c_str()));
...
TEST_F(ClassLinkerTest, FindClassNested) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<mirror::ClassLoader> class_loader(soa.Self(), soa.Decode<mirror::ClassLoader*>(LoadDex("Nested")));
...
TEST_F(ClassLinkerTest, FindClass) {
  ...
  Handle<mirror::ClassLoader> class_loader(soa.Self(), soa.Decode<mirror::ClassLoader*>(LoadDex("MyClass")));
...
TEST_F(ClassLinkerTest, ValidatePrimitiveArrayElementsOffset) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<mirror::LongArray> long_array(soa.Self(), mirror::LongArray::Alloc(soa.Self(), 0));
  ...
  Handle<mirror::DoubleArray> double_array(soa.Self(), mirror::DoubleArray::Alloc(soa.Self(), 0));
  ...
  Handle<mirror::IntArray> int_array(soa.Self(), mirror::IntArray::Alloc(soa.Self(), 0));
  ...
  Handle<mirror::CharArray> char_array(soa.Self(), mirror::CharArray::Alloc(soa.Self(), 0));
  ...
  Handle<mirror::ShortArray> short_array(soa.Self(), mirror::ShortArray::Alloc(soa.Self(), 0));
...
TEST_F(ClassLinkerTest, TwoClassLoadersOneClass) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<mirror::ClassLoader> class_loader_1(soa.Self(), soa.Decode<mirror::ClassLoader*>(LoadDex("MyClass")));
  Handle<mirror::ClassLoader> class_loader_2(soa.Self(), soa.Decode<mirror::ClassLoader*>(LoadDex("MyClass")));
...
TEST_F(ClassLinkerTest, StaticFields) {
  ...
  Handle<mirror::Class> statics(soa.Self(), class_linker_->FindClass(soa.Self(), "LStatics;",
                                                                      class_loader));
...
TEST_F(ClassLinkerTest, Interfaces) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<mirror::ClassLoader> class_loader(soa.Self(), soa.Decode<mirror::ClassLoader*>(LoadDex("Interfaces")));
...
TEST_F(ClassLinkerTest, ResolveVerifyAndClinit) {
  ...
  Handle<mirror::ClassLoader> class_loader(soa.Self(), soa.Decode<mirror::ClassLoader*>(jclass_loader));
