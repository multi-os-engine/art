...
TEST_F(ClassLinkerTest, StaticFields) {
  ...
  s0->SetBooleanNonTransactional(statics.get(), false);
  ...
  s1->SetByteNonTransactional(statics.get(), 6);
  ...
  s2->SetCharNonTransactional(statics.get(), 'b');
  ...
  s3->SetShortNonTransactional(statics.get(), -535);
  ...
  s4->SetIntNonTransactional(statics.get(), 2000000001);
  ...
  s5->SetLongNonTransactional(statics.get(), 0x34567890abcdef12LL);
  ...
  s6->SetFloatNonTransactional(statics.get(), 0.75);
  ...
  s7->SetDoubleNonTransactional(statics.get(), 16777219);
  ...
  s8->SetObjectNonTransactional(s8->GetDeclaringClass(),
