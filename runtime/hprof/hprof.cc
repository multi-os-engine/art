...
class Hprof {
 ...
 private:
  static mirror::Object* RootVisitor(mirror::Object* obj, void* arg, pid_t tid, RootType root_type)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
    DCHECK(arg != NULL);
    reinterpret_cast<Hprof*>(arg)->VisitRoot(obj, tid, root_type);
    return obj;
  }
  ...
  void VisitRoot(const mirror::Object* obj, pid_t tid, RootType type)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
...
void Hprof::VisitRoot(const mirror::Object* obj, pid_t tid, RootType type) {
