...
class Hprof : public SingleRootVisitor {
 ...
 private:
  ...
  friend class NativeRootVisitor;
...
// For class loader, ArtField, and ArtMethod roots.
class NativeRootVisitor {
 public:
  explicit NativeRootVisitor(Hprof* hprof) : hprof_(hprof) {}
  ...
  void VisitRoot(mirror::CompressedReference<mirror::Object>* root) const
    ...
    // Since this callback is used for ArtMethod roots as well as class loader classes, use
    // kRootStickyClass if the object is a class.
...
void Hprof::DumpHeapObject(mirror::Object* obj) {
  ...
  NativeRootVisitor visitor(this);
