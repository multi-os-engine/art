...
// and kAccDefaultConflict will have this bit set. Any kAccDefault method containined in the
// methods_ array of a concrete class will also have this bit set.
