...
class Agent {
 public:
  enum LoadError {
    ...
    AlreadyStarted,       // The agent has already been loaded
    LoadingError,         // dlopen or dlsym returned an error
    InitializationError,  // The entrypoint did not return 0. This might require an abort
  };
