...
Agent::LoadError Agent::Load(/*out*/jint* call_res, /*out*/ std::string* error_msg) {
  ...
  *call_res = onload_(static_cast<JavaVM*>(Runtime::Current()->GetJavaVM()), args_.c_str(), nullptr);
  if (*call_res != 0) {
