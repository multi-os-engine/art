...
extern "C" void* art_quick_alloc_array##suffix(uint32_t, int32_t, void* ref); \
extern "C" void* art_quick_alloc_array_resolved##suffix(void* klass, int32_t, void* ref); \
extern "C" void* art_quick_alloc_array_with_access_check##suffix(uint32_t, int32_t, void* ref); \
extern "C" void* art_quick_alloc_object##suffix(uint32_t type_idx, void* ref); \
extern "C" void* art_quick_alloc_object_resolved##suffix(void* klass, void* ref); \
extern "C" void* art_quick_alloc_object_initialized##suffix(void* klass, void* ref); \
extern "C" void* art_quick_alloc_object_with_access_check##suffix(uint32_t type_idx, void* ref); \
extern "C" void* art_quick_check_and_alloc_array##suffix(uint32_t, int32_t, void* ref); \
extern "C" void* art_quick_check_and_alloc_array_with_access_check##suffix(uint32_t, int32_t, void* ref); \
extern "C" void* art_quick_alloc_array##suffix##_instrumented(uint32_t, int32_t, void* ref); \
extern "C" void* art_quick_alloc_array_resolved##suffix##_instrumented(void* klass, int32_t, void* ref); \
extern "C" void* art_quick_alloc_array_with_access_check##suffix##_instrumented(uint32_t, int32_t, void* ref); \
extern "C" void* art_quick_alloc_object##suffix##_instrumented(uint32_t type_idx, void* ref); \
extern "C" void* art_quick_alloc_object_resolved##suffix##_instrumented(void* klass, void* ref); \
extern "C" void* art_quick_alloc_object_initialized##suffix##_instrumented(void* klass, void* ref); \
extern "C" void* art_quick_alloc_object_with_access_check##suffix##_instrumented(uint32_t type_idx, void* ref); \
extern "C" void* art_quick_check_and_alloc_array##suffix##_instrumented(uint32_t, int32_t, void* ref); \
extern "C" void* art_quick_check_and_alloc_array_with_access_check##suffix##_instrumented(uint32_t, int32_t, void* ref); \
