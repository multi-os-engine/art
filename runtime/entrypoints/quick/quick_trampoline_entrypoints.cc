...
class QuickArgumentVisitor {
  ...
  // |            |    4x2 bytes padding
  // | Method*    |  <- sp
  static constexpr bool kQuickPairRegisterMustStartEven = !kArm32QuickCodeUseSoftFloat;
  ...
  // |            |    padding
  // | Method*    |  <- sp
  static constexpr bool kQuickPairRegisterMustStartEven = false;
      ...
      switch (cur_type_) {
        ...
        case Primitive::kPrimLong:
          if (kQuickSoftFloatAbi || (cur_type_ == Primitive::kPrimLong)) {
            if (kQuickPairRegisterMustStartEven && gpr_index_ == 0) {
              gpr_index_++;
            }
