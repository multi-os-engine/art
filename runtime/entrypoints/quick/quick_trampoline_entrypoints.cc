...
class QuickArgumentVisitor {
  ...
  static constexpr size_t kQuickCalleeSaveFrame_RefAndArgs_LrOffset = 280;  // Offset of return address.
...
template <class T> class BuildGenericJniFrameStateMachine {
 public:
  ...
  static constexpr size_t kNumNativeGprArgs = 7;  // 6 arguments passed in GPRs.
