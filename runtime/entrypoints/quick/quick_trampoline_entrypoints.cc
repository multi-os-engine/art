...
extern "C" uint64_t artQuickToInterpreterBridge(mirror::ArtMethod* method, Thread* self,
  ...
  if (method->IsAbstract()) {
    ...
    if (method->IsStatic() && !method->GetDeclaringClass()->IsInitializing()) {
      ...
      Handle<mirror::Class> sirt_c(self, method->GetDeclaringClass());
...
extern "C" const void* artQuickResolutionTrampoline(mirror::ArtMethod* called,
  ...
  if (called->IsRuntimeMethod()) {
    Handle<mirror::Object> sirt_receiver(soa.Self(), virtual_or_interface ? receiver : nullptr);
  ...
  if (LIKELY(!self->IsExceptionPending())) {
    ...
    Handle<mirror::Class> called_class(soa.Self(), called->GetDeclaringClass());
...
#error "Unsupported architecture"
 ...
 public:
  ...
  void AdvanceHandleScope(mirror::Object* ptr) SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
    uintptr_t sirtRef = PushHandleScope(ptr);
 ...
 private:
  ...
  uintptr_t PushHandleScope(mirror::Object* ref) SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
    return delegate_->PushHandleScope(ref);
  }
 ...
 public:
  ...
  void ComputeLayout(mirror::ArtMethod*** m, bool is_static, const char* shorty, uint32_t shorty_len,
    ...
    *sirt_entries = num_sirt_references_;
    size_t handle_scope_size = HandleScope::GetAlignedHandleScopeSize(num_sirt_references_);
  ...
  uintptr_t PushHandleScope(mirror::Object* /* ptr */) {
...
class BuildGenericJniFrameVisitor FINAL : public QuickArgumentVisitor {
 public:
  BuildGenericJniFrameVisitor(mirror::ArtMethod*** sp, bool is_static, const char* shorty,
    ...
    cur_sirt_entry_ = reinterpret_cast<StackReference<mirror::Object>*>(GetFirstHandleScopeEntry());
 ...
 * We need to fix this, as the HandleScope needs to go into the callee-save frame.
 *
