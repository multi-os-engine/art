...
\
  V(InitializeStaticStorage, void*, uint32_t, ArtMethod*) \
  V(InitializeTypeAndVerifyAccess, void*, uint32_t, ArtMethod*) \
  V(InitializeType, void*, uint32_t, ArtMethod*) \
  V(ResolveString, void*, uint32_t, ArtMethod*) \
\
