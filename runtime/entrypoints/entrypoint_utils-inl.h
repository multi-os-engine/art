...
inline ArtMethod* GetResolvedMethod(ArtMethod* outer_method,
  ...
  // Update the dex cache for future lookups. Note that this is safe when the class
  // is being initialized, as the entrypoint for the ArtMethod is at this point still
