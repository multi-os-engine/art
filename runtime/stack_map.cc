...
void CodeInfo::Dump(std::ostream& os, uint16_t number_of_dex_registers) const {
  ...
  size_t number_of_location_set_entries = GetNumberOfDexRegisterLocationSetEntries();
  size_t location_set_size_in_bytes = GetDexRegisterLocationSetSize();
  os << "  DexRegisterLocationSet (number_of_entries=" << number_of_location_set_entries
     << ", size_in_bytes=" << location_set_size_in_bytes << ")\n";
  DexRegisterLocationSet dex_register_location_set = GetDexRegisterLocationSet();
