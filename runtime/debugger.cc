 ...
 * frame, in which cases this exception is considered uncaught.
 */
class CatchLocationFinder : public StackVisitor {
 public:
  explicit CatchLocationFinder(Thread* self, const Handle<mirror::Throwable>& exception, Context* context)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_)
  ...
  bool VisitFrame() OVERRIDE SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
    ...
    if (dex_pc != DexFile::kDexNoIndex) {
      ...
      bool clear;
      found_dex_pc = mirror::ArtMethod::FindCatchBlock(h_method, exception_class, dex_pc, &clear);
