...
// Attempts to create dalvik-cache at subdir, if it does not already exits. Will return true if
// there is a dalvik-cache at this directory by the end of the call or false otherwise.
