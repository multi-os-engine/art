...
// In quick code for ARM and ARM64 we make poor use of registers and perform frequent suspend
...
// of a register). This also has the effect of making loops and Java code in general look cold to
// profilers.
