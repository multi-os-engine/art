...
ADD_TEST_EQ(METHOD_CHECK_OSR, static_cast<int32_t>(art::jit::kJitCheckForOSR))

#define METHOD_HOTNESS_DISABLE -2
ADD_TEST_EQ(METHOD_HOTNESS_DISABLE, static_cast<int32_t>(art::jit::kJitHotnessDisabled))
