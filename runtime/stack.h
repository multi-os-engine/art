 ...
 public:
  ...
  static int GetVRegOffset(const DexFile::CodeItem* code_item,
    ...
    if (reg == kVRegMethodPtrBaseReg) {
       ...
       */
      return locals_start + ((reg + std::abs(kVRegNonSpecialTempBaseReg) - 1) * sizeof(uint32_t));
