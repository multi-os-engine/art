...
class EntrypointsOrderTest : public CommonRuntimeTest {
 protected:
  ...
  void CheckQuickEntryPoints() {
    ...
    EXPECT_OFFSET_DIFFNP(QuickEntryPoints, pSetObjStatic, pGet8Instance, kPointerSize);
    EXPECT_OFFSET_DIFFNP(QuickEntryPoints, pGet8Instance, pGet8Static, kPointerSize);
    EXPECT_OFFSET_DIFFNP(QuickEntryPoints, pGet8Static, pGet16Instance, kPointerSize);
    EXPECT_OFFSET_DIFFNP(QuickEntryPoints, pGet16Instance, pGet16Static, kPointerSize);
    EXPECT_OFFSET_DIFFNP(QuickEntryPoints, pGet16Static, pGet32Instance, kPointerSize);
