...
#endif
#else
// MOE: to be honest this value is the allocation granularity, not page size. By using this value
// we can ensure that the mman.h implementation in our Windows Compatibility Layer will work
// properly.
static constexpr int kPageSize = 64 * KB;
#endif
