...
class DexRegisterMap {
 public:
  static DexRegisterMap Create(MemoryRegion region,
    ...
    map.SetLiveDexRegMask(live_dex_reg_mask);
    return map;
  }

  static DexRegisterMap Load(MemoryRegion region, size_t offset, size_t number_of_dex_registers) {
