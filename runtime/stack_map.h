...
class DexRegisterLocation {
 public:
   ...
   * - kInRegister: vreg stored in low 32 bits of a physical register,
   *                value holds the register number;
   * - kInRegisterHigh: vreg stored in high 32 bits of a physical register,
   *                    value holds the register number;
   * - kInFpuRegister: vreg stored in low 32 bits of a FPU register,
   *                   value holds the register number;
   * - kInFpuRegisterHigh: vreg stored in high 32 bits of a FPU register,
   *                       value holds the register number;
