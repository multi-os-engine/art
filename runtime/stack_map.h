 ...
 public:
  ...
  size_t GetLocationMappingDataSize(uint16_t number_of_dex_registers,
    ...
    size_t location_mapping_data_size_in_bits =
        ...
        * SingleEntrySizeInBits(number_of_location_set_entries);
 ...
 * DexRegisterLocationSet+, StackMap+, DexRegisterMap+, InlineInfo*].
 */
class CodeInfo {
 public:
  ...
  uint32_t GetStackMapsOffset() const {
    return GetDexRegisterLocationSetOffset() + GetDexRegisterLocationSetSize();
  }
