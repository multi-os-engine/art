...
#define ELEMENT_OFFSET_AFTER(PreviousElement) \
...
class InlineInfo {
 ...
 private:
  ...
  static constexpr int kFixedSize = ELEMENT_OFFSET_AFTER(Depth);

  static constexpr int kMethodIndexOffset = 0;
  static constexpr int kDexPcOffset = ELEMENT_OFFSET_AFTER(MethodIndex);
  static constexpr int kInvokeTypeOffset = ELEMENT_OFFSET_AFTER(DexPc);
  static constexpr int kDexRegisterMapOffset = ELEMENT_OFFSET_AFTER(InvokeType);
  static constexpr int kFixedEntrySize = ELEMENT_OFFSET_AFTER(DexRegisterMap);
...
class CodeInfo {
 ...
 private:
  ...
  static constexpr int kEncodingInfoOffset = ELEMENT_OFFSET_AFTER(OverallSize);
  static constexpr int kNumberOfLocationCatalogEntriesOffset = ELEMENT_OFFSET_AFTER(EncodingInfo);
  static constexpr int kNumberOfStackMapsOffset =
      ELEMENT_OFFSET_AFTER(NumberOfLocationCatalogEntries);
  static constexpr int kStackMaskSizeOffset = ELEMENT_OFFSET_AFTER(NumberOfStackMaps);
  static constexpr int kFixedSize = ELEMENT_OFFSET_AFTER(StackMaskSize);
