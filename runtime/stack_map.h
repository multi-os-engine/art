 ...
 public:
  ...
  void SetEncoding(size_t inline_info_size,
    ...
    if (inline_info_size != 0) {
      ...
      region_.StoreBit(kHasSmallInlineInfoBitOffset, IsUint<kBitsForSmallEncoding>(
    ...
    region_.StoreBit(kHasSmallDexPcBitOffset, IsUint<kBitsForSmallEncoding>(dex_pc_max));
    region_.StoreBit(kHasSmallNativePcBitOffset, IsUint<kBitsForSmallEncoding>(native_pc_max));
  }
