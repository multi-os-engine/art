...
class DeoptimizationReturnValueRecord {
 public:
  ...
  mirror::Object** GetGCRoot() { return ret_val_.GetGCRoot(); }
...
class Thread {
 ...
 public:
  ...
  // Currently deoptimization invokes verifier which can trigger classloading
 ...
 private:
  ...
  struct PACKED(4) tls_ptr_sized_values {
      ...
      stacked_shadow_frame_record(nullptr), deoptimization_return_value_stack(nullptr), name(nullptr),
