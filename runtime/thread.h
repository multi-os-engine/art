 ...
 public:
  ...
  void ReleaseLongJumpContext(Context* context) {
    if (tlsPtr_.long_jump_context != nullptr) {
      // Each QuickExceptionHandler saves the long jump context and uses
      ...
      // cases of exception handling and multiple saved contexts.
      ...
      // saving a context. Since we only keeps one context for reuse, delete the existing
      // one since the passed in context is yet to be used for longjump.
