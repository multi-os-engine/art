...
//
// For loading an executable oat file, use the ExecutableOatFileAssistant
// class instead.
//
...
class OatFileAssistant {
 ...
 private:
  ...
  // Constructs an OatFileAssistant with user specified oat location, a
  // package name, and the option to be executable.
  //
  ...
  friend class ExecutableOatFileAssistant;
  DISALLOW_COPY_AND_ASSIGN(OatFileAssistant);
};

// An OatFileAssistant for executable oat files.
//
...
class ExecutableOatFileAssistant : public OatFileAssistant {
 public:
  // Constructs an ExecutableOatFileAssistant object to assist with the oat
  // file corresponding to the given dex location for the current runtime
  // instruction set.
  explicit ExecutableOatFileAssistant(const char* dex_location);

  // Constructs an ExecutableOatFileAssistant, providing an explicit target
  // oat_location to use instead of the standard oat location.
  ExecutableOatFileAssistant(const char* dex_location, const char* oat_location);
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(ExecutableOatFileAssistant);
};
