...
class OatFileAssistant {
 public:
  enum DexOptStatus {
    // kUpToDate - The code for this dex location is up to date and can be
    // used as is.
    ...
    // kOutOfDate - In order to make the code for this dex location up to
  ...
  //    use the GetDexOptStatus() method, not the OatFileStatus() method.
