...
static DexFileUniquePtr OpenDexFileBase64(const char* base64, const char* location,
...
static DexFileUniquePtr FixChecksumAndOpen(uint8_t* bytes, size_t length, const char* location,
                                           std::string* error_msg) {
  // Check data.
  CHECK(bytes != nullptr);
