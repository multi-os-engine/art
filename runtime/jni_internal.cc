...
class JNI {
 public:
  ...
  static jobject ToReflectedMethod(JNIEnv* env, jclass, jmethodID mid, jboolean) {
    ...
    if (m->IsConstructor()) {
      method = mirror::Constructor::CreateFromArtMethod<kPointerSizeCur, false>(soa.Self(), m);
    } else {
      method = mirror::Method::CreateFromArtMethod<kPointerSizeCur, false>(soa.Self(), m);
    }
  ...
  static jobject ToReflectedField(JNIEnv* env, jclass, jfieldID fid, jboolean) {
    ...
    return soa.AddLocalReference<jobject>(
        mirror::Field::CreateFromArtField<kPointerSizeCur>(soa.Self(), f, true));
  }
