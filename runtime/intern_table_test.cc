...
TEST_F(InternTableTest, Intern) {
  ...
  Handle<mirror::String> foo_1(soa.Self(), intern_table.InternStrong(3, "foo"));
  Handle<mirror::String> foo_2(soa.Self(), intern_table.InternStrong(3, "foo"));
  Handle<mirror::String> foo_3(soa.Self(), mirror::String::AllocFromModifiedUtf8(soa.Self(), "foo"));
  Handle<mirror::String> bar(soa.Self(), intern_table.InternStrong(3, "bar"));
...
TEST_F(InternTableTest, Size) {
  ...
  Handle<mirror::String> foo(soa.Self(), mirror::String::AllocFromModifiedUtf8(soa.Self(), "foo"));
...
TEST_F(InternTableTest, SweepInternTableWeaks) {
  ...
  t.InternStrong(3, "foo");
  t.InternStrong(3, "bar");
  Handle<mirror::String> hello(soa.Self(),
                                mirror::String::AllocFromModifiedUtf8(soa.Self(), "hello"));
  Handle<mirror::String> world(soa.Self(),
                                mirror::String::AllocFromModifiedUtf8(soa.Self(), "world"));
  Handle<mirror::String> s0(soa.Self(), t.InternWeak(hello.Get()));
  Handle<mirror::String> s1(soa.Self(), t.InternWeak(world.Get()));
  ...
  Handle<mirror::String> still_here(soa.Self(),
...
TEST_F(InternTableTest, ContainsWeak) {
  ScopedObjectAccess soa(Thread::Current());
  {
    ...
    InternTable t;
    Handle<mirror::String> interned_foo_1(soa.Self(), t.InternStrong(3, "foo"));
    EXPECT_FALSE(t.ContainsWeak(interned_foo_1.Get()));
    Handle<mirror::String> interned_foo_2(soa.Self(), t.InternStrong(3, "foo"));
...

  {
    ...
    InternTable t;
    Handle<mirror::String> foo_1(soa.Self(),
                                  mirror::String::AllocFromModifiedUtf8(soa.Self(), "foo"));
    Handle<mirror::String> foo_2(soa.Self(),
                                  mirror::String::AllocFromModifiedUtf8(soa.Self(), "foo"));
    EXPECT_NE(foo_1.Get(), foo_2.Get());
    Handle<mirror::String> interned_foo_1(soa.Self(), t.InternWeak(foo_1.Get()));
    Handle<mirror::String> interned_foo_2(soa.Self(), t.InternWeak(foo_2.Get()));
...

  {
    ...
    InternTable t;
    Handle<mirror::String> foo(soa.Self(), mirror::String::AllocFromModifiedUtf8(soa.Self(), "foo"));
    Handle<mirror::String> interned_foo_1(soa.Self(), t.InternWeak(foo.Get()));
...

  {
    ...
    Handle<mirror::String> interned_foo_1(soa.Self(), t.InternStrong(3, "foo"));
    EXPECT_FALSE(t.ContainsWeak(interned_foo_1.Get()));
    Handle<mirror::String> foo(soa.Self(),
                                mirror::String::AllocFromModifiedUtf8(soa.Self(), "foo"));
    Handle<mirror::String> interned_foo_2(soa.Self(), t.InternWeak(foo.Get()));
    EXPECT_FALSE(t.ContainsWeak(interned_foo_2.Get()));
    EXPECT_EQ(interned_foo_1.Get(), interned_foo_2.Get());
  }
}
