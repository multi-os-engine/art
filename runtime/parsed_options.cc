...
void ParsedOptions::Usage(const char* fmt, ...) {
  ...
  UsageMessage(stream, "  -Xps-min-nr-of-methods-to-save:integervalue\n");
  UsageMessage(stream, "  -Xps-min-nr-of-classes-to-save:integervalue\n");
  UsageMessage(stream, "  -Xps-min-nr-of-notification-before-wake:integervalue\n");
  UsageMessage(stream, "  -Xps-max-nr-of-notification-before-wake:integervalue\n");
