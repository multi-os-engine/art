...
class ClassLinker {
 public:
  ...
  mirror::DexCachePointerArray* AllocArtPointerArray(Thread* self, size_t length)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
  ...
  ArtMethod* AllocArtMethod(Thread* self) SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
 ...
 private:
  ...
  ArtMethod* CreateProxyConstructor(Thread* self, Handle<mirror::Class> klass,
                                    mirror::Class* proxy_class)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
  ArtMethod* CreateProxyMethod(Thread* self, Handle<mirror::Class> klass, ArtMethod* prototype)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
