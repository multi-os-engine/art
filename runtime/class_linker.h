...
class ClassLinker {
 public:
  ...
  // (if multidex) into the given vector. Note: This can be used for "single" dex files, not
  // just multidex.
  bool OpenMultiDexFilesFromOat(const char* dex_location, const char* oat_location,
