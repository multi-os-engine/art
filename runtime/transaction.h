...
class Transaction {
 ...
 private:
  ...
  void VisitObjectLogs(RootVisitor* visitor, void* arg) EXCLUSIVE_LOCKS_REQUIRED(log_lock_);
  void VisitArrayLogs(RootVisitor* visitor, void* arg) EXCLUSIVE_LOCKS_REQUIRED(log_lock_);
  void VisitStringLogs(RootVisitor* visitor, void* arg) EXCLUSIVE_LOCKS_REQUIRED(log_lock_);
