...
class BackgroundMethodSamplingProfiler {
 public:
  static void Start(const std::string& output_filename, const ProfileOptions& options)
 ...
 private:
  explicit BackgroundMethodSamplingProfiler(const std::string& output_filename, const ProfileOptions& options);
...
class ProfileFile {
 ...
 public:
  // Loads profile data from the given file clearing any previously loaded data.
