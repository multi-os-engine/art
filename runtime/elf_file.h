...
class ElfFile {
 ...
 private:
  union ElfFileContainer {
    std::unique_ptr<ElfFileImpl<Elf32_Ehdr, Elf32_Phdr, Elf32_Shdr, Elf32_Word, Elf32_Sword,
                    Elf32_Addr, Elf32_Sym, Elf32_Rel, Elf32_Rela, Elf32_Dyn>> elf32_;
    std::unique_ptr<ElfFileImpl<Elf64_Ehdr, Elf64_Phdr, Elf64_Shdr, Elf64_Word, Elf64_Sword,
                    Elf64_Addr, Elf64_Sym, Elf64_Rel, Elf64_Rela, Elf64_Dyn>> elf64_;
    ElfFileContainer() {}
    ~ElfFileContainer() {}
  } elf_;
  bool is_elf64_;
