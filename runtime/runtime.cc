...
bool Runtime::Start() {
  ...
  if (!IsImageDex2OatEnabled() || !GetHeap()->HasBootImageSpace()) {
    ...
    Handle<mirror::Class> class_class(hs.NewHandle<mirror::Class>(mirror::Class::GetJavaLangClass()));
    Handle<mirror::Class> field_class(hs.NewHandle<mirror::Class>(mirror::Field::StaticClass()));
