...
QuickMethodFrameInfo StackVisitor::GetCurrentQuickFrameInfo() const {
  ...
  if (method->IsProxyMethod()) {
    ...
    // cloned from the original java.lang.reflect.Proxy class together with tje code and as a
    // result it is executed as usual quick compiled method without any stubs. Therefore the method
    // must have a OatQuickMethodHeader.
