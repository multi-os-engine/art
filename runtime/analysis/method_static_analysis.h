...
class MethodLogisticsAnalysis : public StaticAnalysisPass {
 public:
   ...
   */
  uint32_t PerformAnalysis(StaticAnalysisMethodCumulativeStats* stats, mirror::ArtMethod* method, const DexFile* dex_file) const SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
    UNUSED(dex_file);
  ...
  void DumpPassAnalysis(std::stringstream& string_stream) const {
    string_stream << static_analysis_method_cumulative_logistics_stats_->num_of_methods_ <<" methods total. "
        << static_analysis_method_cumulative_logistics_stats_->num_of_native_methods_ << " native methods found. "
        << static_analysis_method_cumulative_logistics_stats_->num_of_abstract_methods_ << " abstract methods found. "
        << static_analysis_method_cumulative_logistics_stats_->num_of_analyzable_methods_ << " analyzable methods found. ";
  }
...
class MethodMiscLogisticsAnalysis : public StaticAnalysisPass {
 public:
   ...
   */
  void DumpPassAnalysis(std::stringstream& string_stream) const {
    string_stream << static_analysis_method_cumulative_misc_logistics_stats_->num_of_methods_that_are_constructors_ << " constructor methods. ";
  }
  StaticAnalysisMethodCumulativeStats* GetStats() const {
 ...
 public:
    ...
    uint32_t PerformAnalysis(StaticAnalysisMethodCumulativeStats* stats, mirror::ArtMethod* method, const DexFile* dex_file) const SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
      ...
      if (code_item != nullptr) {
        ...
        static_analysis_method_cumulative_size_stats->size_of_all_methods_.FetchAndAdd(insns_size);
     ...
     */
    void DumpPassAnalysis(std::stringstream& string_stream) const {
      string_stream << static_analysis_method_cumulative_size_stats_->size_of_all_methods_ << " size of Methods in Dex File. "
          << static_analysis_method_cumulative_size_stats_->num_of_sub_tiny_methods_ << " number of sub tiny methods. "
          << static_analysis_method_cumulative_size_stats_->num_of_tiny_methods_ << " number of tiny methods. "
          << static_analysis_method_cumulative_size_stats_->num_of_sub_small_methods_ << " number of sub small methods. "
          << static_analysis_method_cumulative_size_stats_->num_of_small_methods_ << " number of small methods. "
          << static_analysis_method_cumulative_size_stats_->num_of_medium_methods_ << " number of medium methods. "
          << static_analysis_method_cumulative_size_stats_->num_of_large_methods_ << " number of large methods. "
          << static_analysis_method_cumulative_size_stats_->num_of_too_large_methods_ << " number of too large methods. ";
    }
    StaticAnalysisMethodCumulativeStats* GetStats() const {
...
class MethodOpcodeAnalysis : public StaticAnalysisPass {
 public:
  ...
  void DumpPassAnalysis(std::stringstream& string_stream) const {
    string_stream
        << static_analysis_method_cumulative_opcode_stats_->num_of_constant_assigns_ << " number of constant assigns. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_unconditional_jumps_ << " number of unconditional jumps. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_conditional_jumps_ << " number of conditional jumps. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_method_invokes_ << " number of method invokes. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_fp_instructions_ << " number of Floating Point Instructions. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_methods_with_try_catch_ << " number of methods with try catch. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_throw_instructions_ << " number of throw instructions. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_math_instructions_ << " number of math instructions. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_data_movement_getters_instructions_ << " number of getters. "
        << static_analysis_method_cumulative_opcode_stats_->num_of_data_movement_setters_instructions_ << " number of setters. ";
  }
