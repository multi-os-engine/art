...
#ifndef ART_RUNTIME_ANALYSIS_PROFILING_INFO_H_
#define ART_RUNTIME_ANALYSIS_PROFILING_INFO_H_
#include <stdint.h>

namespace art {
/** Default No Profiling Info Found */
static const uint32_t kMethodNone = 0x0000;

/**
 * Per Method Info
 * There exist two types of profiling info
...
/**
 * Method Profile Info Presence
 * These are the minimum percentages that help categorize the info a particular size
 *  within profile_info_size
 */

static const float kLargeProfileInfoMin = 0.66;   // 66%
static const float kMediumProfileInfoMin = 0.33;  // 33%
static const float kSmallProfileInfoMin = 0.00;   // 0%

/** @brief The different sizes of profile. */
enum class profile_info_size { NONE, SMALL, MEDIUM, LARGE };
}  // namespace art

#endif  // ART_RUNTIME_ANALYSIS_PROFILING_INFO_H_
