...
TEST_F(ClassProfileTest, DexCacheProfileDataConstructor) {
  ...
  DexCacheProfileData profile2(0);
  static constexpr size_t kCount = 1234;
  DexCacheProfileData profile3(kCount);
...
TEST_F(ClassProfileTest, DexCacheProfileDataUpdate) {
  ...
  StackHandleScope<123> hs(soa.Self());
  ...
  DexCacheProfileData profile(num_class_defs);
