...
struct DebugInvokeReq {
  DebugInvokeReq(mirror::Object* invoke_receiver, mirror::Object* invoke_thread,
                 mirror::Class* invoke_class, mirror::ArtMethod* invoke_method,
                 uint32_t invoke_options, uint64_t* args, uint32_t args_count)
      : receiver(invoke_receiver), thread(invoke_thread), klass(invoke_class),
