...
class ConcurrentCopyingVerifyNoFromSpaceRefsVisitor : public RootVisitor {
 public:
  ...
  void CheckRoot(mirror::Object* root) SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
    DCHECK(root != nullptr);
    operator()(root);
  }
