...
class ConcurrentCopyingImmuneSpaceScanObjVisitor {
 public:
  explicit ConcurrentCopyingImmuneSpaceScanObjVisitor(ConcurrentCopying* cc)
      : collector_(cc) {}
...
void ConcurrentCopying::MarkingPhase() {
  ...
  for (auto& space : immune_spaces_.GetSpaces()) {
    ...
    ConcurrentCopyingImmuneSpaceScanObjVisitor visitor(this);
