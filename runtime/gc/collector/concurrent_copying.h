...
class ConcurrentCopying : public GarbageCollector {
 public:
  ...
  void ReclaimPhase() SHARED_REQUIRES(Locks::mutator_lock_);
  void FinishPhase();
 ...
 private:
  ...
  bool ProcessMarkStackOnce() SHARED_REQUIRES(Locks::mutator_lock_);
  ...
  mirror::Object* AllocateInSkippedBlock(size_t alloc_size)
      SHARED_REQUIRES(Locks::mutator_lock_);
  void CheckEmptyMarkStack() SHARED_REQUIRES(Locks::mutator_lock_);
