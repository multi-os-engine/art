...
// Test [image1][image2][image1 oat][image2 oat][image] producing a single large immune region.
TEST_F(ImmuneSpacesTest, MultiImage) {
  ...
  // Add a smaller non-adjacent space it is not part of the immune region.
  ...
  // Add a larger non-adjacent space and make sure it becomes the new region.
