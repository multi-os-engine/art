...
mirror::Object* MarkSweep::MarkRootParallelCallback(mirror::Object* root, void* arg, pid_t /*tid*/,
                                                    RootType /*root_type*/) {
  DCHECK(root != NULL);
  DCHECK(arg != NULL);
...
Object* MarkSweep::MarkRootCallback(Object* root, void* arg, pid_t /*tid*/,
                                    RootType /*root_type*/) {
  DCHECK(root != nullptr);
  DCHECK(arg != nullptr);
