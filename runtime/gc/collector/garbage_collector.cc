...
void GarbageCollector::Run(GcCause gc_cause, bool clear_soft_references) {
  ...
  GetHeap()->PreGcVerification(this);  // Do the pre GC verification, this may cause pauses.
  RunPhases();  // Run all the GC phases.
  GetHeap()->PostGcVerification(this);  // Do the post GC verification, this may cause pauses.
