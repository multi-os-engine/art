...
class SemiSpaceMarkObjectVisitor {
 public:
  ...
  void operator()(Object* obj, MemberOffset offset, bool /* is_static */)
      const ALWAYS_INLINE NO_THREAD_SAFETY_ANALYSIS {
    collector_->MarkObject(obj->GetFieldObjectReferenceAddr(offset));
  }

  // EXCLUSIVE_LOCKS_REQUIRED(Locks::heap_bitmap_lock_, Locks::mutator_lock_)
  void operator()(mirror::Class* klass, mirror::Reference* ref) const NO_THREAD_SAFETY_ANALYSIS {
