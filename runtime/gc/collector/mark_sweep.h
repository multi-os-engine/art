...
class MarkSweep : public GarbageCollector {
 public:
  ...
  static mirror::Object* MarkRootCallback(mirror::Object* root, void* arg, pid_t tid,
                                          RootType root_type)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_)
      EXCLUSIVE_LOCKS_REQUIRED(Locks::heap_bitmap_lock_);

  static mirror::Object* MarkRootParallelCallback(mirror::Object* root, void* arg, pid_t tid,
                                                  RootType root_type);
