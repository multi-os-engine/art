...
static constexpr bool kZeroInsteadOfPrefetch = false;
...
RosAlloc::Run* RosAlloc::dedicated_full_run_ = reinterpret_cast<Run*>(dedicated_full_run_storage_);
...
std::string RosAlloc::Run::Dump() {
  ...
  stream << "RosAlloc Run = " << reinterpret_cast<void*>(this)
         ...
         << " first_bitmap_idx=" << first_search_vec_idx_
