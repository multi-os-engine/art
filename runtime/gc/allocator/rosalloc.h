...
class RosAlloc {
 ...
 public:
  ...
  ObjectBytePair SweepRun(Thread* self, Run* run, size_t bracket_idx, uintptr_t* live, uintptr_t* mark,
                          accounting::ContinuousSpaceBitmap* live_bitmap, uintptr_t live_bitmap_begin,
                          bool swap_bitmaps);
