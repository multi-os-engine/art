...
class FixupObjectAdapter : public FixupVisitor {
 public:
  ...
  ALWAYS_INLINE bool IsInAppImage(mirror::Object* object) const {
    return app_image_.ContainsSource(reinterpret_cast<uintptr_t>(object));
  }
 ...
 public:
  ...
  ALWAYS_INLINE void operator()(mirror::Object* obj) const NO_THREAD_SAFETY_ANALYSIS {
    ...
    if (obj->IsClass<kVerifyNone, kWithoutReadBarrier>()) {
      ...
      // Deal with the pointer arrays arrays. Use the helper function since multiple classes can
