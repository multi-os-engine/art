...
class BumpPointerSpace FINAL : public ContinuousMemMapAllocSpace {
 public:
  ...
  size_t RevokeAllThreadLocalBuffers() REQUIRES(!Locks::runtime_shutdown_lock_,
                                                      Locks::thread_list_lock_);
  void AssertThreadLocalBuffersAreRevoked(Thread* thread) REQUIRES(!block_lock_);
  void AssertAllThreadLocalBuffersAreRevoked() REQUIRES(!Locks::runtime_shutdown_lock_,
                                                              Locks::thread_list_lock_);
