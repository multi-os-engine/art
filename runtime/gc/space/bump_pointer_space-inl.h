...
inline mirror::Object* BumpPointerSpace::AllocThreadUnsafe(Thread* self, size_t num_bytes,
  ...
  *bytes_allocated = num_bytes;
  ...
  bytes_allocated_.StoreRelaxed(bytes_allocated_.LoadRelaxed() + static_cast<int32_t>(num_bytes));
...
inline mirror::Object* BumpPointerSpace::AllocNonvirtual(size_t num_bytes) {
  ...
  if (ret != nullptr) {
    ...
    bytes_allocated_.FetchAndAddSequentiallyConsistent(static_cast<int32_t>(num_bytes));
  }
  return ret;
}
