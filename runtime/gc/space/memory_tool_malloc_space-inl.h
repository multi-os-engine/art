...
template <typename S, size_t kMemoryToolRedZoneBytes,
          bool kAdjustForRedzoneInAllocSize, bool kUseObjSizeForUsable>
MemoryToolMallocSpace<S, kMemoryToolRedZoneBytes, kAdjustForRedzoneInAllocSize,
                      kUseObjSizeForUsable>::~MemoryToolMallocSpace() {
  MEMORY_TOOL_MAKE_UNDEFINED(S::Begin(), S::Capacity());
}
