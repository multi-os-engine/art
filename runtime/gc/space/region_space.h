...
class RegionSpace FINAL : public ContinuousMemMapAllocSpace {
 public:
  ...
  void DumpRegions(std::ostream& os) const;
  void DumpNonFreeRegions(std::ostream& os) const;
 ...
 private:
  ...
  void WalkInternal(ObjectCallback* callback, void* arg)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
  ...
  class Region {
   public:
    ...
    bool Contains(mirror::Object* ref) {
  ...
  Region* RefToRegion(mirror::Object* ref) {
  ...
  Region* regions_;                // The pointer to the region array.
