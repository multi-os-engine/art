...
Heap::Heap(size_t initial_size, size_t growth_limit, size_t min_free, size_t max_free,
    ...
    : non_moving_space_(nullptr),
      ...
      max_allocation_stack_size_(kGCALotMode ? kGcAlotInterval
          : (kDesiredVerifyObjectMode > kVerifyObjectModeFast) ? KB : MB),
...
void Heap::VerifyObjectBody(mirror::Object* obj) {
  ...
  mirror::Class* c = obj->GetFieldObject<mirror::Class, 0>(mirror::Object::ClassOffset(), false);
  ...
  if (verify_object_mode_ > kVerifyObjectModeFast) {
    // Note: the bitmap tests below are racy since we don't hold the heap bitmpa lock.
