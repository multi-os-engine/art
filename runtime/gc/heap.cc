...
class VerifyReferenceVisitor {
 public:
  explicit VerifyReferenceVisitor(Heap* heap, AtomicInteger* fail_count, bool verify_referent)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_, Locks::heap_bitmap_lock_)
  ...
  void operator()(mirror::Class* klass, mirror::Reference* ref) const
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
    if (verify_referent_) {
      (*this)(ref, mirror::Reference::ReferentOffset(), false);
    }
  }

  void operator()(mirror::Object* obj, MemberOffset offset, bool /*is_static*/) const
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
    (*this)(obj, obj->GetFieldObject<mirror::Object>(offset), offset);
  }

  // TODO: Fix the no thread safety analysis.
  // Returns false on failure.
  bool operator()(mirror::Object* obj, mirror::Object* ref, MemberOffset offset) const
  ...
  static void VerifyRootCallback(mirror::Object** root, void* arg, uint32_t thread_id,
    ...
    if (!(*visitor)(nullptr, *root, MemberOffset(0))) {
 ...
 private:
  Heap* const heap_;
  AtomicInteger* const fail_count_;
...
class VerifyObjectVisitor {
 public:
  explicit VerifyObjectVisitor(Heap* heap, AtomicInteger* fail_count, bool verify_referent)
      : heap_(heap), fail_count_(fail_count), verify_referent_(verify_referent) {
  }
