...
class Heap {
 public:
  ...
  // The call is not needed if nullptr is stored in the field.
 ...
 private:
  ...
  // When the number of bytes allocated exceeds the footprint TryAllocate returns nullptr indicating
