...
class Heap {
 ...
 private:
  ...
  volatile int32_t count_direct_delay_OOM_;

  // Saved OOMs by indirect Ros2Ros compaction.
  volatile int32_t count_indirect_delay_OOM_;

  // Count for requested Ros2Ros compaction.
  volatile int32_t count_requested_Ros2Ros_compaction_;

  // Count for ignored Ros2Ros compaction.
  volatile int32_t count_ignored_Ros2Ros_compaction_;
