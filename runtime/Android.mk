...
$$(ENUM_OPERATOR_OUT_GEN): $$(GENERATED_SRC_DIR)/%_operator_out.cc : $(LOCAL_PATH)/%.h
  ...
  ifeq ($$(art_static_or_shared),static)
    LOCAL_STATIC_LIBRARIES := libnativehelper libnativebridge libnativeloader libsigchain_dummy libbacktrace liblz4
  else
    LOCAL_SHARED_LIBRARIES := libnativehelper libnativebridge libnativeloader libsigchain libbacktrace liblz4
  endif
