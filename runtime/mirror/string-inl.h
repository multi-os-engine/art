...
inline size_t String::SizeOf() {
  ...
  // String.equals() intrinsics assume zero-padding up to kObjectAlignment and though
  // a String is initially allocated in zero-initialized space, GC compaction may
  // choose to copy only SizeOf() bytes, so we want to include the padding.
  // http://b/23528461
