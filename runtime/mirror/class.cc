...
void Class::SetStatus(Status new_status, Thread* self) {
  ...
  if (UNLIKELY(new_status == kStatusError)) {
    ...
    Handle<mirror::Object> old_throw_this_object(self, NULL);
    Handle<mirror::ArtMethod> old_throw_method(self, NULL);
    Handle<mirror::Throwable> old_exception(self, NULL);
...
String* Class::ComputeName() {
  ...
  Handle<mirror::Class> sirt_c(self, this);
