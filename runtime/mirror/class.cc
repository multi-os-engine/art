...
ArtMethod* Class::GetDeclaredConstructor(
  ...
  for (auto& m : GetDirectMethods(pointer_size)) {
    ...
    if (m.GetInterfaceMethodIfProxy(kPointerSizeCur)->EqualParameters(args)) {
      return &m;
    }
...
template
mirror::Method* Class::GetDeclaredMethodInternal<PointerSize::kPointerSize32, false>(
    Thread* self,
    mirror::Class* klass,
    mirror::String* name,
    mirror::ObjectArray<mirror::Class>* args);
template
mirror::Method* Class::GetDeclaredMethodInternal<PointerSize::kPointerSize32, true>(
    Thread* self,
    mirror::Class* klass,
    mirror::String* name,
    mirror::ObjectArray<mirror::Class>* args);
template
mirror::Method* Class::GetDeclaredMethodInternal<PointerSize::kPointerSize64, false>(
    Thread* self,
    mirror::Class* klass,
    mirror::String* name,
    mirror::ObjectArray<mirror::Class>* args);
template
mirror::Method* Class::GetDeclaredMethodInternal<PointerSize::kPointerSize64, true>(
    Thread* self,
    mirror::Class* klass,
    mirror::String* name,
    mirror::ObjectArray<mirror::Class>* args);
...
template
mirror::Constructor* Class::GetDeclaredConstructorInternal<PointerSize::kPointerSize32, false>(
    Thread* self,
    mirror::Class* klass,
    mirror::ObjectArray<mirror::Class>* args);
template
mirror::Constructor* Class::GetDeclaredConstructorInternal<PointerSize::kPointerSize32, true>(
    Thread* self,
    mirror::Class* klass,
    mirror::ObjectArray<mirror::Class>* args);
template
mirror::Constructor* Class::GetDeclaredConstructorInternal<PointerSize::kPointerSize64, false>(
    Thread* self,
    mirror::Class* klass,
    mirror::ObjectArray<mirror::Class>* args);
template
mirror::Constructor* Class::GetDeclaredConstructorInternal<PointerSize::kPointerSize64, true>(
    Thread* self,
    mirror::Class* klass,
    mirror::ObjectArray<mirror::Class>* args);
