...
inline mirror::Field* Field::CreateFromArtField(Thread* self, mirror::ArtField* field) {
  ...
  // TODO: Lazily resolve field names?
  ret->SetName<kTransactionActive>(field->GetStringName(self, true));
  ret->SetDeclaringClass<kTransactionActive>(field->GetDeclaringClass());
  ret->SetType<kTransactionActive>(type);  // TODO: What to pass in?
