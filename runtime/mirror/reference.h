...
class MANAGED Reference : public Object {
 public:
  ...
  void SetPendingNext(bool transaction_active, Reference* pending_next)
  ...
  // Returns true if the reference has already been enqueued, or is currently
  // pending enqueue.
  bool IsPendingEnqueued() SHARED_REQUIRES(Locks::mutator_lock_) {
