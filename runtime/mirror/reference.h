...
class MANAGED ReferenceClass : public Class {
 public:
  static MemberOffset IntrinsicEnabledMaskOffset() {
    return OFFSET_OF_OBJECT_MEMBER(ReferenceClass, intrinsic_enabled_mask_);
  }
 ...
 private:
  int32_t intrinsic_enabled_mask_;
