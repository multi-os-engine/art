...
String* String::Alloc(Thread* self, int32_t utf16_length) {
  ...
  String* string = down_cast<String*>(heap->AllocObject(self, java_lang_String, size));
  if (string != NULL) {
...
ArtMethod* String::GetStringFactoryMethodForStringInit(std::string signature) {
  ...
  if (signature == "()V") {
    return sf_class->FindDirectMethod("newEmptyString", "()Ljava/lang/String;");
  }
  if (signature == "([B)V") {
    return sf_class->FindDirectMethod("newStringFromBytes", "([B)Ljava/lang/String;");
  }
  if (signature == "([BI)V") {
    return sf_class->FindDirectMethod("newStringFromBytes", "([BI)Ljava/lang/String;");
  }
  if (signature == "([BII)V") {
    return sf_class->FindDirectMethod("newStringFromBytes", "([BII)Ljava/lang/String;");
  }
  if (signature == "([BIII)V") {
    return sf_class->FindDirectMethod("newStringFromBytes", "([BIII)Ljava/lang/String;");
  }
  if (signature == "([BIILjava/lang/String;)V") {
    return sf_class->FindDirectMethod("newStringFromBytes", "([BIILjava/lang/String;)Ljava/lang/String;");
  }
  if (signature == "([BLjava/lang/String;)V") {
    return sf_class->FindDirectMethod("newStringFromBytes", "([BLjava/lang/String;)Ljava/lang/String;");
  }
  if (signature == "([BIILjava/nio/charset/Charset;)V") {
    return sf_class->FindDirectMethod("newStringFromBytes", "([BIILjava/nio/charset/Charset;)Ljava/lang/String;");
  }
  if (signature == "([BLjava/nio/charset/Charset;)V") {
    return sf_class->FindDirectMethod("newStringFromBytes", "([BLjava/nio/charset/Charset;)Ljava/lang/String;");
  }
  if (signature == "([C)V") {
    return sf_class->FindDirectMethod("newStringFromChars", "([C)Ljava/lang/String;");
  }
  if (signature == "([CII)V") {
    return sf_class->FindDirectMethod("newStringFromChars", "([CII)Ljava/lang/String;");
  }
  if (signature == "(II[C)V") {
    return sf_class->FindDirectMethod("newStringFromCharsNoCheck", "(II[C)Ljava/lang/String;");
  }
  if (signature == "(Ljava/lang/String;)V") {
    return sf_class->FindDirectMethod("newStringFromString", "(Ljava/lang/String;)Ljava/lang/String;");
  }
  if (signature == "(Ljava/lang/StringBuffer;)V") {
    return sf_class->FindDirectMethod("newStringFromStringBuffer", "(Ljava/lang/StringBuffer;)Ljava/lang/String;");
  }
  if (signature == "([III)V") {
    return sf_class->FindDirectMethod("newStringFromCodePoints", "([III)Ljava/lang/String;");
  }
  if (signature == "(Ljava/lang/StringBuilder;)V") {
    return sf_class->FindDirectMethod("newStringFromStringBuilder", "(Ljava/lang/StringBuilder;)Ljava/lang/String;");
  }
  return NULL;
}
