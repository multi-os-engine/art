...
class MANAGED AbstractMethod : public AccessibleObject {
 ...
 private:
  ...
  static MemberOffset DeclaringOfOverriddenMethodClassOffset() {
  ...
  HeapReference<mirror::ArtMethod> declaring_class_;
  HeapReference<mirror::ArtMethod> declaring_class_of_overridden_method_;
