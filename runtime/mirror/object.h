...
class MANAGED LOCKABLE Object {
 public:
  ...
  // TODO: In most cases, these assumptions are too strong.  However, the
  // monitor inflation logic currently doesn't seem to tolerate spurious
  // failures, even for CasLockWord.
