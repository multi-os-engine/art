...
class MANAGED Class FINAL : public Object {
 ...
 private:
  ...
  // declared by this class.
  //
  // The slice methods_[copied_methods_offset_:len(methods_)] are the methods that are copied from
  ...
  // default, and default-conflict methods. Having a hard limit of (2<<16 - 1) for methods defined
  // on a single class is well established in Java so we will use only uint16_t's here.
