...
class MANAGED Class FINAL : public Object {
 public:
  ...
  void PopulateEmbeddedImtAndVTable(ArtMethod* (&methods)[kImtSize], size_t pointer_size)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
  ...
  void VisitNativeRoots(Visitor& visitor, size_t image_pointer_size)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
  ...
  Class* CopyOf(Thread* self, int32_t new_length, ArtMethod* (&imt)[mirror::Class::kImtSize],
