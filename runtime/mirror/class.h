...
class MANAGED Class FINAL : public Object {
 public:
  ...
  ALWAYS_INLINE ArtMethod* GetDirectMethods() SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);

  void SetDirectMethods(ArtMethod* new_direct_methods)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
  ...
  template<VerifyObjectFlags kVerifyFlags = kDefaultVerifyFlags>
  ALWAYS_INLINE ArtMethod* GetVirtualMethods() SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);

  ALWAYS_INLINE void SetVirtualMethods(ArtMethod* new_virtual_methods)
      SHARED_LOCKS_REQUIRED(Locks::mutator_lock_);
