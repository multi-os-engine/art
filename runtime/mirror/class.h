...
class MANAGED Class FINAL : public Object {
 ...
 private:
  ...
  // defining class loader, or nullptr for the "bootstrap" system loader
  HeapReference<ClassLoader> class_loader_;

  // For array classes, the component class object for instanceof/checkcast
  // (for String[][][], this will be String[][]). nullptr for non-array classes.
  HeapReference<Class> component_type_;

  // DexCache of resolved constant pool entries (will be nullptr for classes generated by the
  ...
  // The superclass, or nullptr if this is java.lang.Object, an interface or primitive type.
