...
template bool AbstractMethod::CreateFromArtMethod<PointerSize::kPointerSize32, false>(
    ArtMethod* method);
template bool AbstractMethod::CreateFromArtMethod<PointerSize::kPointerSize32, true>(
    ArtMethod* method);
template bool AbstractMethod::CreateFromArtMethod<PointerSize::kPointerSize64, false>(
    ArtMethod* method);
template bool AbstractMethod::CreateFromArtMethod<PointerSize::kPointerSize64, true>(
    ArtMethod* method);
