...
inline ArtMethod* Class::GetDirectMethods() {
...
inline void Class::SetDirectMethods(ArtMethod* new_direct_methods) {
...
template<VerifyObjectFlags kVerifyFlags>
inline ArtMethod* Class::GetVirtualMethods() {
...
inline void Class::SetVirtualMethods(ArtMethod* new_virtual_methods) {
...
inline ArtMethod* Class::GetVirtualMethodUnchecked(size_t i, size_t pointer_size) {
  auto* methods = GetVirtualMethods();
  DCHECK(methods != nullptr);
  return reinterpret_cast<ArtMethod*>(reinterpret_cast<uintptr_t>(methods) +
      ArtMethod::ObjectSize(pointer_size) * i);
}
