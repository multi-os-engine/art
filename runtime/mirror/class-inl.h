...
inline size_t Class::GetObjectSize() {
...
inline size_t Class::NumDirectMethods() {
...
inline size_t Class::NumVirtualMethods() {
...
inline size_t Class::NumStaticFields() {
...
inline size_t Class::NumInstanceFields() {
