...
template Method* Method::CreateFromArtMethod<PointerSize::kPointerSize32, false>(Thread* self,
                                                                                 ArtMethod* method);
template Method* Method::CreateFromArtMethod<PointerSize::kPointerSize32, true>(Thread* self,
                                                                                ArtMethod* method);
template Method* Method::CreateFromArtMethod<PointerSize::kPointerSize64, false>(Thread* self,
                                                                                 ArtMethod* method);
template Method* Method::CreateFromArtMethod<PointerSize::kPointerSize64, true>(Thread* self,
                                                                                ArtMethod* method);
...
template Constructor* Constructor::CreateFromArtMethod<PointerSize::kPointerSize32, false>(
    Thread* self, ArtMethod* method);
template Constructor* Constructor::CreateFromArtMethod<PointerSize::kPointerSize32, true>(
    Thread* self, ArtMethod* method);
template Constructor* Constructor::CreateFromArtMethod<PointerSize::kPointerSize64, false>(
    Thread* self, ArtMethod* method);
template Constructor* Constructor::CreateFromArtMethod<PointerSize::kPointerSize64, true>(
    Thread* self, ArtMethod* method);
