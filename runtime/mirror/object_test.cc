...
class ObjectTest : public CommonRuntimeTest {
 protected:
  void AssertString(int32_t expected_utf16_length,
    ...
    Handle<String> string(self, String::AllocFromModifiedUtf8(self, expected_utf16_length, utf8_in));
...
TEST_F(ObjectTest, Clone) {
  ...
  Handle<ObjectArray<Object> > a1(soa.Self(),
...
TEST_F(ObjectTest, AllocObjectArray) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<ObjectArray<Object> > oa(soa.Self(),
...
TEST_F(ObjectTest, AllocArray) {
  ...
  Handle<Array> a(soa.Self(), Array::Alloc<true>(soa.Self(), c, 1, c->GetComponentSize(),
...
TEST_F(ObjectTest, CreateMultiArray) {
  ...
  Handle<Class> c(soa.Self(), class_linker_->FindSystemClass(soa.Self(), "I"));
  Handle<IntArray> dims(soa.Self(), IntArray::Alloc(soa.Self(), 1));
  dims->Set<false>(0, 1);
...
TEST_F(ObjectTest, StaticFieldFromCode) {
  ...
  Handle<mirror::ClassLoader> loader(soa.Self(), soa.Decode<ClassLoader*>(class_loader));
  ...
  Handle<CharArray> char_array(soa.Self(), CharArray::Alloc(soa.Self(), 0));
...
TEST_F(ObjectTest, StringEqualsUtf8) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<String> string(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "android"));
  ...
  Handle<String> empty(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), ""));
...
TEST_F(ObjectTest, StringEquals) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<String> string(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "android"));
  Handle<String> string_2(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "android"));
...
TEST_F(ObjectTest, StringCompareTo) {
  ...
  Handle<String> string(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "android"));
  Handle<String> string_2(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "android"));
  Handle<String> string_3(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "Android"));
  Handle<String> string_4(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "and"));
  Handle<String> string_5(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), ""));
...
TEST_F(ObjectTest, DescriptorCompare) {
  ...
  Handle<ClassLoader> class_loader_1(soa.Self(), soa.Decode<ClassLoader*>(jclass_loader_1));
  Handle<ClassLoader> class_loader_2(soa.Self(), soa.Decode<ClassLoader*>(jclass_loader_2));
...
TEST_F(ObjectTest, StringHashCode) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<String> empty(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), ""));
  Handle<String> A(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "A"));
  Handle<String> ABC(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "ABC"));
...
TEST_F(ObjectTest, InstanceOf) {
  ...
  Handle<ClassLoader> class_loader(soa.Self(), soa.Decode<ClassLoader*>(jclass_loader));
  ...
  Handle<Object> x(soa.Self(), X->AllocObject(soa.Self()));
  Handle<Object> y(soa.Self(), Y->AllocObject(soa.Self()));
...
TEST_F(ObjectTest, FindInstanceField) {
  ScopedObjectAccess soa(Thread::Current());
  Handle<String> s(soa.Self(), String::AllocFromModifiedUtf8(soa.Self(), "ABC"));
