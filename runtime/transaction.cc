...
void Transaction::ObjectLog::UndoFieldWrite(mirror::Object* obj, MemberOffset field_offset,
  ...
  // TODO We may want to abort a transaction while still being in transaction mode. In this case, we'd
...
void Transaction::ArrayLog::UndoArrayWrite(mirror::Array* array, Primitive::Type array_type,
  ...
  switch (array_type) {
    ...
    case Primitive::kPrimFloat: {
      ...
      float_array->SetWithoutChecks<false>(index, static_cast<float>(value));
      break;
    }
    ...
    case Primitive::kPrimDouble: {
      ...
      double_array->SetWithoutChecks<false>(index, static_cast<double>(value));
      break;
    }
