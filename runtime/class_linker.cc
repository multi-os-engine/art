...
mirror::Class* ClassLinker::FindClass(Thread* self, const char* descriptor,
  ...
  if (descriptor[0] == '[') {
    ...
    if (FindClassInPathClassLoader(soa, self, descriptor, hash, class_loader, &cp_klass)) {
      ...
      //       and the branch above. The current issue is to throw the right exception, i.e.,
      //       whether to throw the result of DefineClass or a pre-allocated NoClassDefFoundError.
