...
bool ClassLinker::FindOatClass(const DexFile& dex_file,
  ...
  if (oat_file == nullptr) return false;
...
bool ClassLinker::FindOatMethodFor(mirror::ArtMethod* method, OatFile::OatMethod* oat_method) {
  ...
  OatFile::OatClass oat_class;
  bool found = FindOatClass(*declaring_class->GetDexCache()->GetDexFile(),
...
void ClassLinker::FixupStaticTrampolines(mirror::Class* klass) {
  ...
  OatFile::OatClass oat_class;
  bool has_oat_file = FindOatClass(dex_file, klass->GetDexClassDefIndex(), &oat_class);
...
void ClassLinker::LoadClass(const DexFile& dex_file,
  ...
  OatFile::OatClass oat_class;
  if (FindOatClass(dex_file, klass->GetDexClassDefIndex(), &oat_class)
