...
mirror::Class* ClassLinker::CreateArrayClass(Thread* self, const char* descriptor, size_t hash,
  ...
  ImTable* object_imt = GetClassRoot(kJavaLangObject)->GetImt(image_pointer_size_);
...
ImTable* FindSuperImt(mirror::Class* klass, size_t pointer_size) SHARED_REQUIRES(Locks::mutator_lock_) {
