...
void ClassLinker::InitFromCompiler(const std::vector<const DexFile*>& boot_class_path) {
  ...
  java_lang_Class->SetClassSize(SizeWithVTableLength(
      sizeof(mirror::ClassClass), mirror::Class::kVTableLength));
  ...
  Handle<mirror::Class> class_array_class(hs.NewHandle(
     AllocClass(self, java_lang_Class.Get(),
                SizeWithVTableLength(sizeof(mirror::Class), mirror::Object::kVTableLength))));
  ...
  Handle<mirror::Class> java_lang_String(hs.NewHandle(
      AllocClass(self, java_lang_Class.Get(),
                 SizeWithVTableLength(sizeof(mirror::StringClass), mirror::String::kVTableLength))));
  mirror::String::SetClass(java_lang_String.Get());
  java_lang_String->SetObjectSize(sizeof(mirror::String));
  CHECK_EQ(java_lang_String->SFieldsOffset().Uint32Value(), 0U);
  java_lang_String->SetSFieldsStart(
      sizeof(mirror::Class) + SizeOfImtAndVTable(mirror::String::kVTableLength, true));
  ...
  Handle<mirror::Class> java_lang_DexCache(hs.NewHandle(
      AllocClass(self, java_lang_Class.Get(),
                 SizeWithVTableLength(sizeof(mirror::DexCacheClass),
                                      mirror::DexCache::kVTableLength))));
  SetClassRoot(kJavaLangDexCache, java_lang_DexCache.Get());
  java_lang_DexCache->SetObjectSize(sizeof(mirror::DexCache));
  CHECK_EQ(java_lang_DexCache->SFieldsOffset().Uint32Value(), 0U);
  java_lang_DexCache->SetSFieldsStart(
      sizeof(mirror::Class) + SizeOfImtAndVTable(mirror::DexCache::kVTableLength, false));
  ...
  CHECK_EQ(java_lang_reflect_ArtField->SFieldsOffset().Uint32Value(), 0U);
  java_lang_reflect_ArtField->SetSFieldsStart(
      sizeof(mirror::Class) + SizeOfImtAndVTable(mirror::ArtField::kVTableLength, false));
  ...
  Handle<mirror::Class> java_lang_reflect_ArtMethod(hs.NewHandle(
    AllocClass(self, java_lang_Class.Get(),
               SizeWithVTableLength(sizeof(mirror::ArtMethodClass),
                                    mirror::ArtMethod::kVTableLength))));
  ...
  CHECK_EQ(java_lang_reflect_ArtMethod->SFieldsOffset().Uint32Value(), 0U);
  java_lang_reflect_ArtMethod->SetSFieldsStart(
      sizeof(mirror::Class) + SizeOfImtAndVTable(mirror::ArtMethod::kVTableLength, false));
...
mirror::Class* ClassLinker::InitializePrimitiveClass(mirror::Class* primitive_class,
  ...
  CHECK_EQ(primitive_class->SFieldsOffset().Uint32Value(), 0U);
  primitive_class->SetSFieldsStart(
      sizeof(mirror::Class) + SizeOfImtAndVTable(mirror::Object::kVTableLength, false));
...
mirror::Class* ClassLinker::CreateArrayClass(Thread* self, const char* descriptor,
  ...
  CHECK_EQ(new_class->SFieldsOffset().Uint32Value(), 0U);
  new_class->SetSFieldsStart(
      sizeof(mirror::Class) + SizeOfImtAndVTable(mirror::Object::kVTableLength, false));
...
mirror::Class* ClassLinker::UpdateClass(const char* descriptor, mirror::Class* klass,
  ...
  CHECK(klass->IsResolving()) << descriptor;
...
bool ClassLinker::LinkClass(Thread* self, const char* descriptor, Handle<mirror::Class> klass,
  ...
  CHECK_NE(klass->SFieldsOffset().Uint32Value(), 0U);
  ...
  *new_class = klass->CopyOf(self, class_size);
  ...
  // This will notify waiters on temp class that saw the not yet resolved
  // class in the class_table_ during EnsureResolved.
  CHECK_NE(klass->SFieldsOffset().Uint32Value(), 0U);
  klass->SetRetired(self);

  DCHECK(new_class_h->IsResolving());
  // This will notify waiters on new_class that saw the not yet resolved
  // class in the class_table_ during EnsureResolved.
  CHECK_NE(new_class_h->SFieldsOffset().Uint32Value(), 0U);
...
bool ClassLinker::LinkFields(Handle<mirror::Class> klass, bool is_static, size_t* class_size) {
  ...
  if (is_static) {
    ...
    // Place static fields after imt and vtable.
