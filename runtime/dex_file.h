...
class DexFile {
 public:
  ...
  struct CodeItem {
    ...
    uint16_t ins_size_;  // the number of words of incoming arguments to the method that this code
                         // is for
    uint16_t outs_size_;  // the number of words of outgoing argument space required by this code
                          // for method invocation
    uint16_t tries_size_;  // the number of try_items for this instance. If non-zero, then these
