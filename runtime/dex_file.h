...
class DexFile {
 public:
  ...
  mirror::Object* GetAnnotationForField(ArtField* field, Handle<mirror::Class> annotation_class) const
      SHARED_REQUIRES(Locks::mutator_lock_);
  ...
  mirror::Object* GetAnnotationDefaultValue(ArtMethod* method) const
      SHARED_REQUIRES(Locks::mutator_lock_);
  mirror::Object* GetAnnotationForMethod(ArtMethod* method, Handle<mirror::Class> annotation_class) const
      SHARED_REQUIRES(Locks::mutator_lock_);
  ...
  const AnnotationSetItem* FindAnnotationSetForClass(Handle<mirror::Class> klass) const
      SHARED_REQUIRES(Locks::mutator_lock_);
  mirror::Object* GetAnnotationForClass(Handle<mirror::Class> klass, Handle<mirror::Class> annotation_class) const
      SHARED_REQUIRES(Locks::mutator_lock_);
  mirror::ObjectArray<mirror::Object>* GetAnnotationsForClass(Handle<mirror::Class> klass) const
      SHARED_REQUIRES(Locks::mutator_lock_);
  bool IsClassAnnotationPresent(Handle<mirror::Class> klass, Handle<mirror::Class> annotation_class) const
      SHARED_REQUIRES(Locks::mutator_lock_);
