...
class ArtMethod FINAL {
 public:
  ...
  // Returns true and throws an error if invoking the method would cause an error. Else returns
  // false.
  bool ThrowInvokationTimeError() SHARED_REQUIRES(Locks::mutator_lock_);
