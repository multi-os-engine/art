...
class ArtMethod FINAL {
 ...
 protected:
  ...
  // values denote special state.  Volatile not needed for correctness, but added in hope of
  // reducing the number of cases in which concurrent updates put us into an unusual state.
