...
class ArtMethod FINAL {
 public:
  ...
  // Update heap objects and non-entrypoint pointers by the passed in visitor. The reason for
  // updating non-entrypoint pointers for image relocation. Does not use read barrier.
