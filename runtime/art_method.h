...
class ArtMethod FINAL {
 public:
  ...
  // A default conflict method is a special sentinal method that stands for a conflict between
  ...
  inline bool IsOverridableByDefaultMethod() SHARED_REQUIRES(Locks::mutator_lock_);
