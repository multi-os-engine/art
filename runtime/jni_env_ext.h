...
struct JNIEnvExt : public JNIEnv {
  ...
  void CheckMonitorsReleased() SHARED_REQUIRES(Locks::mutator_lock_) {
    if (UNLIKELY(check_jni)) {
      CheckMonitorsReleasedImpl();
    }
  }
 ...
 private:
  ...
  void CheckMonitorsReleasedImpl() SHARED_REQUIRES(Locks::mutator_lock_);
