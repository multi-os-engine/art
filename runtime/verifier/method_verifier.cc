...
std::ostream& MethodVerifier::Fail(VerifyError error) {
  ...
  switch (error) {
    ...
    case VERIFY_ERROR_CLASS_CHANGE:
      ...
      // Runtime case for the above errors:
      ...
      //
      // Also general case for lock issues (and force-interpreter). These won't change, as class
      // resolution etc. does not impact lock verification. We want to punt this to the interpreter,
      // and do this by handling it like the runtime case for the above errors, marking the a
      // pending runtime throw. The compilers will not generate code for this case.
