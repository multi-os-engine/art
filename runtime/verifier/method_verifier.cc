...
bool MethodVerifier::CodeFlowVerifyMethod() {
  ...
  // As they may be unreachable, which would mean they are not touched above, but the compiler
  // would touch them, we have to explicitly iterate over all instructions.
