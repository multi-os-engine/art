...
MethodVerifier::FailureKind MethodVerifier::VerifyClass(mirror::Class* klass,
  ...
  Handle<mirror::DexCache> dex_cache(self, kh.GetDexCache());
  Handle<mirror::ClassLoader> class_loader(self, klass->GetClassLoader());
...
void MethodVerifier::FindLocksAtDexPc(mirror::ArtMethod* m, uint32_t dex_pc,
  ...
  MethodHelper mh(m);
  Thread* self = Thread::Current();
  Handle<mirror::DexCache> dex_cache(self, mh.GetDexCache());
  Handle<mirror::ClassLoader> class_loader(self, mh.GetClassLoader());
