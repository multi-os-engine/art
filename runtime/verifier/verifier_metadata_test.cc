...
TEST_F(VerifierMetadataTest, InvokeVirtual_Resolved_DeclaredInSuperinterface) {
  ...
  ASSERT_TRUE(HasDependency("virtual method Ljava/lang/Thread;->size()I unresolved"));
  ASSERT_TRUE(HasDependency("virtual method Ljava/util/Set;->size()I resolved to Ljava/util/Set;"));
}
