...
class PcToRegisterLineTable {
 ...
 private:
  // Owned, but not unique_ptr since register_lines_ are allocated in arenas.
  ScopedArenaVector<DestroyOnlyUniquePtr<RegisterLine>> register_lines_;
...
class MethodVerifier {
  ...
  */
  ...
  DestroyOnlyUniquePtr<RegisterLine> work_line_;
  ...
  DestroyOnlyUniquePtr<RegisterLine> saved_line_;
