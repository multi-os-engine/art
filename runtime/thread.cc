  ...
  while (true) {
    ...
    Closure* checkpoint;
    {
      ...
      if (tlsPtr_.checkpoint_function != nullptr) {
        ...
        // Updating tlsPtr_.checkpoint_function is not necessary but done to make it FIFO and
        // prevent any possible starvation.
      ...
      } else if (!checkpoint_overflow_.empty()) {
        checkpoint = checkpoint_overflow_.front();
        checkpoint_overflow_.pop_front();
      } else {
        // No more checkpoints.
