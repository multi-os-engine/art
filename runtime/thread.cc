...
struct StackDumpVisitor : public StackVisitor {
  ...
  static void DumpLockedObject(mirror::Object* o, void* context)
    ...
    if (o == nullptr) {
      ...
      if ((ls == LockWord::kBiasLocked || ls == LockWord::kThinLocked) &&
...
bool Thread::HoldsLock(mirror::Object* object) const {
  ...
  if (lw.GetState() != LockWord::kBiasLocked) {
    return object->GetLockOwnerThreadId() == GetThreadId();
  } else {
    return object->GetLockOwnerThreadId() == GetThreadId() && !lw.IsBiasLockUnlocked();
  }
}
