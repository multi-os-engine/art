...
void Thread::ActivateSingleStepControl(SingleStepControl* ssc) {
  DCHECK(Dbg::IsDebuggerActive());
  DCHECK(GetSingleStepControl() == nullptr) << "Single step already active in thread " << *this;
  DCHECK(ssc != nullptr);
...
void Thread::DeactivateSingleStepControl() {
  DCHECK(Dbg::IsDebuggerActive());
  DCHECK(GetSingleStepControl() != nullptr) << "Single step not active in thread " << *this;
