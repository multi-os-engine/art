...
class Mips64InstructionSetFeatures FINAL : public InstructionSetFeatures {
 public:
  ...
  bool IsMips64IsaRevGreaterThanEqual2() const {
    return mips64_isa_gte2_;
  }
 ...
 private:
  Mips64InstructionSetFeatures(bool smp, bool fpu_32bit, bool mips64_isa_gte2, bool r6)
      : InstructionSetFeatures(smp), fpu_32bit_(fpu_32bit),  mips64_isa_gte2_(mips64_isa_gte2),
        r6_(r6) {
  }
