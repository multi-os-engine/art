...
#ifndef ART_RUNTIME_ARCH_ARM64_METHOD_FRAME_INFO_ARM64_H_
#define ART_RUNTIME_ARCH_ARM64_METHOD_FRAME_INFO_ARM64_H_
...
constexpr MethodFrameInfo Arm64CalleeSaveMethodFrameInfo(Runtime::CalleeSaveType type) {
  return MethodFrameInfo(Arm64CalleeSaveFrameSize(type),
...
#endif  // ART_RUNTIME_ARCH_ARM64_METHOD_FRAME_INFO_ARM64_H_
