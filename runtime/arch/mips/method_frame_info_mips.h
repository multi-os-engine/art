...
#ifndef ART_RUNTIME_ARCH_MIPS_METHOD_FRAME_INFO_MIPS_H_
#define ART_RUNTIME_ARCH_MIPS_METHOD_FRAME_INFO_MIPS_H_
...
constexpr MethodFrameInfo MipsCalleeSaveMethodFrameInfo(Runtime::CalleeSaveType type) {
  return MethodFrameInfo(MipsCalleeSaveFrameSize(type),
                         MipsCalleeSaveCoreSpills(type),
                         0u);
}

MethodFrameInfo MipsJniMethodFrameInfo(bool is_static, const char* shorty);

}  // namespace mips
}  // namespace art

#endif  // ART_RUNTIME_ARCH_MIPS_METHOD_FRAME_INFO_MIPS_H_
