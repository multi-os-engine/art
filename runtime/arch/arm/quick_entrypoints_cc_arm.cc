...
// Note: The ABI definition must match with trampoline, JNI and quick code.
// SoftFp setting in quick_trampoline_entrypoints.cc:
//   kQuickSoftFloatAbi = true
//   kQuickDoubleRegistersAligned = false
//   kNumQuickGprArgs = 3
//   kNumQuickFprArgs = 0
// HardFp setting in quick_trampoline_entrypoints.cc:
//   kQuickSoftFloatAbi = false
//   kQuickDoubleRegistersAligned = true
//   kNumQuickGprArgs = 3
//   kNumQuickFprArgs = 0
