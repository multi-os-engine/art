...
#ifndef ART_RUNTIME_ARCH_ARM_METHOD_FRAME_INFO_ARM_H_
#define ART_RUNTIME_ARCH_ARM_METHOD_FRAME_INFO_ARM_H_
...
constexpr MethodFrameInfo ArmCalleeSaveMethodFrameInfo(Runtime::CalleeSaveType type) {
  return MethodFrameInfo(ArmCalleeSaveFrameSize(type),
...
#endif  // ART_RUNTIME_ARCH_ARM_METHOD_FRAME_INFO_ARM_H_
