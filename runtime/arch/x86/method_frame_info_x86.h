...
#ifndef ART_RUNTIME_ARCH_X86_METHOD_FRAME_INFO_X86_H_
#define ART_RUNTIME_ARCH_X86_METHOD_FRAME_INFO_X86_H_
...
constexpr MethodFrameInfo X86CalleeSaveMethodFrameInfo(Runtime::CalleeSaveType type) {
  return MethodFrameInfo(X86CalleeSaveFrameSize(type),
                         X86CalleeSaveCoreSpills(type),
                         0u);
}

MethodFrameInfo X86JniMethodFrameInfo(bool is_static, const char* shorty);

}  // namespace x86
}  // namespace art

#endif  // ART_RUNTIME_ARCH_X86_METHOD_FRAME_INFO_X86_H_
