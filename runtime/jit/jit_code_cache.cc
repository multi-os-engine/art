...
JitCodeCache::JitCodeCache(MemMap* code_map,
  ...
  mspace_set_footprint_limit(code_mspace_, code_end_);
  mspace_set_footprint_limit(data_mspace_, data_end_);
...
bool JitCodeCache::IncreaseCodeCacheCapacity() {
  ...
  mspace_set_footprint_limit(data_mspace_, current_capacity_ / 2);
  {
    ScopedCodeCacheWrite scc(code_map_.get());
    mspace_set_footprint_limit(code_mspace_, current_capacity_ / 2);
  }
