...
ProfileSaver::ProfileSaver(const std::string& output_filename,
  ...
  TrackLocations(output_filename, code_paths);
}
...
void ProfileSaver::Start(const std::string& output_filename,
  ...
  if (instance_ != nullptr) {
    ...
    // Add the code_paths to the tracked data.
    instance_->TrackLocations(output_filename, code_paths);
    return;
  }
...
void ProfileSaver::TrackLocations(const std::string& output_filename,
                                  const std::vector<std::string>& code_paths) {
