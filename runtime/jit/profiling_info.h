...
class ProfilingInfo {
 public:
  ...
  bool AllocatedDuringGC() const {
    return allocated_during_gc_;
  }

  void SetAllocatedDuringGC(bool value) {
    allocated_during_gc_ = value;
  }
 ...
 private:
  ...
  bool is_method_being_compiled_ = false;

  // Whether the profile info was allocated during a code cache GC. This flag is cleared by the GC.
  bool allocated_during_gc_ = false;
