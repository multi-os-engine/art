...
class OfflineProfilingInfo {
 ...
 private:
  ...
  using ProfilingInfo = SafeMap<DexLocationKey, std::set<uint32_t>, DexLocationKeyComparator>;

  void AddMethodInfo(ArtMethod* method, /*out*/ ProfilingInfo& info)
      SHARED_REQUIRES(Locks::mutator_lock_);
  bool Serialize(const std::string& filename, const ProfilingInfo& info) const;
