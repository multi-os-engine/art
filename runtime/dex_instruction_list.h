...
#define DEX_INSTRUCTION_LIST(V) \
  ...
  V(0xE3, IGET_QUICK, "iget-quick", k22c, true, kFieldRef, kContinue | kThrow | kLoad | kVCIsConst, kVerifyRegA | kVerifyRegB) \
  V(0xE4, IGET_WIDE_QUICK, "iget-wide-quick", k22c, true, kFieldRef, kContinue | kThrow | kLoad | kVCIsConst, kVerifyRegAWide | kVerifyRegB) \
  V(0xE5, IGET_OBJECT_QUICK, "iget-object-quick", k22c, true, kFieldRef, kContinue | kThrow | kLoad | kVCIsConst, kVerifyRegA | kVerifyRegB) \
  V(0xE6, IPUT_QUICK, "iput-quick", k22c, false, kFieldRef, kContinue | kThrow | kStore | kVCIsConst, kVerifyRegA | kVerifyRegB) \
  V(0xE7, IPUT_WIDE_QUICK, "iput-wide-quick", k22c, false, kFieldRef, kContinue | kThrow | kStore | kVCIsConst, kVerifyRegAWide | kVerifyRegB) \
  V(0xE8, IPUT_OBJECT_QUICK, "iput-object-quick", k22c, false, kFieldRef, kContinue | kThrow | kStore | kVCIsConst, kVerifyRegA | kVerifyRegB) \
