...
#define DEX_INSTRUCTION_LIST(V) \
  ...
  V(0xF3, INVOKE_LAMBDA, "invoke-lambda", k25x, false, kNone, kContinue | kThrow | kInvoke, kVerifyRegC /*TODO: | kVerifyVarArg*/) \
  ...
  V(0xF6, CREATE_LAMBDA, "create-lambda", k21c, false_UNUSED, kMethodRef, kContinue | kThrow, kVerifyRegA | kVerifyRegBMethod) \
