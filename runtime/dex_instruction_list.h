...
#define DEX_INSTRUCTION_LIST(V) \
  ...
  V(0x1F, CHECK_CAST, "check-cast", k21c, true, kTypeRef, kContinue | kThrow | kRegBFieldOrConstant, kVerifyRegA | kVerifyRegBType) \
  V(0x20, INSTANCE_OF, "instance-of", k22c, true, kTypeRef, kContinue | kThrow | kRegCFieldOrConstant, kVerifyRegA | kVerifyRegB | kVerifyRegCType) \
  V(0x21, ARRAY_LENGTH, "array-length", k12x, true, kNone, kContinue | kThrow | kRegBFieldOrConstant, kVerifyRegA | kVerifyRegB) \
  V(0x22, NEW_INSTANCE, "new-instance", k21c, true, kTypeRef, kContinue | kThrow | kClobber | kRegAFieldOrConstant | kRegBFieldOrConstant, kVerifyRegA | kVerifyRegBNewInstance) \
  V(0x23, NEW_ARRAY, "new-array", k22c, true, kTypeRef, kContinue | kThrow | kClobber | kRegAFieldOrConstant | kRegBFieldOrConstant, kVerifyRegA | kVerifyRegB | kVerifyRegCNewArray) \
  V(0x24, FILLED_NEW_ARRAY, "filled-new-array", k35c, false, kTypeRef, kContinue | kThrow | kClobber | kRegAFieldOrConstant | kRegBFieldOrConstant, kVerifyRegBType | kVerifyVarArg) \
  ...
  V(0x28, GOTO, "goto", k10t, false, kNone, kBranch | kUnconditional | kRegAFieldOrConstant, kVerifyBranchTarget) \
  V(0x29, GOTO_16, "goto/16", k20t, false, kNone, kBranch | kUnconditional | kRegAFieldOrConstant, kVerifyBranchTarget) \
  V(0x2A, GOTO_32, "goto/32", k30t, false, kNone, kBranch | kUnconditional | kRegAFieldOrConstant, kVerifyBranchTarget) \
  V(0x2B, PACKED_SWITCH, "packed-switch", k31t, false, kNone, kContinue | kSwitch | kRegBFieldOrConstant, kVerifyRegA | kVerifySwitchTargets) \
  V(0x2C, SPARSE_SWITCH, "sparse-switch", k31t, false, kNone, kContinue | kSwitch | kRegBFieldOrConstant, kVerifyRegA | kVerifySwitchTargets) \
  ...
  V(0x32, IF_EQ, "if-eq", k22t, false, kNone, kContinue | kBranch | kRegCFieldOrConstant, kVerifyRegA | kVerifyRegB | kVerifyBranchTarget) \
  V(0x33, IF_NE, "if-ne", k22t, false, kNone, kContinue | kBranch | kRegCFieldOrConstant, kVerifyRegA | kVerifyRegB | kVerifyBranchTarget) \
  V(0x34, IF_LT, "if-lt", k22t, false, kNone, kContinue | kBranch | kRegCFieldOrConstant, kVerifyRegA | kVerifyRegB | kVerifyBranchTarget) \
  V(0x35, IF_GE, "if-ge", k22t, false, kNone, kContinue | kBranch | kRegCFieldOrConstant, kVerifyRegA | kVerifyRegB | kVerifyBranchTarget) \
  V(0x36, IF_GT, "if-gt", k22t, false, kNone, kContinue | kBranch | kRegCFieldOrConstant, kVerifyRegA | kVerifyRegB | kVerifyBranchTarget) \
  V(0x37, IF_LE, "if-le", k22t, false, kNone, kContinue | kBranch | kRegCFieldOrConstant, kVerifyRegA | kVerifyRegB | kVerifyBranchTarget) \
  V(0x38, IF_EQZ, "if-eqz", k21t, false, kNone, kContinue | kBranch | kRegBFieldOrConstant, kVerifyRegA | kVerifyBranchTarget) \
  V(0x39, IF_NEZ, "if-nez", k21t, false, kNone, kContinue | kBranch | kRegBFieldOrConstant, kVerifyRegA | kVerifyBranchTarget) \
  V(0x3A, IF_LTZ, "if-ltz", k21t, false, kNone, kContinue | kBranch | kRegBFieldOrConstant, kVerifyRegA | kVerifyBranchTarget) \
  V(0x3B, IF_GEZ, "if-gez", k21t, false, kNone, kContinue | kBranch | kRegBFieldOrConstant, kVerifyRegA | kVerifyBranchTarget) \
  V(0x3C, IF_GTZ, "if-gtz", k21t, false, kNone, kContinue | kBranch | kRegBFieldOrConstant, kVerifyRegA | kVerifyBranchTarget) \
  V(0x3D, IF_LEZ, "if-lez", k21t, false, kNone, kContinue | kBranch | kRegBFieldOrConstant, kVerifyRegA | kVerifyBranchTarget) \
  ...
  V(0x5B, IPUT_OBJECT, "iput-object", k22c, false, kFieldRef, kContinue | kThrow | kStore | kRegCFieldOrConst , kVerifyRegA | kVerifyRegB | kVerifyRegCField) \
