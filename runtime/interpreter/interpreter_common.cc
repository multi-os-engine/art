...
static void UnstartedRuntimeFindClass(Thread* self, mirror::String* className,
                                      mirror::ClassLoader* class_loader, JValue* result,
  ...
  Class* found = class_linker->FindClass(self, descriptor.c_str(), h_class_loader);
  if (abort_if_not_found) {
    CHECK(found != NULL) << method_name << " failed in un-started runtime for class: "
...
static void UnstartedRuntimeInvoke(Thread* self, MethodHelper& mh,
  ...
  if (name == "java.lang.Class java.lang.Class.forName(java.lang.String)") {
    ...
    UnstartedRuntimeFindClass(self, class_name, nullptr, result, name, true, true);
  } else if (name == "java.lang.Class java.lang.VMClassLoader.loadClass(java.lang.String, boolean)") {
    mirror::String* class_name = shadow_frame->GetVRegReference(arg_offset)->AsString();
    UnstartedRuntimeFindClass(self, class_name, nullptr, result, name, false, true);
  } else if (name == "java.lang.Class java.lang.VMClassLoader.findLoadedClass(java.lang.ClassLoader, java.lang.String)") {
    mirror::ClassLoader* class_loader = down_cast<mirror::ClassLoader*>(shadow_frame->GetVRegReference(arg_offset));
    mirror::String* class_name = shadow_frame->GetVRegReference(arg_offset + 1)->AsString();
    UnstartedRuntimeFindClass(self, class_name, class_loader, result, name, false, false);
