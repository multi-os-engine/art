...
static void UnstartedMemoryPeekEntry(Thread* self ATTRIBUTE_UNUSED, ShadowFrame* shadow_frame,
                                     JValue* result, size_t arg_offset)
    SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
...
static void UnstartedMemoryPeekArrayEntry(Thread* self, ShadowFrame* shadow_frame,
                                          JValue* result ATTRIBUTE_UNUSED, size_t arg_offset)
    SHARED_LOCKS_REQUIRED(Locks::mutator_lock_) {
  std::string name(PrettyMethod(shadow_frame->GetMethod()));
