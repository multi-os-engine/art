...
static std::map<std::string, InvokeHandler> invoke_handlers_;
static std::map<std::string, JNIHandler> jni_handlers_;

static void UnstartedRuntimeInitializeInvokeHandlers() {
  invoke_handlers_.insert(
      std::make_pair("java.lang.Class java.lang.Class.forName(java.lang.String)",
                     &UnstartedClassForName));
  invoke_handlers_.insert(
        std::make_pair("java.lang.Class java.lang.Class.forName(java.lang.String, boolean, java.lang.ClassLoader)",
                       &UnstartedClassForNameLong));
  invoke_handlers_.insert(
        std::make_pair("java.lang.Class java.lang.Class.classForName(java.lang.String, boolean, java.lang.ClassLoader)",
                       &UnstartedClassClassForName));
  invoke_handlers_.insert(
      std::make_pair("java.lang.Class java.lang.VMClassLoader.findLoadedClass(java.lang.ClassLoader, java.lang.String)",
                     &UnstartedVmClassLoaderFindLoadedClass));
  invoke_handlers_.insert(
      std::make_pair("java.lang.Class java.lang.Void.lookupType()", &UnstartedVoidLookupType));
  invoke_handlers_.insert(
      std::make_pair("java.lang.Object java.lang.Class.newInstance()", &UnstartedClassNewInstance));
  invoke_handlers_.insert(
      std::make_pair("java.lang.reflect.Field java.lang.Class.getDeclaredField(java.lang.String)",
                     &UnstartedClassGetDeclaredField));
  invoke_handlers_.insert(
      std::make_pair("int java.lang.Object.hashCode()", &UnstartedObjectHashCode));
  invoke_handlers_.insert(
      std::make_pair("java.lang.String java.lang.reflect.ArtMethod.getMethodName(java.lang.reflect.ArtMethod)",
                     &UnstartedArtMethodGetMethodName));
  invoke_handlers_.insert(
      std::make_pair("void java.lang.System.arraycopy(java.lang.Object, int, java.lang.Object, int, int)",
                     &UnstartedSystemArraycopy));
  invoke_handlers_.insert(
      std::make_pair("void java.lang.System.arraycopy(char[], int, char[], int, int)",
                     &UnstartedSystemArraycopy));
  invoke_handlers_.insert(
      std::make_pair("void java.lang.System.arraycopy(int[], int, int[], int, int)",
                     &UnstartedSystemArraycopy));
  invoke_handlers_.insert(
      std::make_pair("long java.lang.Double.doubleToRawLongBits(double)",
                     &UnstartedDoubleDoubleToRawLongBits));
  invoke_handlers_.insert(
      std::make_pair("double java.lang.Math.ceil(double)", &UnstartedMathCeil));
  invoke_handlers_.insert(
      std::make_pair("java.lang.Object java.lang.ThreadLocal.get()", &UnstartedThreadLocalGet));
}
...
void UnstartedRuntimeJni(Thread* self, mirror::ArtMethod* method, mirror::Object* receiver,
  ...
  if (name == "java.lang.Object dalvik.system.VMRuntime.newUnpaddedArray(java.lang.Class, int)") {
    UnstartedJNIVMRuntimeNewUnpaddedArray(self, method, receiver, args, result);
  } else if (name == "java.lang.ClassLoader dalvik.system.VMStack.getCallingClassLoader()") {
    UnstartedJNIVMStackGetCallingClassLoader(self, method, receiver, args, result);
  } else if (name == "java.lang.Class dalvik.system.VMStack.getStackClass2()") {
    UnstartedJNIVMStackgetStackClass2(self, method, receiver, args, result);
  } else if (name == "double java.lang.Math.log(double)") {
    UnstartedJNIMathLog(self, method, receiver, args, result);
  } else if (name == "java.lang.String java.lang.Class.getNameNative()") {
    UnstartedJNIClassGetNameNative(self, method, receiver, args, result);
  } else if (name == "int java.lang.Float.floatToRawIntBits(float)") {
    UnstartedJNIFloatFloatToRawIntBits(self, method, receiver, args, result);
  } else if (name == "float java.lang.Float.intBitsToFloat(int)") {
    UnstartedJNIFloatIntBitsToFloat(self, method, receiver, args, result);
  } else if (name == "double java.lang.Math.exp(double)") {
    UnstartedJNIMathExp(self, method, receiver, args, result);
  } else if (name == "java.lang.Object java.lang.Object.internalClone()") {
    UnstartedJNIObjectInternalClone(self, method, receiver, args, result);
  } else if (name == "void java.lang.Object.notifyAll()") {
    UnstartedJNIObjectNotifyAll(self, method, receiver, args, result);
  } else if (name == "int java.lang.String.compareTo(java.lang.String)") {
    UnstartedJNIStringCompareTo(self, method, receiver, args, result);
  } else if (name == "java.lang.String java.lang.String.intern()") {
    UnstartedJNIStringIntern(self, method, receiver, args, result);
  } else if (name == "int java.lang.String.fastIndexOf(int, int)") {
    UnstartedJNIStringFastIndexOf(self, method, receiver, args, result);
  } else if (name == "java.lang.Object java.lang.reflect.Array.createMultiArray(java.lang.Class, int[])") {
    UnstartedJNIArrayCreateMultiArray(self, method, receiver, args, result);
  } else if (name == "java.lang.Object java.lang.Throwable.nativeFillInStackTrace()") {
    UnstartedJNIThrowableNativeFillInStackTrace(self, method, receiver, args, result);
  } else if (name == "int java.lang.System.identityHashCode(java.lang.Object)") {
    UnstartedJNISystemIdentityHashCode(self, method, receiver, args, result);
  } else if (name == "boolean java.nio.ByteOrder.isLittleEndian()") {
    UnstartedJNIByteOrderIsLittleEndian(self, method, receiver, args, result);
