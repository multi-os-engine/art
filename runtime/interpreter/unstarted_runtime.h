...
// image.
//
// While it would technically OK to only expose the public functions, a class was chose to wrap
// this so the actual implementations are exposed for testing. This is also why the private
