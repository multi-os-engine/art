...
return_type MterpGetStatic(uint32_t field_idx, ArtMethod* referrer, Thread* self,
                           return_type (ArtField::*func)(mirror::Object*))
    SHARED_REQUIRES(Locks::mutator_lock_) {
...
extern "C" mirror::Object* MterpGetObjStatic(uint32_t field_idx, ArtMethod* referrer, Thread* self)
    SHARED_REQUIRES(Locks::mutator_lock_) {
    return MterpGetStatic<mirror::Object*, Primitive::kPrimNot>(field_idx,
                                                                referrer,
                                                                self,
                                                                &ArtField::GetObject);
}

extern "C" int32_t MterpGet32Static(uint32_t field_idx, ArtMethod* referrer, Thread* self)
    SHARED_REQUIRES(Locks::mutator_lock_) {
...
template <typename field_type, Primitive::Type primitive_type>
  int MterpSetStatic(uint32_t field_idx,
                     ...
                     ArtMethod* referrer,
                     Thread* self,
                     void (ArtField::*func)(mirror::Object*, field_type val))
    SHARED_REQUIRES(Locks::mutator_lock_) {
...
extern "C" int MterpSetShortStatic(uint32_t field_idx,
                                   ...
                                   Thread* self)
    SHARED_REQUIRES(Locks::mutator_lock_) {
  return MterpSetStatic<int16_t, Primitive::kPrimChar>(field_idx,
                                                       new_value,
                                                       referrer,
                                                       self,
