...
// Poison value for TextExportPC.  If we segfault with this value, it means that a mterp
...
static inline bool TestExportPC() {
  // Return true to enable poison testing of ExportPC.  Uses Alt interpreter.
  return false;
}
