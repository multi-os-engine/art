...
static void GenerateOatForTest(const char* dex_location) {
  OatFileAssistant oat_file_assistant(dex_location, kRuntimeISA);
...
TEST_F(OatFileAssistantTest, DexNoOat) {
  ...
  OatFileAssistant oat_file_assistant(dex_location.c_str(), kRuntimeISA);
...
TEST_F(OatFileAssistantTest, NoDexNoOat) {
  ...
  ExecutableOatFileAssistant oat_file_assistant(dex_location.c_str());
...
TEST_F(OatFileAssistantTest, MultiDexOatUpToDate) {
  ...
  ExecutableOatFileAssistant executable_oat_file_assistant(dex_location.c_str());
...
TEST_F(OatFileAssistantTest, LoadDexNoAlternateOat) {
  ...
  ExecutableOatFileAssistant oat_file_assistant(dex_location.c_str(), oat_location.c_str());
  std::string error_msg;
  ASSERT_TRUE(oat_file_assistant.MakeUpToDate(&error_msg)) << error_msg;
  ...
  OatFileAssistant ofm(dex_location.c_str(), kRuntimeISA);
