...
TEST_F(OatFileAssistantTest, DexOptStatusValues) {
  ...
  mirror::ArtField* no_dexopt_needed = mirror::Class::FindStaticField(soa.Self(), dexfile, "NO_DEXOPT_NEEDED", "I");
  ...
  mirror::ArtField* dex2oat_needed = mirror::Class::FindStaticField(soa.Self(), dexfile, "DEX2OAT_NEEDED", "I");
  ...
  mirror::ArtField* patchoat_needed = mirror::Class::FindStaticField(soa.Self(), dexfile, "PATCHOAT_NEEDED", "I");
  ...
  mirror::ArtField* self_patchoat_needed = mirror::Class::FindStaticField(soa.Self(), dexfile, "SELF_PATCHOAT_NEEDED", "I");
