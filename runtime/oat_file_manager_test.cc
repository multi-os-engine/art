...
TEST_F(OatFileManagerTest, NonExsistentDexLocation) {
...
//
// TODO: This test is disabled because we don't currently support non-absolute
// path to dex location. This test should be re-enabled when we decide how
// non-absolute paths to dex locations should be handled.
...
//
// TODO: This test is disabled because we don't currently support short
// paths to dex location. This test should be re-enabled when we decide how
// short paths to dex locations should be handled.
...
// Expect: The oat file status is kOutOfDate.
//
// TODO: This test is disabled because we don't currently support non-standard
// extensions for dex locations.  This test should be re-enabled when we
// decide how non-standard extensions to dex locations should be handled.
