...
class JavaVMExt : public JavaVM {
 public:
  ...
  // This must only be called in a single threaded context.
  ...
  // after either a SetShutdownFailureListener(nullptr) call or the JavaVMExt is deleted.  This must
  // only be called in a single threaded context.
