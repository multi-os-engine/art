...
#undef INSTRUCTION_ENUM
  ...
  enum Flags {
    ...
    kRegCFieldOrConst    = 0x0400000,  // is the third virtual register a field or literal constant (vC)
    kRegBFieldOrConst    = 0x0800000,  // is the third virtual register a field or literal constant (vB)
    kRegAFieldOrConst    = 0x1000000,  // is the third virtual register a field or literal constant (vB)
  };
