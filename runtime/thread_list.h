...
class ThreadList {
 public:
  ...
  // else nullptr. The peer is used to identify the thread to avoid races with the thread terminating.
  ...
  // thread on success else nullptr. The thread id is used to identify the thread to avoid races with
