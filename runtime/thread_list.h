...
class ThreadList {
 ...
 private:
  ...
  void SuspendAllInternal(Thread* self, Thread* ignore1, Thread* ignore2 = NULL, bool debug_suspend = false)
      LOCKS_EXCLUDED(Locks::thread_list_lock_,
                     Locks::thread_suspend_count_lock_);
  void ResumeAllInternal(Thread* self, Thread* ignore1, Thread* ignore2 = NULL)
      LOCKS_EXCLUDED(Locks::thread_list_lock_,
                     Locks::thread_suspend_count_lock_);
