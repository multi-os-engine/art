...
#ifndef ART_RUNTIME_BASE_PASS_DRIVER_H_
#define ART_RUNTIME_BASE_PASS_DRIVER_H_
...
class PassDriver {
 ...
 protected:
   ...
   */
  void ApplyPass(PassDataHolder* data, const Pass* pass) {
    pass->Start(data);
    DispatchPass(pass);
    pass->End(data);
  }
  ...
  static uint16_t const g_passes_size;
...
#endif  // ART_RUNTIME_BASE_PASS_DRIVER_H_
