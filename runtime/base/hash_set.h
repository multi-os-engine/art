...
class HashSet {
 ...
 public:
  ...
  HashSet(double min_load_factor = kDefaultMinLoadFactor,
          double max_load_factor = kDefaultMaxLoadFactor)
      : num_elements_(0u),
        num_buckets_(0u),
  ...
  void SetLoadFactor(double min_load_factor, double max_load_factor) {
    ...
    DCHECK_GT(min_load_factor, 0.01);
    DCHECK_LT(max_load_factor, 0.99);
    min_load_factor_ = min_load_factor;
    max_load_factor_ = max_load_factor;
