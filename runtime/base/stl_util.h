 ...
 public:
  void operator()(T* ptr) const {
    ...
    if (RUNNING_ON_MEMORY_TOOL > 0) {
      ...
      CHECK(ArenaStack::ArenaTagForAllocation(reinterpret_cast<void*>(ptr)) == kArenaFreeTagUsed)
          << "Freeing invalid object " << ptr;
      // TODO: This is arena specific, should we rename DestroyOnlyDelete correspondingly.
      ArenaStack::ArenaTagForAllocation(reinterpret_cast<void*>(ptr)) = kArenaFreeTagFree;
