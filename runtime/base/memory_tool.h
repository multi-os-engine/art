...
#define MEMORY_TOOL_MAKE_NOACCESS(p, s) VALGRIND_MEM_MAKE_NOACCESS(p, s)
#define MEMORY_TOOL_MAKE_UNDEFINED(p, s) VALGRIND_MEM_MAKE_UNDEFINED(p, s)
#define MEMORY_TOOL_MAKE_DEFINED(p, s) VALGRIND_MEM_MAKE_DEFINED(p, s)
