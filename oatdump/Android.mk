...
$(eval $(call build-art-multi-executable,oatdump,$(OATDUMP_SRC_FILES),libart-compiler libart-disassembler,libcutils liboatmapproto libprotobuf-cpp-lite,liboatmapproto libprotobuf-cpp-lite,art/compiler art/disassembler))
