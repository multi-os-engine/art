...
OATDUMP_SRC_FILES := \
	oatdump.cc emit_oatmap.cc

# Build variants {target,host} x {debug,ndebug}
$(eval $(call build-art-multi-executable,oatdump,$(OATDUMP_SRC_FILES),libart-compiler libart-disassembler,libcutils libartoatmapproto libprotobuf-cpp-lite,libartoatmapproto libprotobuf-cpp-lite,art/compiler art/disassembler))
