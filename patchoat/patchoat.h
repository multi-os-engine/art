...
class PatchOat {
 ...
 private:
  ...
  template <typename ElfFileImpl, typename ptr_t> bool PatchTextSection(ElfFileImpl* oat_file);
  template <typename ElfFileImpl, typename ptr_t> bool CheckOatFile(ElfFileImpl* oat_filec);
  template <typename ElfFileImpl>
