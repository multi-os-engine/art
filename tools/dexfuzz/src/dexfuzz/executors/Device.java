...
public class Device {
  ...
  /**
   * The constructor for a local "device".
   */
  public Device() {
    this.isLocal = true;
    this.deviceName = "[LocalDevice]";
    setup();
  }
   ...
   */
  public String getLocalExecutionFlags() {
  ...
  public void cleanCodeCache(Architecture architecture, String testLocation, String programName) {
    String command = "rm -f " + getCacheLocation(architecture) + getOatFileName(testLocation, programName);
