...
#
# Occurrences of '##' inside regular expressions are replaced with a pattern
# that matches any positive integer. This is a syntactic sugar which is meant to
# alleviate matching against numerical identifiers.
#
# Example:
