...
# the source file of a test which contains the expected output in its comments. These so-called
# check lines begin with a given prefix ('CHECK' by default) followed by a pattern that is searched
# for in the output file. They are matched in the order of appearance in the check file.
#
