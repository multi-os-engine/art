  ...
  for testCase in checkerFile.testCases:
    ...
    try:
      ...
      if e.assertion.variant == TestAssertion.Variant.Not:
        msg = "NOT assertion matched line {}, state: {}".format(lineNo, e.variables)
        Logger.testFailed(msg, e.assertion.fileName, e.assertion.lineNo)
      else:
        msg = "Assertion could not be matched starting from line {}, state: {}".format(
            lineNo, e.variables)
        Logger.testFailed(msg, e.assertion.fileName, e.assertion.lineNo)
