...
class OverviewHandler extends AhatHandler {
  ...
  public void handle(HtmlWriter html, URI uri) throws IOException {
    ...
    html.println("<tr><th>ahat version:</th><td>ahat-%s</td></tr>", OverviewHandler.class.getPackage().getImplementationVersion());
  ...
  private void printHeapSizes(HtmlWriter html) {
    ...
    HeapTable.TableConfig<Object> table = new HeapTable.TableConfig<Object>() {
      ...
      public List<HeapTable.ValueConfig<Object>> getValueConfigs() {
        return new ArrayList<HeapTable.ValueConfig<Object>>();
      }
    };
