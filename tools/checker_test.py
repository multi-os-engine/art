...
class TestCheckGroup_Match(unittest.TestCase):
  ...
  def test_Ordering(self):
    ...
    self.__notMatchMulti([("foo", CheckVariant.InOrder),
                         ...
                         """bar
                            foo""")
    self.__matchMulti([("abc", CheckVariant.NoOrder),
                       ("def", CheckVariant.NoOrder)],
                      """abc
                         def""")
    self.__matchMulti([("abc", CheckVariant.NoOrder),
                       ("def", CheckVariant.NoOrder)],
  ...
  def test_LineOnlyMatchesOnce(self):
    self.__matchMulti([("foo", CheckVariant.NoOrder),
                       ("foo", CheckVariant.NoOrder)],
                       """foo
                          foo""")
    self.__notMatchMulti([("foo", CheckVariant.NoOrder),
                          ("foo", CheckVariant.NoOrder)],
                          """foo
                             bar""")
