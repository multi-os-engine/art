...
# The architecures the compiled tools are able to run on. Setting this to 'all' will cause all
# architectures to be included.
# TODO This should really change what files are checked by make for recompilation.
