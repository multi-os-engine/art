...
ART_GTEST_ANDROID_ROOT := '/system'
ifneq ($(ART_TEST_ANDROID_ROOT),)
  ART_GTEST_ANDROID_ROOT := $(ART_TEST_ANDROID_ROOT)
endif
...
$$(gtest_rule): test-art-target-sync
	...
	$$(call ART_TEST_SKIP,$$@) && \
	  (adb shell "LD_LIBRARY_PATH=$(3) ANDROID_ROOT=$(ART_GTEST_ANDROID_ROOT) \
