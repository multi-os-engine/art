...
.PHONY: $$(gtest_rule)
$$(gtest_rule): $$(gtest_exe) test-art-host-dependencies
...
valgrind-$$(gtest_rule): $$(gtest_exe) test-art-host-dependencies
	$(hide) $$(call ART_TEST_SKIP,$$@) && \
