...
namespace art {
  ...
  bool operator==(const ProfileSaverOptions& lhs, const ProfileSaverOptions& rhs) {
    return lhs.enabled_ == rhs.enabled_ &&
        ...
        lhs.min_nr_of_methods_to_save_ == rhs.min_nr_of_methods_to_save_ &&
        lhs.min_nr_of_classes_to_save_ == rhs.min_nr_of_classes_to_save_ &&
        lhs.min_nr_of_notification_before_wake_ == rhs.min_nr_of_notification_before_wake_ &&
        lhs.max_nr_of_notification_before_wake_ == rhs.max_nr_of_notification_before_wake_;
  }
...
TEST_F(CmdlineParserTest, ProfileSaverOptions) {
  ...
  EXPECT_SINGLE_PARSE_VALUE(opt,
                            ...
                            "-Xps-min-nr-of-methods-to-save:4 "
                            "-Xps-min-nr-of-classes-to-save:5 "
                            "-Xps-min-nr-of-notification-before-wake:6 "
                            "-Xps-max-nr-of-notification-before-wake:7",
                            M::ProfileSaverOpts);
}  // TEST_F
