...
## CHECK-START: int TestCase.testCatchPhiInputs(int, int, int, int) dead_code_elimination_final (before)
...
## CHECK-START: int TestCase.testCatchPhiInputs(int, int, int, int) dead_code_elimination_final (after)
## CHECK-DAG:     <<Const0xb:i\d+>> IntConstant 11
## CHECK-DAG:     <<Const0xc:i\d+>> IntConstant 12
## CHECK-DAG:     <<Const0xd:i\d+>> IntConstant 13
## CHECK-DAG:     <<Const0xe:i\d+>> IntConstant 14
...
.method public static testCatchPhiInputs(IIII)I
    .registers 7
