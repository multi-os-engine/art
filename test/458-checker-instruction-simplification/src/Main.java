...
public class Main {
  ...
  /// CHECK-START: int Main.floatConditionNotEqualOne(float) instruction_simplifier_before_codegen (before)
  /// CHECK-DAG:      <<Arg:f\d+>>      ParameterValue
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  /// CHECK-DAG:      <<Const54:i\d+>>  IntConstant 54
  ...
  /// CHECK-START: int Main.doubleConditionEqualZero(double) instruction_simplifier_before_codegen (before)
  /// CHECK-DAG:      <<Arg:d\d+>>      ParameterValue
  /// CHECK-DAG:      <<Const13:i\d+>>  IntConstant 13
  /// CHECK-DAG:      <<Const54:i\d+>>  IntConstant 54
