...
public class Main {
  ...
  // CHECK:         [[Arg1:i\d+]]     ParameterValue
  // CHECK:         [[Arg2:i\d+]]     ParameterValue
  // CHECK:         [[Neg1:i\d+]]     Neg [ [[Arg1]] ]
  // CHECK:         [[Neg2:i\d+]]     Neg [ [[Arg2]] ]
  // CHECK:         [[Add:i\d+]]      Add [ [[Neg1]] [[Neg2]] ]
  // CHECK:                           Return [ [[Add]] ]
  ...
  // CHECK:         [[Arg2:i\d+]]     ParameterValue
  // CHECK-NOT:                       Neg
  // CHECK:         [[Add:i\d+]]      Add [ [[Arg1]] [[Arg2]] ]
  // CHECK:         [[Neg:i\d+]]      Neg [ [[Add]] ]
  // CHECK:                           Return [ [[Neg]] ]
  ...
  // CHECK:         [[Neg1:i\d+]]     Neg [ [[Arg1]] ]
  // CHECK:         [[Neg2:i\d+]]     Neg [ [[Arg2]] ]
  // CHECK:         [[Add1:i\d+]]     Add [ [[Neg1]] [[Neg2]] ]
  // CHECK:         [[Add2:i\d+]]     Add [ [[Neg1]] [[Neg2]] ]
  // CHECK:         [[Or:i\d+]]       Or [ [[Add1]] [[Add2]] ]
  // CHECK:                           Return [ [[Or]] ]
  ...
  // CHECK:         [[Arg1:j\d+]]     ParameterValue
  // CHECK:         [[Arg2:j\d+]]     ParameterValue
  // CHECK:         [[Neg1:j\d+]]     Neg [ [[Arg1]] ]
  // CHECK:         [[Neg2:j\d+]]     Neg [ [[Arg2]] ]
  // CHECK:                           Goto
  // -------------- Loop
  // CHECK:                           SuspendCheck
  ...
  // CHECK:         [[Arg1:j\d+]]     ParameterValue
  // CHECK:         [[Arg2:j\d+]]     ParameterValue
  // CHECK:         [[Neg:j\d+]]      Neg [ [[Arg1]] ]
  // CHECK:         [[Add:j\d+]]      Add [ [[Neg]] [[Arg2]] ]
  // CHECK:                           Return [ [[Add]] ]

  // CHECK-START: long Main.AddNeg1(long, long) instruction_simplifier (after)
  // CHECK:         [[Arg1:j\d+]]     ParameterValue
  // CHECK:         [[Arg2:j\d+]]     ParameterValue
  // CHECK:         [[Sub:j\d+]]      Sub [ [[Arg2]] [[Arg1]] ]
  // CHECK-NOT:                       Neg
  // CHECK-NOT:                       Add
  // CHECK:                           Return [ [[Sub]] ]
  ...
  // CHECK:         [[Arg1:j\d+]]     ParameterValue
  // CHECK:         [[Arg2:j\d+]]     ParameterValue
  // CHECK:         [[Neg:j\d+]]      Neg [ [[Arg2]] ]
  // CHECK:         [[Add1:j\d+]]     Add [ [[Arg1]] [[Neg]] ]
  // CHECK:         [[Add2:j\d+]]     Add [ [[Arg1]] [[Neg]] ]
  // CHECK:         [[Res:j\d+]]      Or [ [[Add1]] [[Add2]] ]
  // CHECK:                           Return [ [[Res]] ]
  ...
  // CHECK:         [[Neg1:j\d+]]     Neg [ [[Arg]] ]
  // CHECK:         [[Neg2:j\d+]]     Neg [ [[Neg1]] ]
  // CHECK:                           Return [ [[Neg2]] ]
  ...
  // CHECK:         [[Neg1:i\d+]]     Neg [ [[Arg]] ]
  // CHECK:         [[Neg2:i\d+]]     Neg [ [[Neg1]] ]
  // CHECK:         [[Add:i\d+]]      Add [ [[Neg1]] [[Neg2]] ]
  // CHECK:                           Return [ [[Add]] ]

  // CHECK-START: int Main.NegNeg2(int) instruction_simplifier (after)
  // CHECK:         [[Arg:i\d+]]      ParameterValue
  // CHECK:         [[Sub:i\d+]]      Sub [ [[Arg]] [[Arg]] ]
  // CHECK:                           Return [ [[Sub]] ]
  ...
  // CHECK:         [[Neg:j\d+]]      Neg [ [[Arg]] ]
  // CHECK:         [[Sub:j\d+]]      Sub [ [[Const0]] [[Neg]] ]
  // CHECK:                           Return [ [[Sub]] ]
  ...
  // CHECK:         [[Arg1:i\d+]]     ParameterValue
  // CHECK:         [[Arg2:i\d+]]     ParameterValue
  // CHECK:         [[Sub:i\d+]]      Sub [ [[Arg1]] [[Arg2]] ]
  // CHECK:         [[Neg:i\d+]]      Neg [ [[Sub]] ]
  // CHECK:                           Return [ [[Neg]] ]

  // CHECK-START: int Main.NegSub1(int, int) instruction_simplifier (after)
  // CHECK:         [[Arg1:i\d+]]     ParameterValue
  // CHECK:         [[Arg2:i\d+]]     ParameterValue
  // CHECK:         [[Sub:i\d+]]      Sub [ [[Arg2]] [[Arg1]] ]
  // CHECK-NOT:                       Neg
  // CHECK:                           Return [ [[Sub]] ]
  ...
  // CHECK:         [[Arg2:i\d+]]     ParameterValue
  // CHECK:         [[Sub:i\d+]]      Sub [ [[Arg1]] [[Arg2]] ]
  // CHECK:         [[Neg1:i\d+]]     Neg [ [[Sub]] ]
  // CHECK:         [[Neg2:i\d+]]     Neg [ [[Sub]] ]
  // CHECK:         [[Or:i\d+]]       Or [ [[Neg1]] [[Neg2]] ]
  // CHECK:                           Return [ [[Or]] ]
  ...
  // CHECK:         [[Arg:j\d+]]      ParameterValue
  // CHECK:         [[ConstF1:j\d+]]  LongConstant -1
  // CHECK:         [[Xor1:j\d+]]     Xor [ [[Arg]] [[ConstF1]] ]
  // CHECK:         [[Xor2:j\d+]]     Xor [ [[Xor1]] [[ConstF1]] ]
  // CHECK:                           Return [ [[Xor2]] ]
  ...
  // CHECK:         [[Arg:i\d+]]      ParameterValue
  // CHECK:         [[ConstF1:i\d+]]  IntConstant -1
  // CHECK:         [[Xor1:i\d+]]     Xor [ [[Arg]] [[ConstF1]] ]
  // CHECK:         [[Xor2:i\d+]]     Xor [ [[Xor1]] [[ConstF1]] ]
  // CHECK:         [[Add:i\d+]]      Add [ [[Xor1]] [[Xor2]] ]
  // CHECK:                           Return [ [[Add]] ]

  // CHECK-START: int Main.NotNot2(int) instruction_simplifier (after)
  // CHECK:         [[Arg:i\d+]]      ParameterValue
  // CHECK:         [[Not:i\d+]]      Not [ [[Arg]] ]
  // CHECK:         [[Add:i\d+]]      Add [ [[Not]] [[Arg]] ]
  // CHECK:                           Return [ [[Add]] ]
  ...
  // CHECK:         [[Arg1:i\d+]]     ParameterValue
  // CHECK:         [[Arg2:i\d+]]     ParameterValue
  // CHECK:         [[Neg:i\d+]]      Neg [ [[Arg1]] ]
  // CHECK:         [[Sub:i\d+]]      Sub [ [[Neg]] [[Arg2]] ]
  // CHECK:                           Return [ [[Sub]] ]
  ...
  // CHECK:         [[Arg2:i\d+]]     ParameterValue
  // CHECK:         [[Neg:i\d+]]      Neg [ [[Arg1]] ]
  // CHECK:         [[Sub1:i\d+]]     Sub [ [[Neg]] [[Arg2]] ]
  // CHECK:         [[Sub2:i\d+]]     Sub [ [[Neg]] [[Arg2]] ]
  // CHECK:         [[Or:i\d+]]       Or [ [[Sub1]] [[Sub2]] ]
  // CHECK:                           Return [ [[Or]] ]
