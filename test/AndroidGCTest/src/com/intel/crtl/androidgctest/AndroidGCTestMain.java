    ...
    public void start() {
        ...
        if (mOutOfMemory) {
              try {
                  ...
                  Log.i(mTag, "Cannot write to /sdcard/AndroidGCTest-result.txt" + e.getMessage());
              }
        } else {
              long maxTime = 0;
              ...
              String totalTime = "AndroidGCTest is done by " + mThreadNum + " threads. Completion time is " + maxTime + "ms";
