...
.method public static testCase_NormalPhi(IILjava/lang/Object;)V
  .registers 5
  ...
  :then1
    ...
    :merge2
      # PhiA [null, arg3]
      move-object v0, v1                                 # force create PhiA ref equivalent
...
.method public static testCase_LoopPhi(IILjava/lang/Object;Ljava/lang/Object;)V
  .registers 6
  ...
  :then1
    ...
    goto :merge1
  :else1
    move-object v1, v0                                   # create ref equivalent of PhiA
    invoke-static {}, Ljava/lang/System;->nanoTime()J    # env use of ref PhiA
    goto :merge1
  :merge1
  # PhiB [null, PhiA] for v1

  move-object v0, v1                                     # creates ref equivalent of PhiB
  invoke-static {}, Ljava/lang/System;->nanoTime()J      # env use of ref PhiB
