...
#           System.out.println("Expected no error Thrown on Main");
...
#       try {
#           System.out.println(m.sayHi());
#           System.out.println("Expected no error Thrown on Iface");
#       } catch (AbstractMethodError e) {
...
#       try {
#           System.out.println(m.sayHi());
#           System.out.println("Expected no error Thrown on Iface2");
#       } catch (AbstractMethodError e) {
...
.method public static callIface(LIface;)V
    ...
    :try_start
        ...
        const-string v0, "Expected no error Thrown on Iface"
        invoke-virtual {v1,v0}, Ljava/io/PrintStream;->println(Ljava/lang/Object;)V
...
.method public static callIface2(LIface2;)V
    ...
    :try_start
        ...
        const-string v0, "Expected no error Thrown on Iface2"
        invoke-virtual {v1,v0}, Ljava/io/PrintStream;->println(Ljava/lang/Object;)V
...
.method public static callMain(LMain;)V
    ...
    :try_start
        ...
        const-string v0, "Expected no error Thrown on Main"
        invoke-virtual {v1,v0}, Ljava/io/PrintStream;->println(Ljava/lang/Object;)V
