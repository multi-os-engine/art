...
public class Main {
  ...
  /// CHECK-START-ARM64: int Main.$opt$noinline$regressInputsAway1(int, int) instruction_simplifier (before)
  /// CHECK:       <<P1:i\d+>>          ParameterValue
  /// CHECK:       <<P2:i\d+>>          ParameterValue
  ...
  /// CHECK-START-ARM64: int Main.$opt$noinline$regressInputsAway1(int, int) instruction_simplifier (after)
  /// CHECK:       <<P1:i\d+>>          ParameterValue
  /// CHECK:       <<P2:i\d+>>          ParameterValue
  ...
  public static int $opt$noinline$regressInputsAway1(int a, int b) {
    if (doThrow) throw new Error();
    int a1 = a + 1;
    int not_a1 = ~a1;
    int b1 = b + 1;
