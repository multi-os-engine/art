...
public class Main {
  ...
  /// CHECK-START-ARM64: int Main.constantIndexGet(int[]) instruction_simplifier_arch (before)
  /// CHECK:             <<Array:l\d+>>         NullCheck
  /// CHECK:             <<Index:i\d+>>         BoundsCheck
  /// CHECK:                                    ArrayGet [<<Array>>,<<Index>>]

  /// CHECK-START-ARM64: int Main.constantIndexGet(int[]) instruction_simplifier_arch (after)
  /// CHECK:             <<Array:l\d+>>         NullCheck
  /// CHECK:             <<Index:i\d+>>         BoundsCheck
  ...
  /// CHECK-START-ARM64: void Main.constantIndexSet(int[]) instruction_simplifier_arch (before)
  /// CHECK:             <<Const2:i\d+>>        IntConstant 2
  /// CHECK:             <<Array:l\d+>>         NullCheck
  /// CHECK:             <<Index:i\d+>>         BoundsCheck
  /// CHECK:                                    ArraySet [<<Array>>,<<Index>>,<<Const2>>]

  /// CHECK-START-ARM64: void Main.constantIndexSet(int[]) instruction_simplifier_arch (after)
  /// CHECK:             <<Const2:i\d+>>        IntConstant 2
  /// CHECK:             <<Array:l\d+>>         NullCheck
  /// CHECK:             <<Index:i\d+>>         BoundsCheck
  /// CHECK-NOT:                                IntermediateAddress
  ...
  /// CHECK-START-ARM64: int Main.get(int[], int) instruction_simplifier_arch (before)
  /// CHECK:             <<Array:l\d+>>         NullCheck
  /// CHECK:             <<Index:i\d+>>         BoundsCheck
  /// CHECK:                                    ArrayGet [<<Array>>,<<Index>>]

  /// CHECK-START-ARM64: int Main.get(int[], int) instruction_simplifier_arch (after)
  ...
  /// CHECK-START-ARM64: void Main.set(int[], int, int) instruction_simplifier_arch (before)
  ...
  /// CHECK-START-ARM64: void Main.set(int[], int, int) instruction_simplifier_arch (after)
  /// CHECK:                                    ParameterValue
  /// CHECK:                                    ParameterValue
  /// CHECK:             <<Arg:i\d+>>           ParameterValue
  /// CHECK:             <<DataOffset:i\d+>>    IntConstant
  ...
  /// CHECK-START-ARM64: void Main.getSet(int[], int) instruction_simplifier_arch (before)
  ...
  /// CHECK-START-ARM64: void Main.getSet(int[], int) instruction_simplifier_arch (after)
  ...
  /// CHECK-START-ARM64: int[] Main.accrossGC(int[], int) instruction_simplifier_arch (before)
  /// CHECK:             <<Const1:i\d+>>        IntConstant 1
  /// CHECK:             <<Array:l\d+>>         NullCheck
  /// CHECK:             <<Index:i\d+>>         BoundsCheck
  /// CHECK:             <<ArrayGet:i\d+>>      ArrayGet [<<Array>>,<<Index>>]
  ...
  /// CHECK-START-ARM64: int[] Main.accrossGC(int[], int) instruction_simplifier_arch (after)
  /// CHECK-DAG:         <<Const1:i\d+>>        IntConstant 1
  /// CHECK-DAG:         <<DataOffset:i\d+>>    IntConstant
  /// CHECK:             <<Array:l\d+>>         NullCheck
  /// CHECK:             <<Index:i\d+>>         BoundsCheck
  ...
  /// CHECK-START-ARM64: int Main.canMergeAfterBCE1() instruction_simplifier_arch (before)
  /// CHECK:             <<Const1:i\d+>>        IntConstant 1
  ...
  /// CHECK-START-ARM64: int Main.canMergeAfterBCE1() instruction_simplifier_arch (after)
  /// CHECK-DAG:         <<Const1:i\d+>>        IntConstant 1
  ...
  /// CHECK-START-ARM64: int Main.canMergeAfterBCE2() instruction_simplifier_arch (before)
  /// CHECK:             <<Const1:i\d+>>        IntConstant 1
  /// CHECK:             <<Array:l\d+>>         NewArray
  /// CHECK:             <<Index:i\d+>>         Phi
  /// CHECK:                                    If
  ...
  /// CHECK-START-ARM64: int Main.canMergeAfterBCE2() instruction_simplifier_arch (after)
  /// CHECK-DAG:         <<Const1:i\d+>>        IntConstant 1
  /// CHECK-DAG:         <<DataOffset:i\d+>>    IntConstant 12
  /// CHECK:             <<Array:l\d+>>         NewArray
  /// CHECK:             <<Index:i\d+>>         Phi
