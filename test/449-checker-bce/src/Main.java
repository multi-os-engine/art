...
public class Main {
  ...
  static void loopPattern1(int[] array) {
    ...
    for (int i = 0; i < array.length; i += 2) {
      // We don't have any assumptin on max array length yet.
  ...
  // CHECK-START: void Main.pyramid(int[]) BCE (before)
  // CHECK: BoundsCheck
  // CHECK: ArraySet
  // CHECK: BoundsCheck
  // CHECK: ArraySet

  // CHECK-START: void Main.pyramid(int[]) BCE (after)
  // CHECK-NOT: BoundsCheck
  // CHECK: ArraySet
  // CHECK-NOT: BoundsCheck
  // CHECK: ArraySet
