...
public class Main {
  ...
  /// CHECK-START: java.lang.Object[] Main.testInstructionsWithUntypedParent() instruction_simplifier_after_types (after)
  /// CHECK-DAG:  <<Null:l\d+>>      NullConstant
  /// CHECK-DAG:  <<LoopPhi:l\d+>>   Phi [<<Null>>,<<Phi:l\d+>>]
  /// CHECK-DAG:  <<Array:l\d+>>     NewArray
  /// CHECK-DAG:  <<Phi>>            Phi [<<Array>>,<<LoopPhi>>]
  /// CHECK-DAG:  <<NC:l\d+>>        NullCheck [<<LoopPhi>>]
  /// CHECK-DAG:                     ArrayGet [<<NC>>,{{i\d+}}]
