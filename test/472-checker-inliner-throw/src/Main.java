...
public class Main {
  ...
  // CHECK-START: int Main.inlinePossibleAE(int) inliner (before)
  // CHECK-DAG:     [[Invoke:i\d+]]  InvokeStaticOrDirect
  // CHECK-DAG:                      Return [ [[Invoke]] ]

  // CHECK-START: int Main.inlinePossibleAE(int) inliner (after)
  // CHECK-NOT:                      InvokeStaticOrDirect
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if ((ex instanceof ArithmeticException) == false) {
