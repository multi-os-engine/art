...
class InterfaceCallResponse(Enum):
  ...
  def get_output_format(self):
    ...
    if self == InterfaceCallResponse.NoError:
      return "No exception thrown for {iface_name}.super.call() on {tree}. Dexfiles {my_dex_file} -> {called_dex_file}\n"
    elif self == InterfaceCallResponse.AbstractMethodError:
      return "AbstractMethodError thrown for {iface_name}.super.call() on {tree}. Dexfiles {my_dex_file} -> {called_dex_file}\n"
    elif self == InterfaceCallResponse.NoSuchMethodError:
      return "NoSuchMethodError thrown for {iface_name}.super.call() on {tree}. Dexfiles {my_dex_file} -> {called_dex_file}\n"
    else:
      return "IncompatibleClassChangeError thrown for {iface_name}.super.call() on {tree}. Dexfiles {my_dex_file} -> {called_dex_file}\n"
...
"""
  ...
  OUTPUT_PREFIX = "Calling {iface_name}.super.call() on {tree}. Dexfiles {my_dex_file} -> {called_dex_file}\n"
