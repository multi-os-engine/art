...
public class Main {
  ...
  /// CHECK-START-ARM64: void Main.$opt$validateExtendByteHelper1(byte, byte) instruction_simplifier_arm64 (after)
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  ...
  public static void $opt$validateExtendByteHelper1(byte a, byte b) {
    assertIntEquals(a + $noinline$byteToChar (b), a +  (char)b);
    assertIntEquals(a + $noinline$byteToShort(b), a + (short)b);
  }

  /// CHECK-START-ARM64: void Main.$opt$validateExtendByteHelper2(byte, byte) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp

  public static void $opt$validateExtendByteHelper2(byte a, byte b) {
  ...
  public static void $opt$validateExtendByte(byte a, byte b) {
    $opt$validateExtendByteHelper1(a, b);
    $opt$validateExtendByteHelper2(a, b);
  }

  /// CHECK-START-ARM64: void Main.$opt$validateExtendCharHelper1(char, char) instruction_simplifier_arm64 (after)
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  ...
  public static void $opt$validateExtendCharHelper1(char a, char b) {
    assertIntEquals(a + $noinline$charToByte (b), a +  (byte)b);
    assertIntEquals(a + $noinline$charToShort(b), a + (short)b);
  }

  /// CHECK-START-ARM64: void Main.$opt$validateExtendCharHelper2(char, char) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp

  public static void $opt$validateExtendCharHelper2(char a, char b) {
  ...
  public static void $opt$validateExtendChar(char a, char b) {
    $opt$validateExtendCharHelper1(a, b);
    $opt$validateExtendCharHelper2(a, b);
  }

  /// CHECK-START-ARM64: void Main.$opt$validateExtendShortHelper1(short, short) instruction_simplifier_arm64 (after)
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  ...
  public static void $opt$validateExtendShortHelper1(short a, short b) {
    assertIntEquals(a + $noinline$shortToByte (b), a +  (byte)b);
    assertIntEquals(a + $noinline$shortToChar (b), a +  (char)b);
  }

  /// CHECK-START-ARM64: void Main.$opt$validateExtendShortHelper2(short, short) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp

  public static void $opt$validateExtendShortHelper2(short a, short b) {
  ...
  public static void $opt$validateExtendShort(short a, short b) {
    $opt$validateExtendShortHelper1(a, b);
    $opt$validateExtendShortHelper2(a, b);
  }

  /// CHECK-START-ARM64: void Main.$opt$validateExtendIntHelper1(int, int) instruction_simplifier_arm64 (after)
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  ...
  public static void $opt$validateExtendIntHelper1(int a, int b) {
  ...
  /// CHECK-START-ARM64: void Main.$opt$validateExtendIntHelper2(int, int) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp

  public static void $opt$validateExtendIntHelper2(int a, int b) {
    assertLongEquals(a + $noinline$intToLong (b), a +  (long)b);
  }

  public static void $opt$validateExtendInt(int a, int b) {
    $opt$validateExtendIntHelper1(a, b);
    $opt$validateExtendIntHelper2(a, b);
  }
  ...
  public static void main(String[] args) {
    assertLongEquals(10000 - 3, $opt$noinline$translate(10000L, (byte)3));
    assertLongEquals(-10000 - -3, $opt$noinline$translate(-10000L, (byte)-3));
