...
public class Main {
  ...
  /// CHECK-START-ARM64: void Main.$opt$validateExtendByteHelper1(int, byte) instruction_simplifier_arm64 (after)
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  ...
  /// CHECK-START-ARM64: void Main.$opt$validateExtendByteHelper2(int, byte) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp

  public static void $opt$validateExtendByteHelper2(int a, byte b) {
  ...
  /// CHECK-START-ARM64: void Main.$opt$validateExtendChar(long, char) instruction_simplifier_arm64 (after)
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  ...
  /// CHECK-START-ARM64: void Main.$opt$validateExtendShortHelper1(int, short) instruction_simplifier_arm64 (after)
  /// CHECK:                            Arm64DataProcWithShifterOp
  /// CHECK:                            Arm64DataProcWithShifterOp
  ...
  public static void $opt$validateExtendShortHelper1(int a, short b) {
    assertIntEquals(a + $noinline$shortToByte (b), a + (byte)b);
    assertIntEquals(a + $noinline$shortToChar (b), a + (char)b);
  }

  /// CHECK-START-ARM64: void Main.$opt$validateExtendShortHelper2(int, short) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp
  /// CHECK-NOT:                        Arm64DataProcWithShifterOp

  public static void $opt$validateExtendShortHelper2(int a, short b) {
    // The conversion to `int` has been optimized away, so there is nothing to merge.
  ...
  public static void $opt$validateExtendShort(int a, short b) {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < inputs.length; i++) {
      ...
      for (int j = 0; j < inputs.length; j++) {
        ...
        $opt$validateExtendByte((int)inputs[i], (byte)inputs[j]);
        $opt$validateExtendChar(inputs[i], (char)inputs[j]);
        $opt$validateExtendShort((int)inputs[i], (short)inputs[j]);
