...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    assertIntEquals(47, TrueBlockWithSideEffects(true));
    assertIntEquals(43, TrueBlockWithSideEffects(false));
    assertIntEquals(42, FalseBlockWithSideEffects(true));
    assertIntEquals(48, FalseBlockWithSideEffects(false));
