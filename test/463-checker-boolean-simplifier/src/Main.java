...
public class Main {
  ...
  /// CHECK-START: int Main.TrueBlockWithSideEffects(boolean) boolean_simplifier (after)
  /// CHECK:         If
  ...
  /// CHECK-START: int Main.FalseBlockWithSideEffects(boolean) boolean_simplifier (after)
  /// CHECK:         If
  ...
  /// CHECK-START: int Main.SimpleTrueBlock(boolean, int) boolean_simplifier (after)
  ...
  /// CHECK-START: int Main.SimpleFalseBlock(boolean, int) boolean_simplifier (after)
  /// CHECK-DAG:     <<ParamX:z\d+>>   ParameterValue
  /// CHECK-DAG:     <<ParamY:i\d+>>   ParameterValue
  /// CHECK-DAG:     <<Const42:i\d+>>  IntConstant 42
  /// CHECK-DAG:     <<Const43:i\d+>>  IntConstant 43
  ...
  /// CHECK-START: int Main.SimpleBothBlocks(boolean, int, int) boolean_simplifier (after)
  /// CHECK-DAG:     <<ParamX:z\d+>>   ParameterValue
  /// CHECK-DAG:     <<ParamY:i\d+>>   ParameterValue
  /// CHECK-DAG:     <<ParamZ:i\d+>>   ParameterValue
  /// CHECK-DAG:     <<Const42:i\d+>>  IntConstant 42
