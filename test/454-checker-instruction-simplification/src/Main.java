...
public class Main {
  ...
  /**
   * Tiny programs exercising optimisations of arithmetic identities.
   */
  ...
  public static void main(String[] args) {
    ...
    if (MulPowerOfTwo128(arg) != (128 * arg)) {
      throw new Error();
    }
