public class Main {
  ...
  static void testD() {
    ...
    testD10(10.0, 10.02, 10.03, 10.04, 10.05, 10.06, 10.07, 10.08, 10.09, 10.01);
  }

  static void testL1(long p1) { System.out.println(p1); }
  static void testL2x(long p1, long p2) { testL2(p1+p2, p2); }
  ...
  static void testLL() {
        testL1(100100100100011L);  // TODO(64) Fails: 1592299435 (4 bytes only) ABIT-396
//        testL2(100021, 100022);
//        testL3(100031, 100032, 100033);
//        testL4(100041, 100042, 100043, 100044);
//        testL5(100051, 100052, 100053, 100054, 100055);
