...
public class Main {
  ...
  public static void main(String args[]) {
    ...
    // Near maxint.
    expectEquals32(2147483520, round32(Math.nextAfter(2147483647.0f, Float.NEGATIVE_INFINITY)));
    expectEquals32(2147483647, round32(2147483647.0f));
    expectEquals32(2147483647, round32(Math.nextAfter(2147483647.0f, Float.POSITIVE_INFINITY)));
    ...
    // Near maxint.
    expectEquals64(9223372036854774784L,
        round64(Math.nextAfter(9223372036854775807.0, Double.NEGATIVE_INFINITY)));
    expectEquals64(9223372036854775807L, round64(9223372036854775807.0));
    expectEquals64(9223372036854775807L,
        round64(Math.nextAfter(9223372036854775807.0, Double.POSITIVE_INFINITY)));
