...
public class Main {
  ...
  /// CHECK-START: void Main.linearTriangularOnArrayLength(int) BCE (before)
  /// CHECK-DAG: BoundsCheck
  /// CHECK-DAG: ArrayGet
  /// CHECK-DAG: ArraySet
  /// CHECK-DAG: BoundsCheck
  /// CHECK-DAG: ArrayGet
  /// CHECK-DAG: ArraySet
  /// CHECK-START: void Main.linearTriangularOnArrayLength(int) BCE (after)
  /// CHECK-NOT: BoundsCheck
  /// CHECK-DAG: ArrayGet
  /// CHECK-DAG: ArraySet
  /// CHECK-NOT: BoundsCheck
  ...
  /// CHECK-DAG: ArraySet
  /// CHECK-NOT: Deoptimize
  private static void linearTriangularOnArrayLength(int n) {
    int[] a = new int[n];
  ...
  public static void main(String[] args) {
    ...
    linearTriangularOnArrayLength(100);
    linearTriangularOnParameter(100);
