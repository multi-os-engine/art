...
public class Main {
  ...
  /// CHECK:         <<Arg:f\d+>>  ParameterValue
  /// CHECK-DAG:     <<Five:f\d+>> FloatConstant 5
  /// CHECK-DAG:     <<Zero:i\d+>> IntConstant 0
  /// CHECK-DAG:     <<MinusOne:i\d+>> IntConstant -1
  /// CHECK:         <<Base:i\d+>> X86ComputeBaseMethodAddress uses:[<<UseInput:\d+>>]
