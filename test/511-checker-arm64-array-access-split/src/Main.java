...
public class Main {
  ...
  /// CHECK-START: int Main.constantIndexGet(int[]) instruction_simplifier_arch (before)
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  /// CHECK:                              ArrayGet [<<Array>>,<<Index>>]

  /// CHECK-START: int Main.constantIndexGet(int[]) instruction_simplifier_arch (after)
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  ...
  /// CHECK-START: void Main.constantIndexSet(int[]) instruction_simplifier_arch (before)
  /// CHECK:       <<Const2:i\d+>>        IntConstant 2
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  /// CHECK:                              ArraySet [<<Array>>,<<Index>>,<<Const2>>]

  /// CHECK-START: void Main.constantIndexSet(int[]) instruction_simplifier_arch (after)
  /// CHECK:       <<Const2:i\d+>>        IntConstant 2
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  /// CHECK-NOT:                          Arm64IntermediateAddress
  ...
  /// CHECK-START: int Main.get(int[], int) instruction_simplifier_arch (before)
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  /// CHECK:                              ArrayGet [<<Array>>,<<Index>>]

  /// CHECK-START: int Main.get(int[], int) instruction_simplifier_arch (after)
  /// CHECK:       <<DataOffset:i\d+>>    IntConstant
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  /// CHECK:       <<Address:l\d+>>       Arm64IntermediateAddress [<<Array>>,<<DataOffset>>]
  /// CHECK:                              ArrayGet [<<Address>>,<<Index>>]
  ...
  /// CHECK-START: void Main.set(int[], int, int) instruction_simplifier_arch (before)
  ...
  /// CHECK-START: void Main.set(int[], int, int) instruction_simplifier_arch (after)
  /// CHECK:                              ParameterValue
  /// CHECK:                              ParameterValue
  /// CHECK:       <<Arg:i\d+>>           ParameterValue
  /// CHECK:       <<DataOffset:i\d+>>    IntConstant
  ...
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  /// CHECK:       <<Address:l\d+>>       Arm64IntermediateAddress [<<Array>>,<<DataOffset>>]
  /// CHECK:                              ArraySet [<<Address>>,<<Index>>,<<Arg>>]
  ...
  /// CHECK-START: void Main.getSet(int[], int) instruction_simplifier_arch (before)
  ...
  /// CHECK-START: void Main.getSet(int[], int) instruction_simplifier_arch (after)
  ...
  /// CHECK-START: void Main.getSet(int[], int) GVN_after_arch (after)
  /// CHECK-DAG:   <<Const1:i\d+>>        IntConstant 1
  /// CHECK-DAG:   <<DataOffset:i\d+>>    IntConstant
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  ...
  /// CHECK-START: int[] Main.dontReorderAcrossGC(int[], int) instruction_simplifier_arch (before)
  /// CHECK:       <<Const1:i\d+>>        IntConstant 1
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  /// CHECK:       <<ArrayGet:i\d+>>      ArrayGet [<<Array>>,<<Index>>]
  ...
  /// CHECK-START: int[] Main.dontReorderAcrossGC(int[], int) instruction_simplifier_arch (after)
  /// CHECK-DAG:   <<Const1:i\d+>>        IntConstant 1
  /// CHECK-DAG:   <<DataOffset:i\d+>>    IntConstant
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  ...
  /// CHECK-START: int[] Main.dontReorderAcrossGC(int[], int) GVN_after_arch (after)
  /// CHECK-DAG:   <<Const1:i\d+>>        IntConstant 1
  /// CHECK-DAG:   <<DataOffset:i\d+>>    IntConstant
  /// CHECK:       <<Array:l\d+>>         NullCheck
  /// CHECK:       <<Index:i\d+>>         BoundsCheck
  ...
  public static int[] dontReorderAcrossGC(int array[], int index) {
  ...
  /// CHECK-START: int Main.canMergeAfterBCE1() instruction_simplifier_arch (before)
  /// CHECK:       <<Const1:i\d+>>        IntConstant 1
  ...
  // By the time we reach the architecture-specific instruction simplifire, BCE
  // has removed the bounds checks in the loop.

  /// CHECK-START: int Main.canMergeAfterBCE1() instruction_simplifier_arch (after)
  /// CHECK-DAG:   <<Const1:i\d+>>        IntConstant 1
  ...
  /// CHECK-START: int Main.canMergeAfterBCE1() GVN_after_arch (after)
  /// CHECK-DAG:   <<Const1:i\d+>>        IntConstant 1
  /// CHECK-DAG:   <<DataOffset:i\d+>>    IntConstant 12
  /// CHECK:       <<Array:l\d+>>         NewArray
  /// CHECK:       <<Index:i\d+>>         Phi
  ...
  /// CHECK-START: int Main.canMergeAfterBCE2() instruction_simplifier_arch (before)
  /// CHECK:       <<Const1:i\d+>>        IntConstant 1
  /// CHECK:       <<Array:l\d+>>         NewArray
  /// CHECK:       <<Index:i\d+>>         Phi
  /// CHECK:                              If
  ...
  /// CHECK-START: int Main.canMergeAfterBCE2() instruction_simplifier_arch (after)
  /// CHECK-DAG:   <<Const1:i\d+>>        IntConstant 1
  /// CHECK-DAG:   <<DataOffset:i\d+>>    IntConstant 12
  /// CHECK:       <<Array:l\d+>>         NewArray
  /// CHECK:       <<Index:i\d+>>         Phi
  ...
  /// CHECK-START: int Main.canMergeAfterBCE2() GVN_after_arch (after)
  /// CHECK-DAG:   <<Const1:i\d+>>        IntConstant 1
  /// CHECK-DAG:   <<DataOffset:i\d+>>    IntConstant 12
  /// CHECK:       <<Array:l\d+>>         NewArray
  /// CHECK:       <<Index:i\d+>>         Phi
