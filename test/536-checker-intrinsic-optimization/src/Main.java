...
public class Main {
  ...
  /// CHECK-START: boolean Main.stringEqualsNull() instruction_simplifier (before)
  /// CHECK:      InvokeStaticOrDirect

  /// CHECK-START: boolean Main.stringEqualsNull() register (before)
  /// CHECK:      InvokeStaticOrDirect
  public static boolean stringEqualsNull() {
    return $inline$callStringEquals(null, null);
  }
