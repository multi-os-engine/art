...
public class Main {
  ...
  public static void test_Integer_numberOfLeadingZeros() {
    for (int i = 0; i < Integer.SIZE; i++) {
        ...
        Assert.assertEquals(Integer.numberOfLeadingZeros((1 << i) + 1),
                            Integer.SIZE - 1 - Math.max(1, i));
  ...
  public static void test_Long_numberOfLeadingZeros() {
    for (int i = 0; i < Long.SIZE; i++) {
        ...
        Assert.assertEquals(Long.numberOfLeadingZeros((1L << i) + 1L),
                            Long.SIZE - 1 - Math.max(1, i));
