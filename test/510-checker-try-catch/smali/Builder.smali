...
# Test that MOVE_RESULT instruction is placed into the same block as the INVOKE
# it follows, even if there is a try boundary between them.
...
# Test that MOVE_RESULT instruction is placed into the same block as the
