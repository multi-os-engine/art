...
# Tests register allocation of intervals crossing catch block positions.

## CHECK-START: int Runtime.testUseAfterCatch(boolean, boolean) register (after)
## CHECK-NOT:     Phi is_catch_phi:true

.method public static testUseAfterCatch(ZZ)I
  .registers 6
...
# Tests catch-phi runtime support for constant values.
...
# Tests catch-phi runtime support for 32-bit values stored in core registers.
...
# Tests catch-phi runtime support for 64-bit values stored in core registers.
...
# Tests catch-phi runtime support for 32-bit values stored in FPU registers.
...
# Tests catch-phi runtime support for 64-bit values stored in FPU registers.
...
# Tests catch-phi runtime support for 32-bit values stored on the stack.
...
# Tests catch-phi runtime support for 64-bit values stored on the stack.
