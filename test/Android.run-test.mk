...
ifdef dist_goal
  ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,$(TARGET_TYPES),$(PREBUILD_TYPES), \
        ...
        $(TEST_ART_TIMING_SENSITIVE_RUN_TESTS), $(ADDRESS_SIZES))
endif
...
ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,$(TARGET_TYPES),$(PREBUILD_TYPES), \
    ...
    $(TEST_ART_BROKEN_TRACE_RUN_TESTS), $(ADDRESS_SIZES))
...
define define-test-art-run-test
  ...
  ifeq ($(9),64)
    ...
    ifeq ($(9),32)
      ...
      $$(error found $(9) expected $(ADDRESS_SIZES))
    endif
  endif
