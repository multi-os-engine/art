...
#        $(TEST_ART_RUN_TESTS),$(ADDRESS_SIZES))
...
ifdef dist_goal
  ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,$(TARGET_TYPES),$(PREBUILD_TYPES), \
        ...
        $(IMAGE_TYPES), $(TEST_ART_TIMING_SENSITIVE_RUN_TESTS), $(ADDRESS_SIZES))
endif
...
ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,$(TARGET_TYPES),prebuild, \
    $(COMPILER_TYPES), $(RELOCATE_TYPES),$(TRACE_TYPES),$(GC_TYPES),$(JNI_TYPES), \
    $(TEST_ART_BROKEN_PREBUILD_RUN_TESTS), $(ADDRESS_SIZES))
...
ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,$(TARGET_TYPES),$(PREBUILD_TYPES), \
    ...
    $(TEST_ART_BROKEN_NO_RELOCATE_TESTS), $(ADDRESS_SIZES))
...
ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,$(TARGET_TYPES),no-prebuild, \
    $(COMPILER_TYPES), $(RELOCATE_TYPES),$(TRACE_TYPES),$(GC_TYPES),$(JNI_TYPES), \
    $(TEST_ART_BROKEN_NO_PREBUILD_TESTS), $(ADDRESS_SIZES))
...
ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,$(TARGET_TYPES),$(PREBUILD_TYPES), \
    ...
    $(IMAGE_TYPES), $(TEST_ART_BROKEN_TRACE_RUN_TESTS), $(ADDRESS_SIZES))

TEST_ART_BROKEN_TRACE_RUN_TESTS :=

# Tests that tickle unimplemented parts of optimizing generated code, such as GetDexPc.
...
ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,$(TARGET_TYPES),no-dex2oat,$(COMPILER_TYPES), \
    $(RELOCATE_TYPES),$(TRACE_TYPES),$(GC_TYPES),$(JNI_TYPES),$(IMAGE_TYPES), \
	$(TEST_ART_BROKEN_FALLBACK_RUN_TESTS),$(ADDRESS_SIZES))
...
$(foreach target, $(TARGET_TYPES), \
  $(foreach address_size, $(ADDRESS_SIZES), \
...
define define-test-art-run-test
  ...
  ifeq ($(10),64)
    ...
    ifeq ($(10),32)
      ...
      $$(error found $(10) expected $(ADDRESS_SIZES))
    endif
  endif
...
$(foreach target, $(TARGET_TYPES), \
  $(foreach address_size, $(ADDRESS_SIZES), $(eval \
