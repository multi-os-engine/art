...
$$(dmart_target): $(TEST_ART_RUN_TEST_DEPENDENCIES) $(TARGET_JACK_CLASSPATH_DEPENDENCIES) | $(TEST_ART_RUN_TEST_ORDERONLY_DEPENDENCIES)
	...
	$(hide) DX=$(abspath $(DX)) JASMIN=$(abspath $(HOST_OUT_EXECUTABLES)/jasmin) \
	  ...
	  $(if $(ANDROID_JACK_DEFAULT_VERSION),ANDROID_JACK_DEFAULT_VERSION=$(ANDROID_JACK_DEFAULT_VERSION),) \
	  $(if $(ANDROID_JACK_EXTRA_ARGS),ANDROID_JACK_EXTRA_ARGS="$(ANDROID_JACK_EXTRA_ARGS)",) \
	  JACK=$(abspath $(JACK)) \
