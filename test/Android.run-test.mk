...
# Known broken tests for the x86 optimizing compiler backend.
# TODO: 541 - Implement HRor
TEST_ART_BROKEN_OPTIMIZING_X86_RUN_TESTS := \
    541-checker-instruction-simplifier-rotate \
...
ifeq (x86,$(TARGET_ARCH))
  ifneq (,$(filter optimizing,$(COMPILER_TYPES)))
    ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,target,$(RUN_TYPES),$(PREBUILD_TYPES), \
        optimizing,$(RELOCATE_TYPES),$(TRACE_TYPES),$(GC_TYPES),$(JNI_TYPES), \
        $(IMAGE_TYPES),$(PICTEST_TYPES),$(DEBUGGABLE_TYPES), \
        $(TEST_ART_BROKEN_OPTIMIZING_X86_RUN_TESTS),$(ALL_ADDRESS_SIZES))
  endif
endif

TEST_ART_BROKEN_OPTIMIZING_X86_RUN_TESTS :=

# Known broken tests for the x86-64 optimizing compiler backend.
# TODO: 541 - Implement HRor
TEST_ART_BROKEN_OPTIMIZING_X86_64_RUN_TESTS := \
    541-checker-instruction-simplifier-rotate \
...
ifeq (x86_64,$(TARGET_ARCH))
  ifneq (,$(filter optimizing,$(COMPILER_TYPES)))
    ART_TEST_KNOWN_BROKEN += $(call all-run-test-names,target,$(RUN_TYPES),$(PREBUILD_TYPES), \
        optimizing,$(RELOCATE_TYPES),$(TRACE_TYPES),$(GC_TYPES),$(JNI_TYPES), \
        $(IMAGE_TYPES),$(PICTEST_TYPES),$(DEBUGGABLE_TYPES), \
        $(TEST_ART_BROKEN_OPTIMIZING_X86_64_RUN_TESTS),$(ALL_ADDRESS_SIZES))
  endif
endif
