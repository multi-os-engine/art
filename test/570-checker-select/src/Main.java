...
public class Main {
  ...
  /// CHECK-START: long Main.LongNonmatCond_LongVarVar(long, long, long, long) instruction_simplifier_before_codegen (after)
  /// CHECK:            <<Cond:z\d+>> LessThanOrEqual [{{j\d+}},{{j\d+}}]
  /// CHECK:                          Select [{{j\d+}},{{j\d+}},<<Cond>>]

  /// CHECK-START-X86_64: long Main.LongNonmatCond_LongVarVar(long, long, long, long) register (after)
  /// CHECK:            <<Cond:z\d+>> LessThanOrEqual [{{j\d+}},{{j\d+}}]
  /// CHECK:                          Select [{{j\d+}},{{j\d+}},<<Cond>>]

  // X86 rewrites to If.
  /// CHECK-START-X86: long Main.LongNonmatCond_LongVarVar(long, long, long, long) disassembly (after)
  /// CHECK:            <<Cond:z\d+>> LessThanOrEqual [{{j\d+}},{{j\d+}}]
  /// CHECK:                          If [<<Cond>>]
  /// CHECK:            <<Phi:j\d+>>  Phi [{{j\d+}},{{j\d+}}]
  /// CHECK:                          Return [<<Phi>>]
  ...
  // Moved from register (after) due to X86 rewrite of long compare/move.
  /// CHECK-START: long Main.LongMatCond_LongVarVar(long, long, long, long) instruction_simplifier_before_codegen (after)
  /// CHECK:            <<Cond:z\d+>> LessThanOrEqual [{{j\d+}},{{j\d+}}]
  /// CHECK:            <<Sel1:j\d+>> Select [{{j\d+}},{{j\d+}},<<Cond>>]
  /// CHECK:            <<Sel2:j\d+>> Select [{{j\d+}},{{j\d+}},<<Cond>>]
  /// CHECK:                          Add [<<Sel2>>,<<Sel1>>]

  /// CHECK-START-X86: long Main.LongMatCond_LongVarVar(long, long, long, long) register (after)
  /// CHECK:            <<Cond:z\d+>> LessThanOrEqual [{{j\d+}},{{j\d+}}]
  /// CHECK:                          If [<<Cond>>]
  /// CHECK:            <<Phi1:j\d+>> Phi [{{j\d+}},{{j\d+}}]
  /// CHECK:                          If [<<Cond>>]
  /// CHECK:            <<Phi2:j\d+>> Phi [{{j\d+}},{{j\d+}}]
  /// CHECK:                          Add [<<Phi2>>,<<Phi1>>]
