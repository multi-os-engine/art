...
public class Main {
  ...
  /// CHECK-START-ARM: int Main.rotateIntegerRight(int, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Invoke:i\d+>>       InvokeStaticOrDirect

  /// CHECK-START-ARM: int Main.rotateIntegerRight(int, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  ...
  /// CHECK-START-ARM: int Main.rotateIntegerLeft(int, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Invoke:i\d+>>       InvokeStaticOrDirect

  /// CHECK-START-ARM: int Main.rotateIntegerLeft(int, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  ...
  /// CHECK-START-ARM: long Main.rotateLongRight(long, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Invoke:j\d+>>       InvokeStaticOrDirect

  /// CHECK-START-ARM: long Main.rotateLongRight(long, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  ...
  /// CHECK-START-ARM: long Main.rotateLongLeft(long, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Invoke:j\d+>>       InvokeStaticOrDirect

  /// CHECK-START-ARM: long Main.rotateLongLeft(long, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  ...
  /// CHECK-START-ARM: int Main.ror_int_constant_c_c(int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  ...
  /// CHECK-START-ARM: int Main.ror_int_constant_c_c(int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  ...
  /// CHECK-START-ARM: int Main.ror_int_constant_c_c_0(int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  /// CHECK:          <<Rotate:i\d+>>       Rotate [<<ArgValue>>,<<Const2>>]
  /// CHECK:                                Return [<<Rotate>>]
  ...
  /// CHECK-START-ARM: long Main.ror_long_constant_c_c(long) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  ...
  /// CHECK-START-ARM: long Main.ror_long_constant_c_c(long) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  ...
  /// CHECK-START-ARM: long Main.ror_long_constant_c_c_0(long) instruction_simplifier (after)
  /// CHECK-NOT:      Rotate
  ...
  /// CHECK-START-ARM: int Main.ror_int_constant_c_negc(int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  ...
  /// CHECK-START-ARM: int Main.ror_int_constant_c_negc(int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  /// CHECK:          <<Rotate:i\d+>>       Rotate [<<ArgValue>>,<<Const2>>]
  /// CHECK:                                Return [<<Rotate>>]
  ...
  /// CHECK-START-ARM: long Main.ror_long_constant_c_negc(long) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  /// CHECK:          <<ConstNeg2:i\d+>>    IntConstant -2
  /// CHECK-DAG:      <<UShr:j\d+>>         UShr [<<ArgValue>>,<<Const2>>]
  ...
  /// CHECK-START-ARM: long Main.ror_long_constant_c_negc(long) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<Const2:i\d+>>       IntConstant 2
  /// CHECK:          <<Rotate:j\d+>>       Rotate [<<ArgValue>>,<<Const2>>]
  /// CHECK:                                Return [<<Rotate>>]
  ...
  /// CHECK-START-ARM: int Main.ror_int_reg_v_csubv(int, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  ...
  /// CHECK-START-ARM: int Main.ror_int_reg_v_csubv(int, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Rotate:i\d+>>       Rotate [<<ArgValue>>,<<ArgDistance>>]
  /// CHECK:                                Return [<<Rotate>>]
  ...
  /// CHECK-START-ARM: int Main.ror_int_subv_csubv(int, int, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  ...
  /// CHECK-START-ARM: int Main.ror_int_subv_csubv(int, int, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgX:i\d+>>         ParameterValue
  /// CHECK:          <<ArgY:i\d+>>         ParameterValue
  ...
  /// CHECK-START-ARM: int Main.ror_int_subv_csubv_env(int, int, int) instruction_simplifier (after)
  /// CHECK-NOT:      UShr
  /// CHECK-NOT:      Shl
  ...
  /// CHECK-START-ARM: long Main.ror_long_reg_v_csubv(long, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  ...
  /// CHECK-START-ARM: long Main.ror_long_reg_v_csubv(long, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Rotate:j\d+>>       Rotate [<<ArgValue>>,<<ArgDistance>>]
  /// CHECK:                                Return [<<Rotate>>]
  ...
  /// CHECK-START-ARM: long Main.ror_long_reg_v_csubv_0(long, int) instruction_simplifier (after)
  /// CHECK-NOT:      Rotate
  public static long ror_long_reg_v_csubv_0(long value, int distance) {
    return (value >>> distance) | (value << (32 - distance));
  }

  /// CHECK-START-ARM: long Main.ror_long_subv_csubv_0(long, int, int) instruction_simplifier (after)
  /// CHECK-NOT:      Rotate
  ...
  /// CHECK-START-ARM: int Main.rol_int_reg_csubv_v(int, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Const32:i\d+>>      IntConstant 32
  /// CHECK-DAG:      <<Sub:i\d+>>          Sub [<<Const32>>,<<ArgDistance>>]
  ...
  /// CHECK-START-ARM: int Main.rol_int_reg_csubv_v(int, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK:          <<Rotate:i\d+>>       Rotate [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM: int Main.rol_int_csubv_subv(int, int, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgX:i\d+>>         ParameterValue
  /// CHECK:          <<ArgY:i\d+>>         ParameterValue
  /// CHECK:          <<Const32:i\d+>>      IntConstant 32
  ...
  /// CHECK-START-ARM: int Main.rol_int_csubv_subv(int, int, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgX:i\d+>>         ParameterValue
  /// CHECK:          <<ArgY:i\d+>>         ParameterValue
  /// CHECK:          <<SubDistance:i\d+>>  Sub [<<ArgX>>,<<ArgY>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_csubv_v(long, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Const64:i\d+>>      IntConstant 64
  /// CHECK-DAG:      <<Sub:i\d+>>          Sub [<<Const64>>,<<ArgDistance>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_csubv_v(long, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK:          <<Rotate:j\d+>>       Rotate [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_csubv_v_0(long, int) instruction_simplifier (after)
  /// CHECK-NOT:      Rotate
  ...
  /// CHECK-START-ARM: int Main.ror_int_reg_v_negv(int, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK-DAG:      <<UShr:i\d+>>         UShr [<<ArgValue>>,<<ArgDistance>>]
  ...
  /// CHECK-START-ARM: int Main.ror_int_reg_v_negv(int, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Rotate:i\d+>>       Rotate [<<ArgValue>>,<<ArgDistance>>]
  /// CHECK:                                Return [<<Rotate>>]
  ...
  /// CHECK-START-ARM: int Main.ror_int_reg_v_negv_env(int, int) instruction_simplifier (after)
  /// CHECK-NOT:      UShr
  /// CHECK-NOT:      Shl
  ...
  /// CHECK-START-ARM: long Main.ror_long_reg_v_negv(long, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK-DAG:      <<UShr:j\d+>>         UShr [<<ArgValue>>,<<ArgDistance>>]
  /// CHECK-DAG:      <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  ...
  /// CHECK-START-ARM: long Main.ror_long_reg_v_negv(long, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Rotate:j\d+>>       Rotate [<<ArgValue>>,<<ArgDistance>>]
  /// CHECK:                                Return [<<Rotate>>]
  ...
  /// CHECK-START-ARM: int Main.rol_int_reg_negv_v(int, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK-DAG:      <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  ...
  /// CHECK-START-ARM: int Main.rol_int_reg_negv_v(int, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK:          <<Rotate:i\d+>>       Rotate [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_negv_v(long, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK-DAG:      <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_negv_v(long, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK:          <<Rotate:j\d+>>       Rotate [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_v_negv_add(long, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK-DAG:      <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK-DAG:      <<UShr:j\d+>>         UShr [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_v_negv_add(long, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK:          <<Rotate:j\d+>>       Rotate [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_v_negv_xor(long, int) instruction_simplifier (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK-DAG:      <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK-DAG:      <<UShr:j\d+>>         UShr [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM: long Main.rol_long_reg_v_negv_xor(long, int) instruction_simplifier (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK:          <<Rotate:j\d+>>       Rotate [<<ArgValue>>,<<Neg>>]
