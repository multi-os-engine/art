...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            WeakReference<ClassLoader> loader = testUnloadLoader(constructor);
            WeakReference<Class> klass = testUnloadClass(constructor);
    ...
    private static WeakReference<Class> testUnloadClass(Constructor constructor)
        throws Exception {
    ...
    private static WeakReference<ClassLoader> testUnloadLoader(Constructor constructor)
        throws Exception {
        ClassLoader loader = (ClassLoader) constructor.newInstance(
            DEX_FILE, ClassLoader.getSystemClassLoader());
        Class intHolder = loader.loadClass("IntHolder");
