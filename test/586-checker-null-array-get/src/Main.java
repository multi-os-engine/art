...
public class Main {
  ...
  /// CHECK-DAG: <<Get1:j\d+>>   ArrayGet [<<Check1>>,{{i\d+}}]
  /// CHECK-DAG: <<Check2:l\d+>> NullCheck [<<Null>>]
  /// CHECK-DAG: <<Get2:l\d+>>   ArrayGet [<<Check2>>,{{i\d+}}]
  ...
  /// CHECK-DAG: <<Check1:l\d+>>     NullCheck [<<Null>>]
  /// CHECK-DAG: <<Check2:l\d+>>     NullCheck [<<Null>>]
  /// CHECK-DAG: <<FieldGet1:l\d+>>  InstanceFieldGet [<<Check1>>]
  /// CHECK-DAG: <<FieldGet2:l\d+>>  InstanceFieldGet [<<Check2>>]
  /// CHECK-DAG: <<Check3:l\d+>>     NullCheck [<<FieldGet1>>]
  /// CHECK-DAG: <<Check4:l\d+>>     NullCheck [<<FieldGet2>>]
  /// CHECK-DAG: <<ArrayGet1:i\d+>>  ArrayGet [<<Check3>>,{{i\d+}}]
  /// CHECK-DAG: <<ArraySet1:v\d+>>  ArraySet [<<Check3>>,{{i\d+}},{{i\d+}}]
  /// CHECK-DAG: <<ArrayGet2:f\d+>>  ArrayGet [<<Check4>>,{{i\d+}}]
