...
public class Main {
  ...
  /**
   * Method with an outer loop countable loop and an inner do-while loop.
   * Since all work is done in the loop header, any invariant hoisting
   * and deopting should be done in a loop header proper, not the true-block
   * of the newly generated taken-test after dynamice BCE.
   */
