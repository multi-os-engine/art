...
public class Main {
  ...
  /*
   * Ensure an inlined call to a static method whose declaring class is
   * statically known to have been initialized does not explicitly not
   * implicitly require no explicit a clinit check.
   */
   ...
   * explicitly not implicitly require no explicit a clinit check.
   */
