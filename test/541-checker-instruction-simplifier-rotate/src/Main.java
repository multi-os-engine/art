...
public class Main {
  ...
  /// CHECK-START-ARM64: int Main.rotate_int_right_subv_csubv(int, int, int) instruction_simplifier_arm64 (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  ...
  /// CHECK-START-ARM64: int Main.rotate_int_right_subv_csubv(int, int, int) instruction_simplifier_arm64 (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgX:i\d+>>         ParameterValue
  /// CHECK:          <<ArgY:i\d+>>         ParameterValue
  /// CHECK:          <<SubDistance:i\d+>>  Sub [<<ArgX>>,<<ArgY>>]
  /// CHECK:          <<Arm64Ror:i\d+>>     Arm64Ror [<<ArgValue>>,<<SubDistance>>]
  /// CHECK:                                Return [<<Arm64Ror>>]
  ...
  /// CHECK-NOT:      UShr
  /// CHECK-NOT:      Shl
  public static int rotate_int_right_subv_csubv(int value, int x, int y) {
    int distance = x - y;
    return (value >>> distance) | (value << (32 - distance));
  }

  /// CHECK-START-ARM64: int Main.rotate_int_right_subv_csubv_env(int, int, int) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:      UShr
  /// CHECK-NOT:      Shl
  public static int rotate_int_right_subv_csubv_env(int value, int x, int y) {
    int distance = x - y;
  ...
  /// CHECK-START-ARM64: long Main.rotate_long_right_subv_csubv_0(long, int, int) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:      Arm64Ror
  public static long rotate_long_right_subv_csubv_0(long value, int x, int y) {
    int distance = x - y;
    return (value >>> distance) | (value << (32 - distance));
  }
  ...
  /// CHECK-START-ARM64: int Main.rotate_int_left_csubv_subv(int, int, int) instruction_simplifier_arm64 (before)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgX:i\d+>>         ParameterValue
  /// CHECK:          <<ArgY:i\d+>>         ParameterValue
  /// CHECK:          <<Const32:i\d+>>      IntConstant 32
  ...
  /// CHECK-START-ARM64: int Main.rotate_int_left_csubv_subv(int, int, int) instruction_simplifier_arm64 (after)
  /// CHECK:          <<ArgValue:i\d+>>     ParameterValue
  /// CHECK:          <<ArgX:i\d+>>         ParameterValue
  /// CHECK:          <<ArgY:i\d+>>         ParameterValue
  /// CHECK:          <<SubDistance:i\d+>>  Sub [<<ArgX>>,<<ArgY>>]
  ...
  /// CHECK-NOT:      UShr
  /// CHECK-NOT:      Shl
  public static int rotate_int_left_csubv_subv(int value, int x, int y) {
    int distance = x - y;
    return (value >>> (32 - distance)) | (value << distance);
  }
  ...
  /// CHECK-START-ARM64: int Main.rotate_int_right_reg_v_negv_env(int, int) instruction_simplifier_arm64 (after)
  /// CHECK-NOT:      UShr
  /// CHECK-NOT:      Shl
  public static int rotate_int_right_reg_v_negv_env(int value, int distance) {
  ...
  /// CHECK-START-ARM64: long Main.rotate_long_left_reg_v_negv_add(long, int) instruction_simplifier_arm64 (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK-DAG:      <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK-DAG:      <<UShr:j\d+>>         UShr [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM64: long Main.rotate_long_left_reg_v_negv_add(long, int) instruction_simplifier_arm64 (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK:          <<Arm64Ror:j\d+>>     Arm64Ror [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-NOT:  Shl
  /// CHECK-NOT:  UShr
  public static long rotate_long_left_reg_v_negv_add(long value, int distance) {
    return (value << distance) + (value >>> -distance);
  }
  ...
  /// CHECK-START-ARM64: long Main.rotate_long_left_reg_v_negv_xor(long, int) instruction_simplifier_arm64 (before)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK-DAG:      <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK-DAG:      <<UShr:j\d+>>         UShr [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-START-ARM64: long Main.rotate_long_left_reg_v_negv_xor(long, int) instruction_simplifier_arm64 (after)
  /// CHECK:          <<ArgValue:j\d+>>     ParameterValue
  /// CHECK:          <<ArgDistance:i\d+>>  ParameterValue
  /// CHECK:          <<Neg:i\d+>>          Neg [<<ArgDistance>>]
  /// CHECK:          <<Arm64Ror:j\d+>>     Arm64Ror [<<ArgValue>>,<<Neg>>]
  ...
  /// CHECK-NOT:  Shl
  /// CHECK-NOT:  UShr
  public static long rotate_long_left_reg_v_negv_xor(long value, int distance) {
    return (value << distance) ^ (value >>> -distance);
  }
  ...
  public static void main(String[] args) {
    ...
    assertIntEquals(2, rotate_int_right_subv_csubv(8, 2, 0));
    assertIntEquals(32, rotate_int_right_subv_csubv_env(8, 2, 0));
    assertIntEquals(32, rotate_int_left_csubv_subv(8, 2, 0));
    ...
    assertIntEquals(0, rotate_int_right_reg_v_negv_env(8, 2));
    ...
    assertLongEquals(32L, rotate_long_left_reg_v_negv_add(8L, 2));
    assertLongEquals(32L, rotate_long_left_reg_v_negv_xor(8L, 2));
  }
}
