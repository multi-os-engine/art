...
public class Main {
  ...
  /// CHECK-NOT:      InvokeStaticOrDirect intrinsic:IntegerRotateRight
  ...
  /// CHECK-NOT:      LoadClass
  /// CHECK-NOT:      ClinitCheck
  /// CHECK-NOT:      InvokeStaticOrDirect intrinsic:IntegerRotateLeft
  ...
  /// CHECK-NOT:      LoadClass
  /// CHECK-NOT:      ClinitCheck
  /// CHECK-NOT:      InvokeStaticOrDirect intrinsic:LongRotateRight
  ...
  /// CHECK-NOT:      LoadClass
  /// CHECK-NOT:      ClinitCheck
  /// CHECK-NOT:      InvokeStaticOrDirect intrinsic:LongRotateLeft
