...
public class Main {
  ...
  static void checkEq(long expected, long value) {
    if (expected != value) {
      System.out.println("Expected " + expected + " but got " + value);
    }
  }
