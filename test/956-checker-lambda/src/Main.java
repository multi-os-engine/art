...
public class Main {
  ...
  /// CHECK-DAG: CaptureVariable
  //  CHECK-DAG: CaptureVariable          TODO: enable
  /// CHECK-DAG: CreateLambda
  /// CHECK-DAG: InvokeLambda
  /// CHECK-DAG: ReturnVoid
  private void doL1Capture(int parameter) {
    ...
    /// CHECK-DAG: ReturnVoid
    //
    // TODO: add mField as well, pending b/25631011
    L1 lambda1 = (int a) -> { System.out.println("Lambda1:" + a + parameter + local); };
    lambda1.run(1);
  }

  /// CHECK-START: B1 Main.doBox() ssa_builder (after)
  /// CHECK-DAG: CreateLambda
  /// CHECK-DAG: BoxLambda
  private B1 doBox() {
  ...
  /// CHECK-START: void Main.doUnbox(B1) ssa_builder (after)
