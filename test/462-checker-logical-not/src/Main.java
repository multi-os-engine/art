...
public class Main {
  ...
  // Note #2: The first input of Phi is always the fall-through path,
  //          i.e. the false branch.
  ...
  // CHECK-START: boolean Main.BooleanNot(boolean) boolean_not_simplifier (before)
  ...
  // CHECK-START: boolean Main.BooleanNot(boolean) boolean_not_simplifier (after)
  // CHECK-DAG:     [[Param:z\d+]]    ParameterValue
  // CHECK-DAG:     [[Const0:i\d+]]   IntConstant 0
  ...
  // CHECK-START: boolean Main.GreaterThan(int, int) boolean_not_simplifier (before)
  ...
  // CHECK-START: boolean Main.GreaterThan(int, int) boolean_not_simplifier (after)
  // CHECK-DAG:     [[ParamX:i\d+]]   ParameterValue
  // CHECK-DAG:     [[ParamY:i\d+]]   ParameterValue
  // CHECK-DAG:     [[Const0:i\d+]]   IntConstant 0
  // CHECK-DAG:     [[Const1:i\d+]]   IntConstant 1
  ...
  // CHECK-START: boolean Main.LessThan(int, int) boolean_not_simplifier (before)
  // CHECK-DAG:     [[ParamX:i\d+]]   ParameterValue
  // CHECK-DAG:     [[ParamY:i\d+]]   ParameterValue
  // CHECK-DAG:     [[Const0:i\d+]]   IntConstant 0
  // CHECK-DAG:     [[Const1:i\d+]]   IntConstant 1
  ...
  // CHECK-START: boolean Main.LessThan(int, int) boolean_not_simplifier (after)
  // CHECK-DAG:     [[ParamX:i\d+]]   ParameterValue
  // CHECK-DAG:     [[ParamY:i\d+]]   ParameterValue
  // CHECK-DAG:     [[Const0:i\d+]]   IntConstant 0
  // CHECK-DAG:     [[Const1:i\d+]]   IntConstant 1
  ...
  // CHECK-START: boolean Main.ValuesOrdered(int, int, int) boolean_not_simplifier (before)
  // CHECK-DAG:     [[ParamX:i\d+]]   ParameterValue
  // CHECK-DAG:     [[ParamY:i\d+]]   ParameterValue
  // CHECK-DAG:     [[ParamZ:i\d+]]   ParameterValue
  // CHECK-DAG:     [[Const0:i\d+]]   IntConstant 0
  // CHECK-DAG:     [[Const1:i\d+]]   IntConstant 1
  // CHECK-DAG:                       GreaterThan [ [[ParamX]] [[ParamY]] ]
  // CHECK-DAG:                       GreaterThan [ [[ParamY]] [[ParamZ]] ]
  // CHECK-DAG:                       NotEqual [ [[PhiXY:i\d+]] [[PhiYZ:i\d+]] ]
  ...
  // CHECK-START: boolean Main.ValuesOrdered(int, int, int) boolean_not_simplifier (after)
  // CHECK-DAG:     [[ParamX:i\d+]]   ParameterValue
  // CHECK-DAG:     [[ParamY:i\d+]]   ParameterValue
  // CHECK-DAG:     [[ParamZ:i\d+]]   ParameterValue
