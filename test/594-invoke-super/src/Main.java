...
class A {
  ...
  // Adding this method causes the program to invoke A's bar
  // instead of A's foo when calling Y's foo from Z.
...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // invoke-super on this as well as on an instance of Y.
