...
public class Main {
    ...
    public Main() {
        ...
        testCases.add(new TestCase("MoveExc", "MoveExc", "run", null, new ArithmeticException(),
                null));
        testCases.add(new TestCase("CatchHandlerOnEntry", "CatchHandlerOnEntry",
                "catchHandlerOnEntry", new Object[]{0}, null, 100));
        testCases.add(new TestCase("CatchHandlerOnEntry2", "CatchHandlerOnEntry2",
                "catchHandlerOnEntry", new Object[]{0}, new VerifyError(), 100));
    }
