...
public class Main {
  ...
  // CHECK-START: Main Main.ifKeepCheckTest(boolean) instruction_simplifier_after_types (before)
  // CHECK-DAG:     NewInstance
  // CHECK-DAG:     NullCheck

  // CHECK-START: Main Main.ifKeepCheckTest(boolean) instruction_simplifier_after_types (after)
  // CHECK-DAG:     NewInstance
  // CHECK-DAG:     NullCheck
