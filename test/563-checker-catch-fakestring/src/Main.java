...
public class Main {
  ...
  public static void main(String[] args) throws Throwable {
    ...
    {
      c.getMethod("compareFakeString").invoke(null, (Object[]) null);
    }

    {
      Method m = c.getMethod("deoptimizeFakeString", int[].class, byte[].class);
      try {
    ...
    {
      c.getMethod("catchFakeString").invoke(null, (Object[]) null);
    }
  }
}
