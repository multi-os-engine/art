...
uint32_t art_portable_jni_method_start(Thread* self) UNLOCK_FUNCTION(Locks::mutator_lock_) {
...
uint32_t art_portable_jni_method_start_synchronized(Thread* self, mirror::Object* to_lock)
    UNLOCK_FUNCTION(Locks::mutator_lock_) {
  to_lock->MonitorEnter(self);
