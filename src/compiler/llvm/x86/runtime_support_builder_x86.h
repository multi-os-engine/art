...
#ifndef ART_SRC_COMPILER_LLVM_X86_RUNTIME_SUPPORT_BUILDER_X86_H_
#define ART_SRC_COMPILER_LLVM_X86_RUNTIME_SUPPORT_BUILDER_X86_H_
...
class RuntimeSupportBuilderX86 : public RuntimeSupportBuilder {
 public:
  RuntimeSupportBuilderX86(ArtIRBuilder* irb) : RuntimeSupportBuilder(irb) {}
...
#endif // ART_SRC_COMPILER_LLVM_X86_RUNTIME_SUPPORT_BUILDER_X86_H_
